...
export let ComponentRenderer = /*@__PURE__*/ (() => {
    class ComponentRenderer extends Base {
            ...
            if (typeCast(Array_$type, b) !== null) {
                ...
                this.f.forPropertyValueItem(c, a, (r) => {
                    if (j.containsKey(k)) {
                        let s = j.item(k);
                        if (!d.b(r) && !d.a(s.f)) {
                            d.k(e, s.f, r, s, runOn(this, this.cr), f);
                        }
                        for (let t of fromEnum(s.e())) {
                            this.ci(a + "." + t.c, t.b, c, d, e, s.f);
                        }
                    }
                    k++;
                });
                if (l > 0 && k == 0) {
                    ...
                    this.f.forPropertyValueItem(c, r, (s) => {
                        if (j.containsKey(k)) {
                            let t = j.item(k);
                            if (!d.b(s) && !d.a(t.f)) {
                                d.k(e, t.f, s, t, runOn(this, this.cr), f);
                            }
                            for (let u of fromEnum(t.e())) {
                                this.ci(r + "." + u.c, u.b, c, d, e, t.f);
                            }
                        }
                        k++;
                    });
                ...
                if (c) {
                    ...
                    if (h.c.count > 0) {
                        for (let l of fromEnum(h.c)) {
                            let m = this.bt(a, i, l);
                            let n = this.f.getPropertyValue(m, l.i);
                            if (n != null) {
                                if (!i.b(n)) {
                                    let o = l.f;
                                    if (typeCast(DescriptionTreeNode.$, o) !== null) {
                                        let p = o.f;
                                        i.k(a, p, n, o, runOn(this, this.cr), l.b.f);
                                    }
                                }
                            }
                        }
                    ...
                    if (h.b.count > 0) {
                        for (let u of fromEnum(h.b)) {
                            ...
                            let aa = this.bt(a, i, u);
                            let ab = this.f.getPropertyValue(aa, u.i);
                            if (ab != null) {
                                let ac = 0;
                                this.f.forPropertyValueItem(aa, u.i, (ad) => {
                                    if (w.containsKey(this.f.getPropertyValue(ad, "Name").toString())) {
                                        if (!i.b(ad)) {
                                            let ae = w.item(this.f.getPropertyValue(ad, "Name").toString());
                                            if (typeCast(DescriptionTreeNode.$, ae) !== null) {
                                                let af = ae.f;
                                                i.k(a, af, ad, ae, runOn(this, this.cr), u.b.f);
                                            }
                                        }
                                    }
                                    ac++;
        ...
        be(a, b, c) {
            ...
            let f = this.bo(d, a.f, b, c, false, a.b.f);
            return f;
        }
        bv(a, b) {
            return a.f == null ? null : this.d(a.f, b);
        ...
        a6(a, b, c) {
            ...
            for (let g = 0; g < d.length; g++) {
                ...
                let j = this.bo(h, d[g], b, c, false, a.b.f);
                e.add1(j);
            }
            return e.toArray();
        }
        ...
        c5(a, b, c, d) {
            ...
            let g = this.bo(f, c.f, a, b, false, c.b.f);
        ...
        ah(a, b, c) {
            ...
            let e = c.f;
            let f = false;
            this.f.replaceRootItem(a, e.h, this.context, (g) => {
                let h = this.f.getRootObject(a);
                b.k(a, e.f, h, e, runOn(this, this.cr), -1);
                let i = this.a3(e);
                this.cp(a, b, i);
                f = true;
                if (g) {
        ...
        l(a, b, c) {
            ...
            let d = c.f;
            let e = false;
            this.f.replaceRootItem(a, d.h, this.context, (f) => {
                let g = this.f.getRootObject(a);
                b.k(a, d.f, g, d, runOn(this, this.cr), -1);
                let h = this.a3(d);
                this.cp(a, b, h);
                e = true;
                if (f) {
        ...
        b6(a, b, c, d) {
            ...
            let h = this.bo(f, c.f, a, b, false, c.b.f);
