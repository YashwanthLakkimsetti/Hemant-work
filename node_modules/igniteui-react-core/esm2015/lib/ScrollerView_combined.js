...
export let Scroller = /*@__PURE__*/ (() => {
    class Scroller extends Base {
        constructor() {
            ...
            this.bc = 0;
            this.w = false;
            this.ay = new List$1(Boolean_$type, 0);
            this.cb = 500;
            this.cc = 0;
            this.cd = 0;
            this.o = false;
            ...
            this.t = true;
            this.u = true;
            this.dx = this.view.getDefaultScrollbarBrush();
            ...
            let a = this.j;
            a.propertyChanged = delegateCombine(a.propertyChanged, runOn(this, this.c1));
            let b = this.k;
            b.propertyChanged = delegateCombine(b.propertyChanged, runOn(this, this.c2));
        }
