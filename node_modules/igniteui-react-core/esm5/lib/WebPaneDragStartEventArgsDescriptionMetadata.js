...
var WebPaneDragStartEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    WebPaneDragStartEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(WebPaneDragStartEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(WebPaneDragStartEventArgsDescriptionMetadata.a);
        WebPaneDragStartEventArgsDescriptionMetadata.d(a);
    };
    WebPaneDragStartEventArgsDescriptionMetadata.c = function (a) {
        a.item("__qualifiedNameTS", "String:PaneDragStartEventArgs");
        a.item("Detail", "ExportedType:WebPaneDragStartEventArgs");
    };
    WebPaneDragStartEventArgsDescriptionMetadata.d = function (a) {
        WebPaneDragStartEventArgsDescriptionMetadata.b(a);
        a.u("WebPaneDragStartEventArgs", function () { return new WebPaneDragStartEventArgsDescription(); });
        a.t("WebPaneDragStartEventArgs", WebPaneDragStartEventArgsDescriptionMetadata.a);
    };
