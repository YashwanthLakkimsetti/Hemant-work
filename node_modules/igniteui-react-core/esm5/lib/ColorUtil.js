...
var ColorUtil = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ColorUtil.v = function (a, b) {
        var c = ColorUtil.a(a);
        if (b < 0) {
            return ColorUtil.o(c[0], c[1], c[2], c[3] * (1 - MathUtil.c(-b, 0, 1)));
        }
        else {
            return ColorUtil.o(c[0], c[1], c[2], c[3] + MathUtil.c(b, 0, 1) * (1 - c[3]));
        }
    };
    ...
    ColorUtil.i = function (a, b) {
        ...
        if (ColorUtil.d == null) {
            ...
            try {
                for (var _d = __values(fromEnum(ColorUtil.c.keys)), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var c = _e.value;
