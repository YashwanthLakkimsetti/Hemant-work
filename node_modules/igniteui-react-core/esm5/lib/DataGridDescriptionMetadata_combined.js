...
var DataGridDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataGridDescriptionMetadata.e = function (a) {
        a.item("_qualifiedName", "String:Infragistics.Controls.Grids.XamDataGrid");
    ...
    DataGridDescriptionMetadata.b = function (a) {
        ...
        if (a.g(DataGridDescriptionMetadata.a)) {
            return;
        }
        a.s(DataGridDescriptionMetadata.a);
    ...
    DataGridDescriptionMetadata.c = function (a) {
        ...
        a.item("Density@names", "Auto;Comfortable;Cosy;Compact");
        ...
        a.item("SelectionMode", "ExportedType:string:GridSelectionMode");
        ...
        a.item("ActualColumns", "Collection:Column:GridColumnCollection:Column");
        a.item("Columns", "Collection:Column:GridColumnCollection:Column");
    ...
    DataGridDescriptionMetadata.d = function (a) {
        ...
        a.u("DataGrid", function () { return new DataGridDescription(); });
        a.t("DataGrid", DataGridDescriptionMetadata.a);
    };
...
var GridCellEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridCellEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridCellEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(GridCellEventArgsDescriptionMetadata.a);
    ...
    GridCellEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("GridCellEventArgs", function () { return new GridCellEventArgsDescription(); });
        a.t("GridCellEventArgs", GridCellEventArgsDescriptionMetadata.a);
    };
