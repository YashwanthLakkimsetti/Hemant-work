...
export declare type UnpackCustomEvent<T> = T extends CustomEvent<infer U> ? U : never;
...
export declare const EventEmitterMixin: <E, T extends Constructor<LitElement>>(superClass: T) => Constructor<EventEmitterInterface<E>> & T;
