...
export declare abstract class FinancialIndicator extends FinancialSeries implements ITrendLineSeries {
    ...
    tm: FinancialIndicatorView;
    constructor();
    tz(a: boolean): void;
    protected tr(a: Point, b: Point, c: boolean): boolean;
    ...
    to: IndicatorDisplayType;
    protected get_tn(): IndicatorDisplayType;
    get tn(): IndicatorDisplayType;
    tu: number;
    ...
    protected tl: AxisRange;
    protected abstract tp(a: number, b: number): boolean;
    protected abstract ts(a: number, b: number): IList$1<string>;
