...
export declare abstract class IgrSeries<P extends IIgrSeriesProps = IIgrSeriesProps> extends React.Component<P, {}> {
    ...
    set tooltipTemplate(value: React.SFC<IChartTooltipProps> | React.Component<IChartTooltipProps>);
    get tooltipTemplate(): React.SFC<IChartTooltipProps> | React.Component<IChartTooltipProps>;
    private _tooltipContainerTemplate;
    set tooltipContainerTemplate(value: React.SFC<IChartTooltipProps> | React.Component<IChartTooltipProps>);
    get tooltipContainerTemplate(): React.SFC<IChartTooltipProps> | React.Component<IChartTooltipProps>;
