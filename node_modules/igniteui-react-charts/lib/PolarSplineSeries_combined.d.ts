 ...
 * @hidden
 */
export declare class PolarSplineSeries extends PolarLineSeriesBase {
    static $t: Type;
    protected get_eg(): boolean;
    protected bx(): SeriesView;
    ly(a: SeriesView): void;
    vf: PolarSplineSeriesView;
    constructor();
    vg: number;
 ...
 * @hidden
 */
export declare class PolarSplineSeriesView extends PolarLineSeriesBaseView {
    static $t: Type;
    protected c4: PolarSplineSeries;
    constructor(a: PolarSplineSeries);
    as(): void;
    c8: Path;
    c7: Path;
    c5(): void;
