...
export let SeriesViewer = /*@__PURE__*/ (() => {
    class SeriesViewer extends Control {
        constructor() {
            ...
            this.er = false;
            this.dm = false;
            this.bw = new SeriesViewerComponentsForView();
            this.da = false;
            this.ar = 0;
            this.aq = 1;
            ...
            this.hh = null;
            this.ff = new Dictionary$2(String_$type, Base.$, 0);
            this.ep = false;
            this.f2 = NaN;
            this.fr = NaN;
            this.ft = NaN;
            ...
            this.fh = new List$1(IDataLegend_$type, 0);
            ...
            this.sa = Rect.empty;
            this.r5 = { $type: Point_$type, x: NaN, y: NaN };
            this.fi = dateNow();
            this.d7 = false;
            this.d8 = false;
            ...
            this.oq(null, this.actualSyncLink);
            this.ap = new ChartContentManager(this);
            this.propertyUpdated = delegateCombine(this.propertyUpdated, (a, b) => this.nh(a, b.propertyName, b.oldValue, b.newValue));
            let a = this.series;
            a.collectionChanged = delegateCombine(a.collectionChanged, runOn(this, this.n7));
            let b = this.series;
            b.collectionResetting = delegateCombine(b.collectionResetting, runOn(this, this.n8));
            this.cs = new DoubleAnimator(0, 1, this.hf);
            this.cr = new DoubleAnimator(0, 1, this.he);
            let c = this.cr;
            c.propertyChanged = delegateCombine(c.propertyChanged, runOn(this, this.le));
            this.cq.bx();
            this.lh();
            this.lg();
        }
        ...
        get a5() {
            if (this.a4 == null) {
                this.a4 = DVContainer.instance.createInstance(ISeriesViewerInteractionManager_$type, () => this.c3.n);
            }
            return this.a4;
        }
        get ed() {
        ...
        get_si() {
            if (this.c5) {
                this.c5 = false;
                let a = this.sm(this.su, this.sj, this.sf);
                this.sb = a;
            }
            return this.sb;
        }
        ...
        cf(a) {
            let b = this.cq.k != null && this.cq.k.al ? this.cg : this.ce;
            if (b != 3) {
                return b;
            }
            return this.cq.m(a);
        ...
        *_fg() {
        ...
        fg() {
            return toEnum(() => this._fg());
        }
        r9(a) {
            a = { $type: Point_$type, x: a.x + this.su.left, y: a.y + this.su.top };
            let b = this.si;
            let c = this.sf.left + this.sf.width * (a.x - b.left) / b.width;
            let d = this.sf.top + this.sf.height * (a.y - b.top) / b.height;
            return { $type: Point_$type, x: c, y: d };
        }
        r7(a) {
            let b = this.si;
            let c = (a.x - this.sf.left) * b.width / this.sf.width + b.left;
            let d = (a.y - this.sf.top) * b.height / this.sf.height + b.top;
            a = { $type: Point_$type, x: a.x - this.su.left, y: a.y - this.su.top };
            return { $type: Point_$type, x: c, y: d };
        }
        st(a) {
            ...
            let b = this.si;
            let c = this.sf.left + this.sf.width * (a.left - b.left) / b.width;
            let d = this.sf.top + this.sf.height * (a.top - b.top) / b.height;
            let e = this.sf.left + this.sf.width * (a.right - b.left) / b.width;
            let f = this.sf.top + this.sf.height * (a.bottom - b.top) / b.height;
        ...
        ss(a) {
            ...
            let b = this.su;
            let c = b.left + (b.width * (a.left - this.sf.left) / this.sf.width);
            let d = b.top + (b.height * (a.top - this.sf.top) / this.sf.height);
            let e = b.left + (b.width * (a.right - this.sf.left) / this.sf.width);
            let f = b.top + (b.height * (a.bottom - this.sf.top) / this.sf.height);
            return new Rect(0, c, d, e - c, f - d);
        }
        nm() {
        ...
        set sf(a) {
            let b = Rect.l_op_Inequality(this.sa, a);
            if (b) {
                let c = this.sa;
                this.sa = a;
    ...
    SeriesViewer.$t = /*@__PURE__*/ markType(SeriesViewer, 'SeriesViewer', Control.$, [INotifyPropertyChanged_$type, ILegendOwner_$type, IInternalLegendOwner_$type, IDataLegendTarget_$type]);
    SeriesViewer.p2 = /*@__PURE__*/ DependencyProperty.i("Legend", IChartLegend_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("Legend", b.oldValue, b.newValue);
    }));
    SeriesViewer.o7 = /*@__PURE__*/ DependencyProperty.i("AnimateSeriesWhenAxisRangeChanges", Boolean_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, false, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("AnimateSeriesWhenAxisRangeChanges", b.oldValue, b.newValue);
    }));
    SeriesViewer.py = /*@__PURE__*/ DependencyProperty.i("IsWindowSyncedToVisibleRange", Boolean_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, false, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("IsWindowSyncedToVisibleRange", b.oldValue, b.newValue);
    }));
    SeriesViewer.qk = /*@__PURE__*/ DependencyProperty.i("ShouldSimulateHoverMoveCrosshairPoint", Boolean_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, false, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("ShouldSimulateHoverMoveCrosshairPoint", b.oldValue, b.newValue);
    }));
    SeriesViewer.ph = /*@__PURE__*/ DependencyProperty.i("HighlightingMode", SeriesHighlightingMode_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(SeriesHighlightingMode_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HighlightingMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.pp = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarMode", SeriesViewerScrollbarMode_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(SeriesViewerScrollbarMode_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.qy = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarMode", SeriesViewerScrollbarMode_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(SeriesViewerScrollbarMode_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.pr = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarPosition", SeriesViewerHorizontalScrollbarPosition_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(SeriesViewerHorizontalScrollbarPosition_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarPosition", b.oldValue, b.newValue);
    }));
    SeriesViewer.q0 = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarPosition", SeriesViewerVerticalScrollbarPosition_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(SeriesViewerVerticalScrollbarPosition_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarPosition", b.oldValue, b.newValue);
    }));
    SeriesViewer.pl = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarFill", Brush.$, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarFill", b.oldValue, b.newValue);
    }));
    SeriesViewer.pq = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarOutline", Brush.$, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarOutline", b.oldValue, b.newValue);
    }));
    SeriesViewer.pt = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarStrokeThickness", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarStrokeThickness", b.oldValue, b.newValue);
    }));
    SeriesViewer.po = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarMaxOpacity", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarMaxOpacity", b.oldValue, b.newValue);
    }));
    SeriesViewer.pk = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarCornerRadius", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarCornerRadius", b.oldValue, b.newValue);
    }));
    SeriesViewer.pm = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarHeight", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarHeight", b.oldValue, b.newValue);
    }));
    SeriesViewer.pn = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarInset", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.pv = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarTrackStartInset", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarTrackStartInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.pu = /*@__PURE__*/ DependencyProperty.i("HorizontalViewScrollbarTrackEndInset", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
    ...
    SeriesViewer.ps = /*@__PURE__*/ DependencyProperty.i(SeriesViewer.ik, Boolean_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, true, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl(SeriesViewer.ik, b.oldValue, b.newValue);
    }));
    SeriesViewer.qv = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarFill", Brush.$, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarFill", b.oldValue, b.newValue);
    }));
    SeriesViewer.qz = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarOutline", Brush.$, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarOutline", b.oldValue, b.newValue);
    }));
    SeriesViewer.q2 = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarStrokeThickness", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarStrokeThickness", b.oldValue, b.newValue);
    }));
    SeriesViewer.qx = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarMaxOpacity", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarMaxOpacity", b.oldValue, b.newValue);
    }));
    SeriesViewer.qu = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarCornerRadius", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarCornerRadius", b.oldValue, b.newValue);
    }));
    SeriesViewer.q5 = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarWidth", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarWidth", b.oldValue, b.newValue);
    }));
    SeriesViewer.qw = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarInset", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.q4 = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarTrackStartInset", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarTrackStartInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.q3 = /*@__PURE__*/ DependencyProperty.i("VerticalViewScrollbarTrackEndInset", Number_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
    ...
    SeriesViewer.q1 = /*@__PURE__*/ DependencyProperty.i(SeriesViewer.kh, Boolean_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, true, (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl(SeriesViewer.kh, b.oldValue, b.newValue);
    }));
    SeriesViewer.pg = /*@__PURE__*/ DependencyProperty.i("HighlightingBehavior", SeriesHighlightingBehavior_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(SeriesHighlightingBehavior_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("HighlightingBehavior", b.oldValue, b.newValue);
    }));
    SeriesViewer.pz = /*@__PURE__*/ DependencyProperty.i("LegendHighlightingMode", LegendHighlightingMode_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(LegendHighlightingMode_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("LegendHighlightingMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.p1 = /*@__PURE__*/ DependencyProperty.i("LegendItemBadgeShape", LegendItemBadgeShape_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(LegendItemBadgeShape_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("LegendItemBadgeShape", b.oldValue, b.newValue);
    }));
    SeriesViewer.p0 = /*@__PURE__*/ DependencyProperty.i("LegendItemBadgeMode", LegendItemBadgeMode_$type, SeriesViewer.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(LegendItemBadgeMode_$type, 0), (a, b) => {
        let c = typeCast(SeriesViewer.$, a);
        c.nl("LegendItemBadgeMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.sr = Rect.empty;
    SeriesViewer.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, SeriesViewer, 'nl', ['ActualPlotAreaBorderBrush:rj:o6', [Brush.$, null], 'Brushes:ag:o8', [BrushCollection.$, null], 'CircleMarkerTemplate:ov:o9', [DataTemplate.$, null], 'CrosshairVisibility:sz:pa', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'DefaultInteraction:ce:pb', [InteractionState_$type, /*@__PURE__*/ enumGetBox(InteractionState_$type, 3)], 'DiamondMarkerTemplate:ow:pc', [DataTemplate.$, null], 'DragModifier:rf:pd', [ModifierKeys_$type, /*@__PURE__*/ enumGetBox(ModifierKeys_$type, 2)], 'HexagonMarkerTemplate:ox:pe', [DataTemplate.$, null], 'HexagramMarkerTemplate:oy:pf', [DataTemplate.$, null], 'HighlightingTransitionDuration:he:pi', [1, 300], 'HorizontalCrosshairBrush:rt:pj', [Brush.$, null], 'IsPagePanningAllowed:eg:pw', [0, true], 'IsSurfaceInteractionDisabled:eh:px', [0, false], 'MarkerAutomaticBehavior:ba:p3', [MarkerAutomaticBehavior_$type, /*@__PURE__*/ enumGetBox(MarkerAutomaticBehavior_$type, 4)], 'MarkerBrushes:ah:p4', [BrushCollection.$, null], 'MarkerOutlines:ai:p5', [BrushCollection.$, null], 'Outlines:aj:p6', [BrushCollection.$, null], 'OverviewPlusDetailPaneVisibility:s0:p7', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 1)], 'PanModifier:rg:p8', [ModifierKeys_$type, /*@__PURE__*/ enumGetBox(ModifierKeys_$type, 4)], 'PentagonMarkerTemplate:oz:p9', [DataTemplate.$, null], 'PentagramMarkerTemplate:o0:qa', [DataTemplate.$, null], 'PlotAreaBackground:rw:qb', [Brush.$, null], 'PlotAreaBorderBrush:rx:qc', [Brush.$, null], 'PreferHigherResolutionTiles:e0:qd', [0, false], 'PreviewPathFill:ry:qe', [Brush.$, null], 'PreviewPathOpacity:gm:qf', [1, NaN], 'PreviewPathStroke:rz:qg', [Brush.$, null], 'PyramidMarkerTemplate:o1:qh', [DataTemplate.$, null], 'RightButtonDefaultInteraction:cg:qi', [InteractionState_$type, /*@__PURE__*/ enumGetBox(InteractionState_$type, 3)], 'ScrollbarsAnimationDuration:hf:qj', [1, 300], 'SquareMarkerTemplate:o2:ql', [DataTemplate.$, null], 'SubtitleHorizontalAlignment:rd:qm', [HorizontalAlignment_$type, /*@__PURE__*/ enumGetBox(HorizontalAlignment_$type, 1)], 'Subtitle:jk:qn', [2, null], 'TetragramMarkerTemplate:o3:qo', [DataTemplate.$, null], 'TitleHorizontalAlignment:re:qp', [HorizontalAlignment_$type, /*@__PURE__*/ enumGetBox(HorizontalAlignment_$type, 1)], 'Title:jw:qq', [2, null], 'TriangleMarkerTemplate:o4:qr', [DataTemplate.$, null], 'UseTiledZooming:fc:qs', [0, false], 'VerticalCrosshairBrush:r2:qt', [Brush.$, null], 'WindowPositionHorizontal:g4:q6', [1, NaN], 'WindowPositionVertical:g5:q7', [1, NaN], 'WindowRectMinWidth:g6:q8', [1, 0.0001], 'WindowRect:sv:q9', [Rect.$, /*@__PURE__*/ new Rect(0, 0, 0, 1, 1)], 'WindowResponse:b7:ra', [WindowResponse_$type, /*@__PURE__*/ enumGetBox(WindowResponse_$type, 1)], 'ZoomCoercionMode:cb:rb', [ZoomCoercionMode_$type, /*@__PURE__*/ enumGetBox(ZoomCoercionMode_$type, 0)], 'ZoomTileCacheSize:hg:rc', [1, 30]]);
    return SeriesViewer;
})();
/**
 * @hidden
...
export let SeriesViewerView = /*@__PURE__*/ (() => {
    class SeriesViewerView extends Base {
        constructor(a) {
            ...
            this.a7 = 0;
            this.p = a;
            this.p.r6 = { $type: Point_$type, x: NaN, y: NaN };
            this.p.b7 = 1;
        ...
        dn(a, b) {
            ...
            if (this.p.b7 == 1) {
                let d = this.p.su.width / this.p.su.height;
        ...
        c0(a) {
            ...
            if (this.k != null) {
                ...
                let i = this.k;
                i.onDragDelta = delegateCombine(i.onDragDelta, (i) => this.p.mf(i));
                let j = this.k;
                j.onDragStarted = delegateCombine(j.onDragStarted, (j) => this.p.mg(j, true));
                let k = this.k;
                ...
                if (this.k.an) {
                    let q = this.k;
                    q.onZoomDelta = delegateCombine(q.onZoomDelta, (q, r, s, t) => this.p.m8(q, r, s, t));
                    let r = this.k;
                    r.onZoomStarted = delegateCombine(r.onZoomStarted, (r, s, t, u) => this.p.nc(r, s, t, u));
                    let s = this.k;
                    ...
                    let t = this.k;
                    t.onPinchDelta = delegateCombine(t.onPinchDelta, (t, u) => this.p.mq(u));
                    let u = this.k;
                    u.onPinchStarted = delegateCombine(u.onPinchStarted, (u, v) => this.p.mr(u));
                    let v = this.k;
                    v.onGestureCompleted = delegateCombine(v.onGestureCompleted, (v, w) => this.p.mh(v));
                }
                let w = this.k;
                w.onDoubleTap = delegateCombine(w.onDoubleTap, (w) => this.p.md(w));
                let x = this.k;
        ...
        f(a, b, c, d) {
            return {
                ret: ((() => { let e = this.p.a5.f$d(this.p, this.g, this.x, a, b, c, d); c = e.p5; return e.ret; })()),
                p2: c
            };
        }
        bd() {
        ...
        ek() {
            if (this.p.cj != null && !this.e9.isEmpty) {
                let a = this.p.cj;
                let b = (this.p.dj) ? this.e9.width : Number.POSITIVE_INFINITY;
                let c = (this.p.dj) ? this.e9.height : Number.POSITIVE_INFINITY;
        ...
        fm() {
            let a = this.j.cd();
            let b = isNaN_(this.p.gv) ? a.top : this.p.gv;
            let c = isNaN_(this.p.gt) ? a.left : this.p.gt;
            let d = isNaN_(this.p.gu) ? a.right : this.p.gu;
            let e = isNaN_(this.p.gs) ? a.bottom : this.p.gs;
            return new Thickness(1, c, b, d, e);
        }
        fl() {
            let a = this.j.cc();
            let b = isNaN_(this.p.gr) ? a.top : this.p.gr;
            let c = isNaN_(this.p.gp) ? a.left : this.p.gp;
            let d = isNaN_(this.p.gq) ? a.right : this.p.gq;
            let e = isNaN_(this.p.go) ? a.bottom : this.p.go;
            return new Thickness(1, c, b, d, e);
        }
        dv(a) {
        }
...
export let SeriesViewerViewManager = /*@__PURE__*/ (() => {
    class SeriesViewerViewManager extends Base {
        ...
        az() {
            ...
            if (this.ae != null) {
                this.al = this.ae.setTimeout(() => this.j.p.a5.f$j(this.j.p), 5000);
            }
            else {
                this.al = window.setTimeout(() => this.j.p.a5.f$j(this.j.p), 5000);
            }
        }
        av() {
            if (this.al != -1) {
        ...
        a0(a) {
            ...
            if (this.ae != null) {
                this.am = this.ae.setTimeout(() => this.j.p.k7(), a);
            }
            else {
                this.am = window.setTimeout(() => this.j.p.k7(), a);
            }
        }
        aw() {
            if (this.am != -1) {
    ...
    class Axis extends Control {
        ...
        cf(a, b, c, d) {
            ...
            if (f != null && (f.tx || f.ty) && !c.isEmpty) {
                let g = this.bh.sf.width == 1 && this.bh.sf.height == 1;
                for (let h of fromEnum(f.axes)) {
                    ...
                    if (h.ai != null && h.b4()) {
                        if (f.tx) {
                            ...
                            let j = 0;
                            let k = h.id(i, j, h.bh.sv, c, h.j7(), d ? c.left : c.top, d ? c.right : c.bottom);
                            i = k.p0;
                            j = k.p1;
                            let l = Rect.empty;
                            let m = Rect.empty;
        ...
        ba() {
            ...
            if (this.di != c || this.bb == null) {
                this.di = c;
                let d = FontUtil.getCurrentFontHeight(this.bh.cq.j.ae, a);
                if (this.bb == null) {
        ...
        e3(a) {
            let b = this.j7();
            let c = new ScalerParams(0, this.bh.sf, this.kc, this.cg, b);
            return this.ei(a, c);
        }
        hs(a) {
            let b = false;
        ...
        a2() {
            ...
            if (typeCast(NumericAxisBase.$, this.ad) !== null) {
                ...
                for (let c = 0; c < d.length; c++) {
                    let b = d[c];
                    let e = this.ad.j7();
                    let f = new ScalerParams(0, this.ad.bh.sv, this.ad.kc, this.ad.ch, e);
...
export let CategoryAxisBase = /*@__PURE__*/ (() => {
    class CategoryAxisBase extends Axis {
        ...
        la(a, b, c) {
            let d = !isNaN_(this.k0) ? MathUtil.c(this.k0, 0, this.kz) : 0;
        ...
        *_kw() {
            ...
            if (this.bh != null && this.bh.ei && this.kt(this.bh)) {
                for (let b of fromEnum(this.bh.fg())) {
                    if (b != this.bh) {
    ...
    class NumericAxisBase extends Axis {
        ...
        h8(a) {
            ...
            if (this.lh && this.bh != null) {
                let b = this.j7();
                let c = this.j6();
                let d = this.kz(this.kc, this.bh.sf, b, c);
                if (d == null) {
                    return;
                }
...
export let XamDataChart = /*@__PURE__*/ (() => {
    class XamDataChart extends SeriesViewer {
        constructor() {
            ...
            this.tu = true;
            let a = this.axes;
            a.collectionChanged = delegateCombine(a.collectionChanged, runOn(this, this.vz));
            let b = this.axes;
            b.collectionResetting = delegateCombine(b.collectionResetting, runOn(this, this.v0));
        }
        get XSRP() {
            if (this._xsr == null) {
        ...
        get s8() {
            if (this.s7 == null) {
                this.s7 = DVContainer.instance.createInstance(IDataChartVisualDataManager_$type, () => this.XSRP.q);
            }
            return this.s7;
        }
        static staticInit() {
        ...
        uy(a, b, c, d) {
            ...
            if (e < f) {
                ...
                let y = this.cq.a4;
                let z = this.cq.a5;
                let aa = new Thickness(1, this.us + w, 0, this.ut + x, 0);
                let ab = (aa.left - y) + (aa.right - z);
                let ac = a.ad.j6().width;
                let ad = ac - ab;
                let ae = ad / ac;
                let af = a.bn() * ae;
                let ag = this.uq(af, a, b, c, d);
                if (ag == e) {
                    return e;
                }
                else {
        ...
        sh(a) {
            ...
            let c = new Rect(0, a.left + this.uh, a.top + this.uj, a.width - this.uh - this.ui, a.height - this.uj - this.ug);
            return c;
        }
        sn() {
            let a = this.su;
    ...
    XamDataChart.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, XamDataChart, 'nl', ['AlignsGridLinesToPixels:tm:wb', [0, true], 'AutoExpandMarginExtraPadding:um:wc', [1, /*@__PURE__*/ DeviceUtils.g(2)], 'AutoExpandMarginMaximumValue:un:wd', [1, 60], 'AutoMarginAndAngleUpdateMode:s1:we', [AutoMarginsAndAngleUpdateMode_$type, /*@__PURE__*/ enumGetBox(AutoMarginsAndAngleUpdateMode_$type, 0)], 'ComputedPlotAreaMarginMode:s4:wf', [ComputedPlotAreaMarginMode_$type, /*@__PURE__*/ enumGetBox(ComputedPlotAreaMarginMode_$type, 0)], 'DefaultAxisMajorStroke:w0:wg', [Brush.$, null], 'DefaultAxisMinorStroke:w1:wh', [Brush.$, null], 'DefaultAxisStroke:w2:wi', [Brush.$, null], 'GridMode:s6:wj', [GridMode_$type, /*@__PURE__*/ enumGetBox(GridMode_$type, 2)], 'HorizontalZoomable:tp:wk', [0, false], 'InitialCloseGridlinesThreshold:ur:wl', [1, NaN], 'IsHorizontalZoomEnabled:tq:wm', [0, false], 'IsSquare:ts:wn', [0, false], 'IsVerticalZoomEnabled:tt:wo', [0, false], 'SeriesPlotAreaMarginHorizontalMode:tb:wp', [SeriesPlotAreaMarginHorizontalMode_$type, /*@__PURE__*/ enumGetBox(SeriesPlotAreaMarginHorizontalMode_$type, 0)], 'SeriesPlotAreaMarginVerticalMode:te:wq', [SeriesPlotAreaMarginVerticalMode_$type, /*@__PURE__*/ enumGetBox(SeriesPlotAreaMarginVerticalMode_$type, 0)], 'ShouldAutoExpandMarginForInitialLabels:tw:wr', [0, false], 'ShouldClipGridlines:tx:ws', [0, true], 'ShouldClipInitialCloseGridlines:ty:wt', [0, true], 'ShouldConsiderAutoRotationForInitialLabels:tz:wu', [0, false], 'ShouldSuppressAxisLabelTruncation:t0:wv', [0, false], 'SuppressAutoMarginAndAngleRecalculation:t1:ww', [0, false], 'VerticalZoomable:t2:wx', [0, false], 'WindowScaleHorizontal:uz:wy', [1, NaN], 'WindowScaleVertical:u0:wz', [1, NaN]]);
    return XamDataChart;
})();
/**
 * @hidden
...
export let Series = /*@__PURE__*/ (() => {
    class Series extends Control {
        constructor() {
            ...
            this.bm = 0;
            this.co = null;
            this.pf = { $type: Point_$type, x: NaN, y: NaN };
            this.fo = NaN;
            this.fp = NaN;
            this.a4 = null;
            DVContainer.instance.registerIfLoaded("AnnotationFactoryManager");
            ...
            this.cl = (a, b) => {
                if (this.cd == null || !this.cd.d4) {
                    this.m5(b.oldRect, b.newRect);
                }
            };
            this.bd = (a, b) => this.l3(a, b.propertyName, b.oldValue, b.newValue);
            this.g5 = (a, b) => {
                if (this.cd != null) {
                    this.ez = true;
                    this.cd.lx();
            ...
            this.propertyUpdated = delegateCombine(this.propertyUpdated, (a, b) => this.l3(a, b.propertyName, b.oldValue, b.newValue));
            this.m9 = new Canvas();
        ...
        ao(a, b, c) {
            ...
            if (!this.isVertical) {
                ...
                let d = new ScalerParams(0, c, this.cd.su, b.cg, this.getEffectiveViewport());
                d.b = this.gc();
                let e = b.ei(a.c, d);
                let f = b.ei(a.b, d);
                if (b.cg) {
                ...
                let i = new ScalerParams(0, c, this.cd.su, b.cg, this.getEffectiveViewport());
                i.b = this.gc();
                let j = b.ei(a.c, i);
                let k = b.ei(a.b, i);
                if (!b.cg) {
        ...
        getEffectiveViewport1(a) {
            ...
            if (a.q) {
                ...
                let b = this.cd.so(a.bu, this.cd.su, this.cd.sj);
                return b;
            }
            return this.cd.sj;
        }
        pq(a) {
            ...
            if (a.q) {
                ...
                let b = this.cd.so(a.bu, this.cd.su, this.cd.sj);
                let c = this.cd.sm(a.bu, b, this.cd.sf);
                return c;
            }
            return this.cd.si;
        }
        ...
        l2(a) {
            ...
            let b = this.b0.bu;
            let c = this.b0.bv;
            let d = this.e9(b, c, this.b0);
            let e = this.cd != null && this.cd.ej && this.bz != null && this.e9(this.bz.bu, this.bz.bv, this.bz);
            if (d) {
                if (a) {
                    this.es = !this.em();
                    this.k3(false);
        ...
        m7() {
            let a = typeCast(ContentControl.$, this.m6);
        ...
        static fe(a, b, c) {
            return toEnum(() => Series._fe(a, b, c));
        }
        static fd(a, b) {
        ...
        ch(a) {
            ...
            let b = null;
            let c = SeriesViewer.cc(a, this.coercionMethods);
            b = c.a;
        ...
        hs() {
            let a = this.a8.exportVisualData(this, this.py);
            this.k7(a);
            this.b0.al(a);
            return a;
        }
    ...
    Series.ha = 0;
    Series.os = /*@__PURE__*/ DependencyProperty.i("VisibilityProxy", Visibility_$type, Series.$, /*@__PURE__*/ new PropertyMetadata(2, /*@__PURE__*/ enumGetBox(Visibility_$type, 0), (a, b) => a.raisePropertyChanged("VisibilityProxy", b.oldValue, b.newValue)));
    Series.nz = /*@__PURE__*/ DependencyProperty.i("ItemsSource", IEnumerable_$type, Series.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
    ...
    Series.n5 = /*@__PURE__*/ DependencyProperty.i("Legend", IChartLegend_$type, Series.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(Series.$, a);
        c.raisePropertyChanged("Legend", b.oldValue, b.newValue);
    }));
    Series.n2 = /*@__PURE__*/ DependencyProperty.i("LegendItemBadgeTemplate", DataTemplate.$, Series.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(Series.$, a);
    ...
    Series.n3 = /*@__PURE__*/ DependencyProperty.i("LegendItemTemplate", DataTemplate.$, Series.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(Series.$, a);
    ...
    Series.nq = /*@__PURE__*/ DependencyProperty.i("DiscreteLegendItemTemplate", DataTemplate.$, Series.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => {
        let c = typeCast(Series.$, a);
        c.raisePropertyChanged("DiscreteLegendItemTemplate", b.oldValue, b.newValue);
    }));
    Series.nu = /*@__PURE__*/ DependencyProperty.i("Index", Number_$type, Series.$, /*@__PURE__*/ new PropertyMetadata(2, -1, (a, b) => {
        let c = typeCast(Series.$, a);
    ...
    Series.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, Series, 'raisePropertyChanged', ['ActualAreaFillOpacity:fq:ne', [1, 1], 'ActualBrush:oy:nf', [Brush.$], 'ActualLegendItemBadgeBrush:oz:ng', [Brush.$], 'ActualLegendItemBadgeOutline:o0:nh', [Brush.$], 'ActualLegendItemBadgeTemplate:na:ni', [DataTemplate.$], 'ActualMarkerFillOpacity:fs:nj', [1, 1], 'ActualOutline:o1:nk', [Brush.$], 'ActualThickness:fu:nl', [1, /*@__PURE__*/ DeviceUtils.g(2)], 'AreaFillOpacity:fz:nm', [1, NaN], 'Brush:o2:nn', [Brush.$, null], 'DashArray:pb:no', [DoubleCollection.$], 'DashCap:pc:np', [PenLineCap_$type, /*@__PURE__*/ enumGetBox(PenLineCap_$type, 0)], 'EndCap:pd:nr', [PenLineCap_$type, /*@__PURE__*/ enumGetBox(PenLineCap_$type, 2)], 'FastItemsSource:ck:ns', [IFastItemsSource_$type], 'HighlightingFadeOpacity:gp:nt', [1, NaN], 'IsActualLegendFinancial:c7:nv', [0, false], 'IsComponentHighlightingModeIgnored:di:nw', [0, false], 'IsDropShadowEnabled:dm:nx', [0, false], 'IsHighlightingEnabled:dw:ny', [0, false], 'LegendItemBadgeMode:a9:n0', [LegendItemBadgeMode_$type, /*@__PURE__*/ enumGetBox(LegendItemBadgeMode_$type, 0)], 'LegendItemBadgeShape::n1', [LegendItemBadgeShape_$type, /*@__PURE__*/ enumGetBox(LegendItemBadgeShape_$type, 0)], 'LegendItemVisibility:p2:n4', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'MarkerFillOpacity:gq:n6', [1, NaN], 'MiterLimit:gr:n7', [1, 0], 'MouseOverEnabled:el:n8', [0, true], 'OutlineMode:bt:n9', [SeriesOutlineMode_$type, /*@__PURE__*/ enumGetBox(SeriesOutlineMode_$type, 0)], 'Outline:o7:oa', [Brush.$, null], 'Resolution:gt:ob', [1, NaN], 'ShadowBlur:gw:oc', [1, NaN], 'ShadowColor:pa:od', [Color.$], 'ShadowOffsetX:gx:oe', [1, NaN], 'ShadowOffsetY:gy:of', [1, NaN], 'ShowDefaultTooltip:er:og', [0, false], 'StartCap:pe:oh', [PenLineCap_$type, /*@__PURE__*/ enumGetBox(PenLineCap_$type, 2)], 'Thickness:gz:oi', [1, /*@__PURE__*/ DeviceUtils.g(2)], 'Title::oj', [4, "Series Title"], 'ToolTip::ok', [4, null], 'TransitionDuration:hm:ol', [1, 0], 'TransitionEasingFunction:cf:om', [Delegate_$type, null], 'TransitionInDuration:hn:on', [1, 1000], 'TransitionInEasingFunction:cg:oo', [Delegate_$type, null], 'TransitionInSpeedType:ca:op', [TransitionInSpeedType_$type, /*@__PURE__*/ enumGetBox(TransitionInSpeedType_$type, 0)], 'TransitionProgress:g0:oq', [1, 0], 'UseSingleShadow:e7:or', [0, true], 'VisibleRangeMarginBottom:g1:ot', [1, NaN], 'VisibleRangeMarginLeft:g2:ou', [1, NaN], 'VisibleRangeMarginRight:g3:ov', [1, NaN], 'VisibleRangeMarginTop:g4:ow', [1, NaN], 'VisibleRangeMode:b4:ox', [SeriesVisibleRangeMode_$type, /*@__PURE__*/ enumGetBox(SeriesVisibleRangeMode_$type, 0)]]);
    return Series;
})();
/**
 * @hidden
...
export let MarkerSeries = /*@__PURE__*/ (() => {
    class MarkerSeries extends Series {
        ...
        mv() {
            ...
            if (this.qb.b2()) {
                ...
                let a = MarkerSeries.qd(this, this.qc);
                let b = MarkerSeries.ql(a);
                if (b == null) {
    ...
    MarkerSeries.q3 = /*@__PURE__*/ DependencyProperty.i("MarkerBrush", Brush.$, MarkerSeries.$, /*@__PURE__*/ new PropertyMetadata(1, (a, b) => {
        let c = (typeCast(MarkerSeries.$, a));
        c.raisePropertyChanged("MarkerBrush", b.oldValue, b.newValue);
    }));
    MarkerSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, MarkerSeries, 'raisePropertyChanged', ['ActualMarkerBrush:rc:q0', [Brush.$], 'ActualMarkerOutline:rd:q1', [Brush.$], 'ActualMarkerTemplate:qw:q2', [DataTemplate.$, null], 'MarkerFillMode:p5:q4', [MarkerFillMode_$type, /*@__PURE__*/ enumGetBox(MarkerFillMode_$type, 0)], 'MarkerOutlineMode:p9:q5', [MarkerOutlineMode_$type, /*@__PURE__*/ enumGetBox(MarkerOutlineMode_$type, 0)], 'MarkerOutline:rf:q6', [Brush.$], 'MarkerStyle:rg:q7', [Style.$], 'MarkerTemplate:qy:q8', [DataTemplate.$, null], 'MarkerThickness:qh:q9', [1, /*@__PURE__*/ DeviceUtils.g(2)], 'MarkerType:qc:ra', [MarkerType_$type, /*@__PURE__*/ enumGetBox(MarkerType_$type, 1)], 'UseLightweightMarkers:qg:rb', [0, false]]);
    return MarkerSeries;
})();
/**
 * @hidden
    ...
    class SyncLink extends FrameworkElement {
        ...
        ax(a, b, c, d) {
            if (!c.isEmpty) {
                ...
                let i = c.width;
                let j = c.height;
                let k = MathUtil.c(c.width, e, 1);
                let l = MathUtil.c(c.height, e, 1);
                let m = false;
                if (a.fa() && !a.su.isEmpty) {
                    ...
                    let af = new Rect(0, z, ab, aa - z, ac - ab);
                    let ag = [v, w];
                    let ah = [x, y];
                    for (let ai = 0; ai < b.series.count; ai++) {
                        let aj = b.series._inner[ai];
                        if (aj.dc) {
                            continue;
                        }
                        {
                    ...
                    let al = (v == 1.7976931348623157E+308 || w == -1.7976931348623157E+308 || isNaN_(v) || isNaN_(w));
                    let am = (x == 1.7976931348623157E+308 || y == -1.7976931348623157E+308 || isNaN_(x) || isNaN_(y));
                    if (!al || !am) {
                        if (al) {
                ...
                let an = k != i;
                let ao = l != j;
                let ap = an && !m ? g - 0.5 * k : c.left;
                let aq = ao && !m ? h - 0.5 * l : c.top;
                let ar = an && !m ? g + 0.5 * k : c.right;
                let as = ao && !m ? h + 0.5 * l : c.bottom;
                if (b.b9 == 1) {
                    if (ap < 0) {
                        ap = 0;
                        ar = ap + k;
        ...
        ab(a, b, c, d) {
            ...
            if (h != null) {
                ...
                let k = new ScalerParams(0, j, j, h.cg, b.so(j, b.su, b.sj));
                k.b = a.gc();
                let l = a.aq(c);
    ...
    class AxisLabelPanelBaseView extends Base {
        ...
        as() {
            if (this.a.ad != null && this.a.ad.bh != null) {
                ...
                let c = FontUtil.getCurrentFontHeight(this.a.ad.bh.cq.j.ae, b);
                this.h = c;
                if (a != this.h) {
                    this.a.ad.bh.lj();
                }
...
export let NumericAxisBaseView = /*@__PURE__*/ (() => {
    class NumericAxisBaseView extends AxisView {
        ...
        r(a) {
            let b = this.bh.ky.d(this.bh.kc, this.bh.bh.sf, this.bh.j7(), this.bh.j6());
    ...
    class MarkerSeriesView extends SeriesView {
        ...
        b9() {
            if (!isNaN_(this.e.fs) && this.e.fs != 1) {
                let a = BrushUtil.o(this.b1.re, this.e.fs);
                this.b1.rc = a;
            }
            else {
