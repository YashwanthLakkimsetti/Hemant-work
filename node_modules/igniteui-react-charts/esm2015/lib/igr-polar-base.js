...
export class IgrPolarBase extends IgrMarkerSeries {
    ...
    */
    get angleAxis() {
        ...
        if (!this.i.rt.externalObject) {
            let e = IgrNumericAngleAxis._createFromInternal(this.i.rt);
            if (e) {
                e._implementation = this.i.rt;
            }
            this.i.rt.externalObject = e;
        }
        return this.i.rt.externalObject;
    }
    set angleAxis(v) {
        if (v != null && this._stylingContainer && v._styling)
            v._styling(this._stylingContainer, this, this);
        v == null ? this.i.rt = null : this.i.rt = v.i;
    }
    /**
    ...
    */
    get radiusAxis() {
        ...
        if (!this.i.ru.externalObject) {
            let e = IgrNumericRadiusAxis._createFromInternal(this.i.ru);
            if (e) {
    ...
    */
    ...
    set trendLineType(v) {
        this.i.sb = ensureEnum(TrendLineType_$type, v);
    }
    /**
