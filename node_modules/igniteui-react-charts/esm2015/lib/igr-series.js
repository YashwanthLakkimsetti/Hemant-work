...
*/
    ...
    */
    ...
    set legendItemVisibility(v) {
        this.i.p2 = ensureEnum(Visibility_$type, v);
    }
    /**
    ...
    */
    get shadowColor() {
        return colorToString(this.i.pa);
    }
    set shadowColor(v) {
        this.i.pa = stringToColor(v);
    }
    /**
...
*/
    ...
    */
    toWorldPosition(seriesPoint) {
        let iv = this.i.po(toPoint(seriesPoint));
        return fromPoint(iv);
    }
    /**
    ...
    */
    fromWorldPosition(world) {
        let iv = this.i.pg(toPoint(world));
        return fromPoint(iv);
    }
    /**
