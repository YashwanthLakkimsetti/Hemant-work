...
export let CalloutLayer = /*@__PURE__*/ (() => {
    class CalloutLayer extends AnnotationLayer {
                ...
                if (d != null) {
                    ...
                    if (this.rm != null) {
                        ...
                        if (this.cd != null && this.cd.series.count > 0) {
                            h = true;
                            for (let i of fromEnum(this.cd.series)) {
                                if (!i.dc) {
                                    if (!i.isVertical) {
                                        h = false;
                                    }
        ...
        r0() {
            ...
            for (let a = 0; a < this.cd.series.count; a++) {
                let b = this.cd.series._inner[a];
        ...
        r2(a) {
            ...
            if (b == null) {
                for (let c = 0; c < this.cd.series.count; c++) {
                    let d = this.cd.series._inner[c];
                    if (!d.dc) {
                        b = d;
                        break;
                    }
