    ...
    class PieLabel extends Control {
        ...
        ak(a) {
            if (a.a.az == 3) {
                ...
                let e = GeometryUtil.m(d, this.ai, this.ah.a2 + a.a.c9);
                let f = a.b4.width;
...
export let PieChartBase = /*@__PURE__*/ (() => {
    class PieChartBase extends Control {
        constructor() {
            ...
            this.cl = new List$1(Number_$type, 0);
            this.ck = new List$1(Base.$, 0);
            this.a7 = (b, c) => this.gp(b, c.propertyName, c.oldValue, c.newValue);
            this.cs = (b, c) => {
                this.gw();
                this.gv();
            };
            ...
            this.cu = (b, c) => this.gy(c);
            this.cv = (b, c) => this.ge(c);
            this.di = (b, c) => this.fu(c.action, c.position, c.count, c.propertyName);
            this.propertyUpdated = delegateCombine(this.propertyUpdated, this.a7);
            let b = this.selectedSlices;
            b.collectionChanged = delegateCombine(b.collectionChanged, this.cu);
            this.b2 = true;
            let c = this.explodedSlices;
            c.collectionChanged = delegateCombine(c.collectionChanged, this.ct);
            this.bz = true;
            ...
            this.bv = ((() => {
                ...
                $ret.create = runOn(this.a3, this.a3.g);
                $ret.activate = runOn(this.a3, this.a3.bf);
                $ret.disactivate = runOn(this.a3, this.a3.bh);
                $ret.destroy = runOn(this.a3, this.a3.bg);
                return $ret;
            })());
            this.bu = ((() => {
                let $ret = new Pool$1(PieLabel.$);
                $ret.create = runOn(this.a3, this.a3.d);
                $ret.activate = runOn(this.a3, this.a3.as);
                $ret.disactivate = runOn(this.a3, this.a3.au);
                $ret.destroy = runOn(this.a3, this.a3.at);
                return $ret;
            })());
            this.a6 = new PieChartSliceSelector(this);
        ...
        b8(a, b) {
            ...
            let d = c.b6();
            let e = this.iz == 1 ? c.a3 : c.ax;
            let f = this.iz == 1 ? c.ax : c.a3;
            let g = false;
            let h = false;
            ...
            let k;
            k = MathUtil.f(a.ao.right - d.x, a.ao.top - d.y);
            if (k > c.a2) {
                return false;
            }
            k = MathUtil.f(a.ao.right - d.x, a.ao.bottom - d.y);
            if (k > c.a2) {
                return false;
            }
            k = MathUtil.f(a.ao.left - d.x, a.ao.top - d.y);
            if (k > c.a2) {
                return false;
            }
            k = MathUtil.f(a.ao.left - d.x, a.ao.bottom - d.y);
            if (k > c.a2) {
                return false;
            }
            if (h) {
        ...
        gx(a) {
            ...
            let b = this.a3.b4.width;
            let c = this.a3.b4.height;
            let d = a.count;
        ...
        gm() {
            ...
            for (let a of fromEnum(this.bt)) {
                if (isNaN_(a) || isInfinity(a) || a <= 0) {
                    continue;
                }
                this.dh = this.dh + a;
            }
            for (let b = 0; b < this.bt.count; b++) {
                let c = this.bt.item(b);
                let d = c <= 0;
                if (isNaN_(c) || isInfinity(c) || d) {
                    continue;
                }
                let e = this.a1 == 1 ? c / this.dh : c;
                let f = this.a1 == 1 ? this.db / 100 : this.db;
                let g = true;
                if (e <= f && g) {
                    this.dc = this.dc + c;
                    this.cl.add(b);
        ...
        go() {
            ...
            let a = this.cm.count;
            let b = this.cl.count > 0;
            let c = PieChartBase.df(this.c2);
            let d = PieChartBase.df(this.c2);
            if (b) {
                a++;
            }
            this.dk = a;
        ...
        gn() {
            ...
            for (let c = 0; c < a; c++) {
                ...
                let f;
                let g = null;
                if (c == a - 1 && this.cl.count > 0) {
                    f = this.fe();
                    e = true;
                    if (this.b9() || this.ap != null || this.as != null) {
                        let h = ((() => {
                            let $ret = new PieSliceDataContext();
                            $ret.series = this;
                            $ret.item = e ? this.ck : this.bk.item(this.cm._inner[c]);
                            $ret.percentValue = this.c7(this.bv.item(c));
                            $ret.isOthersSlice = e;
                            return $ret;
                        })());
                        if (f != null) {
                    ...
                    if (this.bp != null && this.bp.count >= this.cm.count) {
                        f = this.bp.item(this.cm._inner[c]);
                    }
                    else {
                        f = null;
                    }
                    g = (this.bq != null && this.bq.count > 0) ? this.bq.item(this.cm._inner[c]) : null;
                    if (this.b9() || this.ap != null || this.as != null) {
                        let j = ((() => {
                            let $ret = new PieSliceDataContext();
                            $ret.series = this;
                        ...
                        if ((this.ap != null && !e) || (this.as != null && e)) {
                            ...
                            formattedLabel_ = this.a4(k);
                        }
                        if (null == formattedLabel_ && this.bp != null && this.bp.count > 0) {
                            f = this.bp.item(this.cm._inner[c]);
                        }
                        else {
                            f = formattedLabel_;
                ...
                if (this.bp != null && this.bp.count > 0) {
                    let l = this.bu.item(c);
                    let m = this.bv.item(c);
                    m.aj = l;
                    ...
                    if (this.g9 == null) {
                        l.dataContext = e ? this.ck : this.bk.item(this.cm._inner[c]);
                        l.ak(this.a3);
                    }
                    else {
                    }
        ...
        gw() {
            ...
            for (let i of fromEnum(this.bv.a)) {
                let j = GeometryUtil.l(a.width, a.height, true, (i.a3 + i.ax) / 2, f * this.cy);
                i.aw = true;
                i.a1 = this.cz;
                i.a0 = this.cz;
                i.a2 = f;
        ...
        gu() {
            let a = this.a3.b4.width;
            let b = this.a3.b4.height;
            if (b == 0 || a == 0) {
                return;
            }
            ...
            for (let g of fromEnum(this.bu.a)) {
                let h = g.ah;
                if (h == null) {
                    continue;
                }
                ...
                if (this.az == 2 || this.az == 4) {
                    let o = PieChartBase.c5(i, h.a2, g);
                ...
                h.au = false;
                let r = GeometryUtil.m(i, g.ai, h.a2 + this.c9);
                g.ag = 3;
                g._visibility = 0;
                g.al();
                if (g.ai < 90 && g.ai >= 0) {
        ...
        gv() {
            ...
            for (let a of fromEnum(this.bv.a)) {
                ...
                b.content = ((() => {
                    ...
                    $ret.legendLabel = a.isOthersSlice ? this.fe() : a.bf != null ? a.bf : (c != null ? c.toString() : null);
                    $ret.percentValue = this.c7(a);
                    $ret.isOthersSlice = a.isOthersSlice;
                    return $ret;
                })());
                let f = b.content;
                if (this.ca() || this.aq != null || this.ar != null) {
                    let g = null;
                    if (this.ca()) {
                        g = this.a5(b.content);
                    }
        ...
        g8() {
            ...
            if (this.bi == 1) {
                if (a != 0) {
                    let b = this.bv.a._inner[this.selectedSlices._inner[a - 1]];
                    if (b.isOthersSlice) {
                        this.selectedItem = ((() => {
        ...
        g4(a, b, c) {
            ...
            let d = new SliceClickEventArgs(a, this.a3.af(b));
            this.gh(this, d);
            if (!c) {
                this.a3.bo(a, b);
            }
        ...
        ce(a, b) {
            let c = new LabelClickEventArgs(a, this.a3.af(b));
            this.ga(this, c);
    ...
    PieChartBase.hm = /*@__PURE__*/ DependencyProperty.i("InnerExtent", Number_$type, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(2, 0, (a, b) => a.gr("InnerExtent", b.oldValue, b.newValue)));
    PieChartBase.hx = /*@__PURE__*/ DependencyProperty.i("LabelTemplate", DataTemplate.$, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => a.gr("LabelTemplate", b.oldValue, b.newValue)));
    PieChartBase.ij = /*@__PURE__*/ DependencyProperty.i("SelectedItem", Base.$, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(1, (a, b) => {
    ...
    PieChartBase.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, PieChartBase, 'gr', ['ActualBrushes:ak:ha', [BrushCollection.$, null], 'ActualItemsSource::hb', [IEnumerable_$type, null], 'ActualLabelInnerColor:iu:hc', [Brush.$, null], 'ActualLabelOuterColor:iv:hd', [Brush.$, null], 'ActualOutlines:al:he', [BrushCollection.$, null], 'AllowSliceExplosion:b6:hf', [0, true], 'AllowSliceSelection:b7:hg', [0, true], 'Brushes:am:hh', [BrushCollection.$, null], 'ExplodedRadius:c3:hi', [1, 0.2], 'FastItemsSource:bk:hj', [FastItemsSource.$], 'FormatLabel:a4:hk', [Delegate_$type], 'FormatLegendLabel:a5:hl', [Delegate_$type], 'IsDragInteractionEnabled:cc:hn', [0, false], 'IsSurfaceInteractionDisabled:cd:ho', [0, false], 'ItemsSource::hp', [IEnumerable_$type, null], 'LabelExtent:c9:hq', [1, 10], 'LabelFormat:ed:hr', [2, null], 'LabelFormatSpecifiers:ag:hs', [Array_$type, null], 'LabelInnerColor:iw:ht', [Brush.$, null], 'LabelMemberPath:eh:hu', [2], 'LabelOuterColor:ix:hv', [Brush.$, null], 'LabelsPosition:az:hw', [LabelsPosition_$type, /*@__PURE__*/ enumGetBox(LabelsPosition_$type, 1)], 'LeaderLineMargin:da:hy', [1, 6], 'LeaderLineStyle:i6:hz', [Style.$, null], 'LeaderLineType:a0:h0', [LeaderLineType_$type, /*@__PURE__*/ enumGetBox(LeaderLineType_$type, 0)], 'LeaderLineVisibility:ja:h1', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'LegendItemBadgeTemplate::h2', [DataTemplate.$, null], 'LegendItemTemplate::h3', [DataTemplate.$, null], 'LegendLabelFormat:et:h4', [2, null], 'LegendLabelFormatSpecifiers:ah:h5', [Array_$type, null], 'LegendLabelMemberPath:ew:h6', [2], 'LegendOthersLabelFormat:ey:h7', [2, null], 'LegendOthersLabelFormatSpecifiers:ai:h8', [Array_$type, null], 'Legend::h9', [IChartLegend_$type, null], 'OthersCategoryStyle:i7:ia', [Style.$, null], 'OthersCategoryText:e3:ib', [2, null], 'OthersCategoryThreshold:db:ic', [1, 3], 'OthersCategoryType:a1:id', [OthersCategoryType_$type, /*@__PURE__*/ enumGetBox(OthersCategoryType_$type, 1)], 'OthersLabelFormat:e7:ie', [2, null], 'OthersLabelFormatSpecifiers:aj:ig', [Array_$type, null], 'Outlines:an:ih', [BrushCollection.$, null], 'RadiusFactor:de:ii', [1, 0.9], 'SelectedStyle:i8:ik', [Style.$, null], 'SelectionMode:bi:il', [SliceSelectionMode_$type, /*@__PURE__*/ enumGetBox(SliceSelectionMode_$type, 1)], 'ShouldDisplayMockData:cf:im', [0, false], 'ShouldUseSkeletonStyleForMockData:cg:io', [0, false], 'StartAngle:dg:ip', [1, 0], 'SweepDirection:iz:iq', [SweepDirection_$type, /*@__PURE__*/ enumGetBox(SweepDirection_$type, 1)], 'ToolTip:dp:ir', [4, null], 'ToolTipStyle:i9:is', [Style.$, null], 'ValueMemberPath:fs:it', [2, null]]);
    return PieChartBase;
})();
/**
 * @hidden
...
export let Slice = /*@__PURE__*/ (() => {
    class Slice extends ContentControl {
        ...
        az() {
            let a = Math.abs(PieChartBase.df(this.ax - this.a3)) == 360;
            if (a) {
                return this.a2;
            }
            return this.a2;
        ...
        cb() {
            let a = (this.ai != null && this.ai.b6) ? true : false;
            let b = this.az();
        ...
        bk() {
            ...
            let g = Slice.b4(MathUtil.n(this.a3), c, f, d, 100);
            let h = Slice.b4(MathUtil.n(this.ax), c, f, d, 100);
            let i = Slice.b4(MathUtil.n(this.ax), c, f, this.a2, this.a0);
            let j = Slice.b4(MathUtil.n(this.a3), c, f, this.a2, this.a1);
            let k = Math.abs(PieChartBase.df(this.ax - this.a3)) == 360;
            if (k) {
                if (this.a0 == 0) {
                    let l = ((() => {
            ...
            if (ar && this.b8.height > 0 && this.b8.width > 0 && !b.containsRect(aq)) {
                ...
                let az = GeometryUtil.l(this.ai.i5.width, this.ai.i5.height, true, au, this.a2 * this.ai.cy - ay);
