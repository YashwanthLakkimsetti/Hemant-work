...
export let CategoryXAxis = /*@__PURE__*/ (() => {
    class CategoryXAxis extends CategoryAxisBase {
        ...
        c2() {
            ...
            let a = this.kq.count;
            if (a != this.mu) {
                let b = new AxisRangeChangedEventArgs(0, 1, 1, this.mu, a);
                this.mu = a;
                this.h2(b);
                return true;
            }
    ...
    CategoryXAxis.m3 = /*@__PURE__*/ DependencyProperty.i("Interval", Number_$type, CategoryXAxis.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        a.h1("Interval", b.oldValue, b.newValue);
        a.h7(false);
    }));
    CategoryXAxis.m4 = /*@__PURE__*/ DependencyProperty.i("MinorInterval", Number_$type, CategoryXAxis.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
