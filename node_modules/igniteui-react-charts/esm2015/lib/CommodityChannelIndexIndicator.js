...
export let CommodityChannelIndexIndicator = /*@__PURE__*/ (() => {
    class CommodityChannelIndexIndicator extends StrategyBasedIndicator {
        ...
        get u1() {
            return typeGetValue(this.c(CommodityChannelIndexIndicator.u2));
        }
        set u1(a) {
            this.h(CommodityChannelIndexIndicator.u2, a);
        }
        um() {
            return this.u1;
        }
    ...
    CommodityChannelIndexIndicator.u2 = /*@__PURE__*/ StrategyBasedIndicator.uy(20, CommodityChannelIndexIndicator.$);
    return CommodityChannelIndexIndicator;
})();
