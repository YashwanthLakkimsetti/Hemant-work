...
export class IgrShapeSeriesBase extends IgrSeries {
    ...
    */
    ...
    set itemSearchMode(v) {
        this.i.qq = ensureEnum(ShapeItemSearchMode_$type, v);
    }
    /**
    ...
    */
    get xAxis() {
        ...
        if (!this.i.qk.externalObject) {
            let e = IgrNumericXAxis._createFromInternal(this.i.qk);
            if (e) {
    ...
    */
    get yAxis() {
        ...
        if (!this.i.qm.externalObject) {
            let e = IgrNumericYAxis._createFromInternal(this.i.qm);
            if (e) {
