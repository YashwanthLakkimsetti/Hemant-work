...
export let TimeXAxis = /*@__PURE__*/ (() => {
    class TimeXAxis extends TimeAxisBase {
        ...
        ov() {
            ...
            let b = this.bh.sf;
            let c = new ScalerParams(0, this.bh.sf, this.bh.su, this.cg, this.bh.sj);
        ...
        nh() {
            ...
            let a = new ScalerParams(0, this.bh.sf, this.bh.su, this.cg, this.bh.sj);
            let b = this.j6();
            let c = b.left;
            let d = b.right;
            let e = b.left;
        ...
        i$f(a) {
            ...
            let i = c.item(g);
            let j = c.item(h);
            let k = new ScalerParams(0, this.bh.sv, this.kc, this.cg, this.bh.sj);
            this.startCursor();
        ...
        getCategorySize(a, b, c) {
            if (this.ou != (0)) {
                let d = timeSpanFromTicks(truncate((timeSpanTicks(this.ou) * (a.width / (this.bh != null ? this.bh.sf.width : 1)))));
