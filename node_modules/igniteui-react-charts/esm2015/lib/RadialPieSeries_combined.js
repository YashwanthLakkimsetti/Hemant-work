...
export let RadialPieSeries = /*@__PURE__*/ (() => {
    class RadialPieSeries extends AnchoredRadialSeries {
        ...
        sp(a, b) {
            ...
            let g = this.pq(b);
            let h = this.rr.kz(e, d, f, g);
            let i = a.f;
            let j = this.rr;
            let k = Math.max(0, 0.5 * j.nl);
            let l = k;
            l = Math.max(l, h.minLength);
            let m = this.rk.k3(d, e, f);
            ...
            let u = this.rk;
            let v = new ScalerParams(1, b.bv, b.bu, u.cg);
    ...
    RadialPieSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, RadialPieSeries, 'raisePropertyChanged', ['RadiusX:t7:ub', [1, 2], 'RadiusY:t8:uc', [1, 2]]);
