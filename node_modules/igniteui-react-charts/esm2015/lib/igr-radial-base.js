...
export class IgrRadialBase extends IgrMarkerSeries {
    ...
    */
    get angleAxis() {
        ...
        if (!this.i.rk.externalObject) {
            let e = IgrCategoryAngleAxis._createFromInternal(this.i.rk);
            if (e) {
                e._implementation = this.i.rk;
            }
            this.i.rk.externalObject = e;
        }
        return this.i.rk.externalObject;
    }
    set angleAxis(v) {
        if (v != null && this._stylingContainer && v._styling)
            v._styling(this._stylingContainer, this, this);
        v == null ? this.i.rk = null : this.i.rk = v.i;
    }
    /**
    ...
    */
    get valueAxis() {
        ...
        if (!this.i.rr.externalObject) {
            let e = IgrNumericRadiusAxis._createFromInternal(this.i.rr);
            if (e) {
    ...
    */
    getAngleFromWorld(world) {
        let iv = this.i.sb(toPoint(world));
        return (iv);
    }
    /**
