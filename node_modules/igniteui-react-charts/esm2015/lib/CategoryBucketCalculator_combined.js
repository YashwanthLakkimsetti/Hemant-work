    ...
    class CategoryBucketCalculator extends Base {
        ...
        g(a) {
            ...
            if (i == null || i.i$b == null) {
                ...
                let k = Math.floor(e.em(h.left, j, 0));
                let l = Math.ceil(e.em(h.right, j, 0));
                if (e.cg) {
...
export let CategoryFramePreparerBase = /*@__PURE__*/ (() => {
    class CategoryFramePreparerBase extends FramePreparer {
        ...
        t(a, b, c, d, e) {
            ...
            let k = a.m;
            let l = a.l;
            let m = typeCast(NumericAxisBase.$, a.c) !== null && a.c.lh;
            let n = a.f;
            ...
            let x = ((() => {
                ...
                $ret.b = typeCast(Series.$, this.h) !== null ? this.h.gc() : NaN;
                return $ret;
            })());
            if (j) {
...
export let CategorySeries = /*@__PURE__*/ (() => {
    class CategorySeries extends MarkerSeries {
        constructor() {
            ...
            this.r4 = null;
            this.r5 = null;
            this.rq = new CategoryFrame(3);
            this.rs = new CategoryFrame(3);
            this.ro = new CategoryFrame(3);
            this.rr = new CategoryFrame(3);
            this.rw = null;
            this.r0 = null;
            this.rw = new CategorySeriesRenderManager();
            this.r0 = new CategoryTransitionSourceFramePreparer();
            this.sa = false;
            this.r9 = false;
        ...
        get r7() {
            if (this.r6 == null) {
                this.r6 = DVContainer.instance.createInstance(ICategorySeriesInteractionManager_$type, () => this.cn.n);
            }
            return this.r6;
        }
        c1(a, b, c, d) {
            ...
            let f = this.rn();
            let g = new ScalerParams(1, this.cd.sf, this.py, f.cg);
            g.c = e;
            let h = this.r8();
            let i = new ScalerParams(1, this.cd.sf, this.py, h.cg);
            i.c = e;
            let j = this.cd.sf;
            let k = this.py;
            ...
            this.qb.cf((n) => {
                if (n._visibility == 0) {
                    ...
                    let p = n.n;
                    let q = n.o;
                    if (p < this.py.left || p > this.py.right || q < this.py.top || q > this.py.bottom) {
                        return;
                    }
                    if (this.isVertical) {
        ...
        ax(a, b, c) {
            if (this.ef(this.bk) && !c) {
                let d = this.r3(a, b, this.r5);
                this.r5 = d;
                return d;
            }
            else {
                let e = this.r1(a, b, this.r5);
                e.e = true;
                this.r5 = e;
                return e;
            }
        ...
        aw(a, b, c) {
            if (this.c2 && this.ef(this.bk) && !c) {
                let d = this.r2(a, b, this.r4);
                this.r4 = d;
                return d;
            }
            else {
                let e = this.r1(a, b, this.r4);
                this.r4 = e;
                return e;
            }
        }
        ...
        r2(a, b, c) {
            let d = this.sp(this.b0);
            let e = this.sq(this.b0);
            let f = this.so(this.b0);
            let g = this.rp();
        ...
        mj(a, b) {
            ...
            let c = typeCast(CategorySeriesView.$, this.bz);
            c.cr.g(this.ft);
            this.b0.a2(b);
            if (this.cx(this.bz)) {
                return;
        ...
        s7() {
            let a = typeCast(CategorySeriesView.$, this.bz);
            if (!this.et) {
                this.s3(this.rr, a);
            }
            this.et = false;
