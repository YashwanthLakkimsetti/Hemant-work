...
export class IgrCategoryHighlightLayer extends IgrAnnotationLayer {
    ...
    */
    get targetAxis() {
        ...
        if (!this.i.q7.externalObject) {
            let e = IgrCategoryAxisBase._createFromInternal(this.i.q7);
            if (e) {
                e._implementation = this.i.q7;
            }
            this.i.q7.externalObject = e;
        }
        return this.i.q7.externalObject;
    }
    set targetAxis(v) {
