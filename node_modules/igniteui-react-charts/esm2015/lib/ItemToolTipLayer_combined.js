...
export let ItemToolTipLayer = /*@__PURE__*/ (() => {
    ...
    ItemToolTipLayer.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, ItemToolTipLayer, 'raisePropertyChanged', ['SkipUnknownValues:ra:rk', [0, true], 'TargetSeriesName:re:rl', [2, null], 'TargetSeries:q8:rm', [Series.$, null], 'UseInterpolation:rb:rn', [0, false]]);
...
export let ItemToolTipLayerView = /*@__PURE__*/ (() => {
    class ItemToolTipLayerView extends AnnotationLayerView {
        constructor(a) {
            ...
            this._htmlTest = null;
            this.b4 = a;
            this.b7 = new List$1(PointerTooltip.$, 0);
        }
        as() {
            super.as();
            this.b5 = ((() => {
        ...
        aj() {
            super.aj();
            for (let a = 0; a < this.b5.a.count; a++) {
                this.b5.a._inner[a].br();
            }
            for (let b = 0; b < this.b5.b.count; b++) {
        ...
        cg(a, b, c) {
            ...
            d.cx = 1;
            let g = d.cw(new Size(1, Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY));
            d.cx = 0;
            return g;
        }
        cf(a, b, c, d, e) {
        ...
        a6(a, b) {
            ...
            for (let g = 0; g < this.b7.count; g++) {
                this.b7._inner[g].bx(this.b7._inner[g].n + c, this.b7._inner[g].o + d);
            }
        }
        al(a) {
            super.al(a);
            for (let tooltip_ of fromEnum(this.b5.a)) {
