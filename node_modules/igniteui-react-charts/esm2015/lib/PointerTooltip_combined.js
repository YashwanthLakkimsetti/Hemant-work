...
export let PointerTooltip = /*@__PURE__*/ (() => {
    class PointerTooltip extends ContentControl {
        constructor() {
            ...
            this.cv = null;
            this.av = false;
            this.cj = { $type: Point_$type, x: NaN, y: NaN };
            this.al = 0;
            this.ax = 0;
            this.aw = 0;
            this.ap = null;
            ...
            this.propertyUpdated = delegateCombine(this.propertyUpdated, (a, b) => this.bu(a, b.propertyName, b.oldValue, b.newValue));
        ...
        cw(a) {
            ...
            b = d.width;
            c = d.height;
            if (this.al == this.am && this.au(this.cj.x, this.cr.x) && this.au(this.cj.y, this.cr.y)) {
                this.a1 = b;
                this.a0 = c;
                if (this.cx == 0) {
                    b += this.ax;
        ...
        bx(a, b) {
            if (this.av) {
                this.cw(new Size(1, Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY));
            }
            this.an.x(a, b);
        }
        bv(a) {
    ...
    PointerTooltip.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, PointerTooltip, 'bw', ['ActualBoxBottomLeftPosition:ck:b0', [Point_$type, { $type: Point_$type, x: 0, y: 0 }], 'ActualBoxBottomRightPosition:cl:b1', [Point_$type, { $type: Point_$type, x: 0, y: 0 }], 'ActualBoxFullHeight:ay:b2', [1, 0], 'ActualBoxFullWidth:az:b3', [1, 0], 'ActualBoxHeight:a0:b4', [1, 0], 'ActualBoxTopLeftPosition:cm:b5', [Point_$type, { $type: Point_$type, x: 0, y: 0 }], 'ActualBoxTopRightPosition:cn:b6', [Point_$type, { $type: Point_$type, x: 0, y: 0 }], 'ActualBoxWidth:a1:b7', [1, 0], 'ActualPointerFirstPosition:co:b8', [Point_$type, { $type: Point_$type, x: 0, y: 0 }], 'ActualPointerSecondPosition:cp:b9', [Point_$type, { $type: Point_$type, x: 0, y: 0 }], 'ActualPointerStartPosition:cq:ca', [Point_$type, { $type: Point_$type, x: 0, y: 0 }], 'PixelScalingRatio:a2:cb', [1, NaN], 'PointerInset:a3:cc', [1, /*@__PURE__*/ DeviceUtils.g(7.5)], 'PointerLocation:am:cd', [PointerTooltipPointerLocation_$type, /*@__PURE__*/ enumGetBox(PointerTooltipPointerLocation_$type, 0)], 'PointerOutlinePoints:cs:ce', [PointCollection.$, null], 'PointerPoints:ct:cf', [PointCollection.$, null], 'PointerPosition:cr:cg', [Point_$type, { $type: Point_$type, x: 0, y: 0 }], 'PointerVisibility:cx:ch', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'PointerWidth:a4:ci', [1, /*@__PURE__*/ DeviceUtils.g(5)]]);
...
export let PointerTooltipView = /*@__PURE__*/ (() => {
    class PointerTooltipView extends Base {
        constructor(a) {
            ...
            this.l = null;
            this.a = a;
            this.a.cu = new Polygon();
            this.a.cv = new Polyline();
            this.n = null;
            this.v();
        }
        v() {
        ...
        x(a, b) {
            ...
            if (d != null) {
                let cont_ = this.o;
                let xPos_ = this.a.cm.x.toString() + "px";
                let yPos_ = this.a.cm.y.toString() + "px";
            ...
            if (e != null) {
                ...
                k.ac = !isNaN_(e.b) ? e.b : 1;
                k.am = !isNaN_(e.a) ? e.a : 0;
                k.an = !isNaN_(e.a) ? e.a : 0;
            }
            else {
                k._fill = ((() => {
                    let $ret = new Brush();
        ...
        s() {
            return this.a.ak.exportPointerTooltipData(this.a.cu, this.a.cv, this.y, new Rect(0, 0, 0, this.a.az, this.a.ay));
        }
        d(a) {
            let b = this.g;
            let c = this.e;
            let d = this.z(new Size(1, Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY));
