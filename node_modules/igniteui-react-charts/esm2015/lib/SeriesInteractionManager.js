...
export let SeriesInteractionManager = /*@__PURE__*/ (() => {
    class SeriesInteractionManager extends Base {
        ...
        a$m(a, b, c, d, e, f, g, h, i) {
            ...
            let j = a.e8;
            let k = a.hk(c, i, d, g, b);
            let l = a.hi(c, i, d, g, b);
            let m = a.f3(c, k, d, e, f);
            let n = a.f3(c, l, d, e, f);
            let o = k;
            let p = l;
            let q = d.cm;
            if (q && !j) {
        ...
        a$al(a, b, c, d, e, f, g, h, i, j) {
            ...
            if (!c && g != null) {
                ...
                r.c = a.cd.sj;
                let s = a.f3(b, p, g, r, e);
                let t = a.f3(b, q, g, r, e);
                let u = q;
                let v = p;
                if (g.cm) {
                    let w = g;
        ...
        a$ai(a, b) {
            ...
            let d = null;
            let e;
            let f = ((() => { let g = a.cd.cq.f(b, false, e, false); e = g.p2; return g.ret; })());
            if (f != a) {
                if (this.a$c) {
        ...
        a$r(a) {
            let b = new Color();
            let c = a != null && a.cd != null && a.cd.cq != null && a.cd.cq.j != null ? a.cd.cq.j.ae : null;
            c.startCSSQuery();
        ...
        a$aj(a, b) {
            ...
            if (typeof b === 'string') {
                ...
                if (this._toolTipObject != null) {
                    ...
                    let d = a.o1 != null && Color.e(toNullable(Color.$, a.o1.color), toNullable(Color.$, null)) && a.o1.color.l > 0;
                    if (d) {
