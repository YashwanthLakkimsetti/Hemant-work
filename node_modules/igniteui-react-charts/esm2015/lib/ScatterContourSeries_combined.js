...
export let ScatterContourSeries = /*@__PURE__*/ (() => {
    class ScatterContourSeries extends ScatterTriangulationSeries {
        constructor() {
            ...
            this.rx = new LinearContourValueResolver();
        }
        get_d0() {
            return true;
        }
        hw(a, b) {
            ...
            if (c == ScatterContourSeries.$$p[4]) {
                return this.hx(a, b, this.sa);
            }
            return super.hw(a, b);
        }
        bx() {
            this.ry = new ScatterContourSeriesView(this);
            return this.ry;
        }
        get r2() {
            return this.r1;
        ...
        set r2(a) {
            ...
            if (b) {
                let c = this.r2;
                this.r1 = a;
                this.raisePropertyChanged("ValueColumn", c, this.r2);
            }
        }
        getDataLegendSeriesContextAt(a, b) {
            ...
            let g = d == null ? NaN : this.gb(d, "ValueMemberPath");
            let h = new DataLegendSeriesValueInfo();
            h.a = 13;
            h.l = e;
            h.p = this.q5 != null ? this.q5 : "X";
            h.q = this.q1 != null ? this.q1 : "X:";
            h.r = this.q3 != null ? this.q3 : "";
            let i = new DataLegendSeriesValueInfo();
            i.a = 14;
            i.l = f;
            i.p = this.rd != null ? this.rd : "Y";
            i.q = this.q9 != null ? this.q9 : "Y:";
            i.r = this.rb != null ? this.rb : "";
            let j = new DataLegendSeriesValueInfo();
            j.a = 0;
            j.l = g;
            j.p = this.sa != null ? this.sa : "Value";
            j.q = this.r6 != null ? this.r6 : "V:";
            j.r = this.r8 != null ? this.r8 : "";
        ...
        l3(a, b, c, d) {
            ...
            switch (b) {
                case "FastItemsSource":
                    ...
                    if (e != null) {
                        e.deregisterColumn(this.r2);
                        this.r2 = null;
                    }
                    let f = typeCast(IFastItemsSource_$type, d);
                    if (f != null) {
                        this.r2 = this.ch(this.sa);
                    }
                    this.mh(false);
                    break;
        ...
        sd(a) {
            ...
            c = e.p0;
            b = e.p1;
            let f = new ScalerParams(1, b, c, this.p3.cg);
            f.c = this.getEffectiveViewport1(a);
            let g = new ScalerParams(1, b, c, this.p4.cg);
            g.c = this.getEffectiveViewport1(a);
            let h = this.p3;
            let i = this.p4;
            let j = this.qd.count;
            let k;
            let xArr_ = this.qg.asArray();
            k = (xArr_.slice(0));
            let l;
            let yArr_ = this.qh.asArray();
            l = (yArr_.slice(0));
            let m = this.r2.asArray();
            let n = this.qd.asArray();
            let o = this.qe.asArray();
            let p = this.qf.asArray();
            let q = this.rx.j(this.r2);
        ...
        se() {
            ...
            if (this.r0 == null || this.r0.brushes == null || this.r0.brushes.count == 0) {
                b.brushes.add(BrushUtil.l(a, -0.5));
                b.brushes.add(a);
            }
            else {
                for (let c of fromEnum(this.r0.brushes)) {
                    b.brushes.add(c);
                }
            }
            if (this.r0 != null) {
                if (!isNaN_(this.r0.minimumValue)) {
                    b.minimumValue = this.r0.minimumValue;
                }
                if (!isNaN_(this.r0.maximumValue)) {
                    b.maximumValue = this.r0.maximumValue;
                }
                b.logarithmBase = this.r0.logarithmBase;
                b.isLogarithmic = this.r0.isLogarithmic;
            }
            this.rz = b;
        }
        get rx() {
        ...
        set rx(a) {
            ...
            if (b) {
                if (this.rw != null) {
                    let c = this.rw;
                    c.updated = delegateRemove(c.updated, runOn(this, this.sf));
                }
                let d = this.rw;
                this.rw = a;
                if (this.rw != null) {
                    let e = this.rw;
                    e.updated = delegateCombine(e.updated, runOn(this, this.sf));
                }
        ...
        e9(a, b, c) {
            return super.e9(a, b, c) && this.rx != null && this.qg != null && this.qh != null && this.qd != null && this.qe != null && this.qf != null && this.qg.count > 0 && this.qh.count > 0 && this.qd.count > 0 && this.qe.count > 0 && this.qf.count > 0;
        }
        at(a, b) {
            let c = this.ry.b7(a, b);
            if (c != null) {
    ...
    ScatterContourSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, ScatterContourSeries, 'raisePropertyChanged', ['ActualFillScale:rz:sg', [ValueBrushScale.$, null], 'FillScale:r0:sh', [ValueBrushScale.$, null], 'ValueMemberAsLegendLabel:r6:si', [2, null], 'ValueMemberAsLegendUnit:r8:sj', [2, null], 'ValueMemberPath:sa:sk', [2, null]]);
    ...
    class ScatterContourSeriesView extends SeriesView {
        ...
        b2(a, b) {
            ...
            for (let e = 0; e < b.length; e++) {
                ...
                if (d != null) {
                    let m = d.getBrushByValue(f, this.by.r2);
                    if (m == null) {
                        m = this.e.oy;
                    }
                    this.b0.add(m);
        ...
        getDefaultTooltipTemplate() {
            ...
            if (!stringIsNullOrEmpty(this.by.sa)) {
                ...
                if (e != null) {
                    for (let f = 0; f < e.c.count; f++) {
                        ...
                        for (let i = 0; i < g._segments.count; i++) {
                            ...
                            if (j != null) {
                                let k = this.by.fu / 2 + this.by.f8(b);
