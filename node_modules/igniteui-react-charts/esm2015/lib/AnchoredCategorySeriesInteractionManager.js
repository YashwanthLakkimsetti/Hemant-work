...
export let AnchoredCategorySeriesInteractionManager = /*@__PURE__*/ (() => {
    class AnchoredCategorySeriesInteractionManager extends Base {
        c$b(a, b, c, d, e, f, g, h) {
            ...
            let i = truncate(Math.round(a.f5(b)));
            if (i < 0 || i >= a.ck.count) {
                return h(b);
            }
            let j = intDivide(i, c);
            ...
            let m = a.pq(a.b0);
            let n = new ScalerParams(0, a.cd.sv, a.cd.su, f.cg, a.cd.sj);
            let o = m.top;
            let p = m.bottom;
            let q = o + (p - o) * b.y;
            let r = f.el(q, n);
        ...
        c$a(a, b, c, d, e, f) {
            ...
            let j = !g.isEmpty && !h.isEmpty && a.ck != null ? a.ck.indexOf(f) : -1;
            let k = a.ps(a.b0);
        ...
        c$d(a, b, c, d, e, f, g, h) {
            ...
            let j = a.b0.bv;
            let k = a.b0.bu;
            let l = a.getEffectiveViewport1(a.b0);
            let m = new ScalerParams(0, j, k, d.cg, l);
            m.b = a.gc();
            let n = a.aj(a.ar(), e.f, f, g, b, true);
            if (n == null) {
                return Rect.empty;
            }
            let o = n[0];
