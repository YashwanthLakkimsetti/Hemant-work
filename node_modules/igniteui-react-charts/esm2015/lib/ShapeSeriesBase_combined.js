...
export let ShapeSeriesBase = /*@__PURE__*/ (() => {
    class ShapeSeriesBase extends Series {
        constructor() {
            ...
            this.qr = new ShapeSeriesRenderManager();
        ...
        r2(a) {
            ...
            let e = this.qs.b2(b, false, !this.qx);
            if (e != null) {
                c = RectUtil.l(e.d);
        ...
        r1(a) {
            ...
            let h = this.qs.b2(b, false, !this.qx);
            if (h != null) {
                let i = RectUtil.l(h.d);
                let j = this.r0(b, h.a, this.qx);
            ...
            for (let q = 0; q < g.count; q++) {
                ...
                if (s < f) {
                    let t = this.r0(b, g._inner[q].a, this.qx);
                    if (t.c < o) {
                        o = t.c;
                        e = t.d;
                        p = q;
        ...
        aw(a, b, c) {
            if (this.c2 && this.ef(this.bk) && !c) {
                let d = this.qf(a, b, this.qh);
                this.qh = d;
                return d;
            }
            else {
                let e = this.qe(a, b, this.qh);
                this.qh = e;
                return e;
            }
        }
        ax(a, b, c) {
            if (this.ef(this.bk) && !c) {
                let d = this.qg(a, b, this.qi);
                this.qi = d;
                return d;
            }
            else {
                let e = this.qe(a, b, this.qi);
                e.e = true;
                this.qi = e;
                return e;
            }
        ...
        re(a, b, c, d, e, f, g) {
            ...
            if (typeCast(List$1.$.specialize(List$1.$.specialize(Point_$type)), c) !== null) {
                ...
                let l = c;
                let m = this.qd(a, b, PointCollectionUtil.b(l), d, e, f, g);
        ...
        sa(a) {
            ...
            if (!this.es) {
                ...
                for (let aj = 0; aj < p; aj++) {
                    ...
                    if (k.intersectsWith(c)) {
                        ...
                        let ak = this.re(a, ai, w.item(aj), i, j, 0, ag);
                        if (ad) {
                        ...
                        if (k.intersectsWith(c)) {
                            ...
                            let al = this.re(a, ai, w.item(aj), i, j, ag, ag);
                            if (ad) {
            ...
            d.cm((as) => {
                ...
                d.cj(as, at, am);
                if (an) {
                    this.r6(as, aq, au, this.qu.count, ap, ar);
                }
                else {
                    if (ar) {
                        {
                            this.qr.az(as, this.fr, ar);
                        }
                    }
                }
                {
                    this.qr.ad(as, false, false, false, false);
                }
            });
        }
        r6(a, b, c, d, e, f) {
        ...
        e9(a, b, c) {
            let d = true;
            if (!super.e9(a, b, c) || (this.q6 && this.qu == null) || b.isEmpty || a.isEmpty || this.qk == null || this.qm == null || this.qk.bh == null || this.qm.bh == null || this.qk.lv == this.qk.lu || this.qm.lv == this.qm.lu || this.qu == null || this.qu.count == 0 || this.rc == null || this.rc.count == 0 || this.rc.count != this.qu.count) {
                d = false;
            }
            return d;
        }
        ...
        qd(a, b, c, d, e, f, g) {
            ...
            let t = !(l > this.sn.right || n < this.sn.left || m > this.sn.bottom || o < this.sn.top);
            if (!t && f == 0 && g != 0) {
                if (g != 0) {
                    for (let u = 0; u < k; u++) {
                        i[u] = i[u] + g;
            ...
            let w = b != null && (l < this.sn.left || m < this.sn.top || n > this.sn.right || o > this.sn.bottom);
            ...
            let y = PolySimplification.b(h, this.ft);
            let z = new DefaultFlattener().c(h.c, h.d, y, this.rg);
            let aa = z.count;
            if (w) {
        ...
        b2(a, b, c) {
            ...
            for (let i = 0; i < f; i++) {
                ...
                if (d >= h.d.left && d <= h.d.right && e >= h.d.top && e <= h.d.bottom) {
                    if (c) {
                        let j = this.b3.fu / 2 + this.b3.f8(b);
