...
export let CategoryYAxis = /*@__PURE__*/ (() => {
    class CategoryYAxis extends CategoryAxisBase {
        ...
        c2() {
            ...
            let a = this.kq.count;
            if (a != this.mr) {
                let b = new AxisRangeChangedEventArgs(0, 1, 1, this.mr, a);
                this.mr = a;
                this.h2(b);
                return true;
            }
    ...
    CategoryYAxis.mz = /*@__PURE__*/ DependencyProperty.i("Interval", Number_$type, CategoryYAxis.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
        a.h1("Interval", b.oldValue, b.newValue);
        a.h7(false);
    }));
    CategoryYAxis.m0 = /*@__PURE__*/ DependencyProperty.i("MinorInterval", Number_$type, CategoryYAxis.$, /*@__PURE__*/ new PropertyMetadata(2, NaN, (a, b) => {
