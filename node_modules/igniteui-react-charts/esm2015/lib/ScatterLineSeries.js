...
export let ScatterLineSeries = /*@__PURE__*/ (() => {
    class ScatterLineSeries extends ScatterBase {
        ...
        tw(a, b) {
            ...
            let f = this.ft * this.ft;
            let g = 0;
            if (this.sc != null) {
                g = this.sc.count;
            }
            if (this.sd != null) {
                g = Math.min(this.sd.count, g);
            }
            let h = new ScalerParams(0, c, d, this.rw.d, e);
            let i = ((() => {
                let $ret = new ScalerParams(0, c, d, this.rw.e, e);
                $ret.b = this.gc();
                return $ret;
            })());
            let j = arrayShallowClone(this.sc.asArray());
            let k = arrayShallowClone(this.sd.asArray());
        ...
        t7(a, b) {
            ...
            d = RectUtil.t(d, this.fu, this.fu);
            this.t0(a, new Clipper(0, d, false));
            let e = typeCast(ScatterLineSeriesView.$, b);
            this.r9.ax(this, this.sp(), runOn(this, this.rk));
            let f = false;
            let g = this.r9.b;
            if (g != null) {
                f = true;
            ...
            if (f) {
                this.ts(-1, this.sc.count, b.q);
            }
            this.r9.ad(e.dg, true, false, true, false);
            this.u7(e.dg, a.m.count, (h) => a.m._inner[h].x, (h) => a.m._inner[h].y, this.u1, this.ft);
        }
        u7(a, b, c, d, e, f) {
            ...
            for (let j = 0; j < b; j++) {
                if (isNaN_(c(j)) || isNaN_(d(j))) {
                    ...
                    if (k > 0) {
                        ...
                        this.u6(h._inner[h.count - 1]._points, i, j - 1, c, d, f);
                    }
                    i = j + 1;
                }
            }
            ...
            this.u6(h._inner[h.count - 1]._points, i, b - 1, c, d, f);
        ...
        u6(a, b, c, d, e, f) {
            if (c > -1) {
                let g = !isNaN_(this.gt) ? f : 1;
                let h = this.u3(new List$1(Number_$type, 0), d, e, b, c, g);
                let i;
    ...
    ScatterLineSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, ScatterLineSeries, 'raisePropertyChanged', ['UnknownValuePlotting:u1:u8', [UnknownValuePlotting_$type, /*@__PURE__*/ enumGetBox(UnknownValuePlotting_$type, 1)]]);
