...
export let RangeColumnSeries = /*@__PURE__*/ (() => {
    class RangeColumnSeries extends HorizontalRangeCategorySeries {
        ...
        pu(a) {
            ...
            f.b = this.gc();
            let g = this.aj(this.rn(), this.ro.f, this.so(this.b0), this.sp(this.b0), a, true);
            if (g == null) {
                return Rect.empty;
            }
            let h = g[0];
    ...
    RangeColumnSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, RangeColumnSeries, 'raisePropertyChanged', ['RadiusX:ue:ui', [1, 0], 'RadiusY:uf:uj', [1, 0]]);
