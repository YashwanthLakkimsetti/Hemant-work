...
export let AxisAnnotationFrameManager = /*@__PURE__*/ (() => {
    class AxisAnnotationFrameManager extends Base {
        ...
        static c(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
            ...
            if (v != null) {
                let aa = new ScalerParams(1, d.sf, v.kc, v.cg);
                aa.c = e;
                let ab = v.el(b.x, aa);
                a.q.add(ab);
                a.p.add(ab);
            ...
            if (w != null) {
                let ac = new ScalerParams(1, d.sf, w.kc, w.cg);
                ac.c = e;
                let ad = w.el(b.y, ac);
                a.ac.add(ad);
                a.ab.add(ad);
            ...
            for (let n = 0; n < b.q.count; n++) {
                ...
                if (o != null) {
                    ...
                    if (!d.containsKey(o)) {
                        ...
                        p.activate = (q) => o.an.add(q);
                        p.disactivate = (q) => o.an.remove(q);
                        d.item(o, p);
                        e.add(o);
                    }
                    else {
            ...
            for (let t = 0; t < b.ac.count; t++) {
                ...
                if (u != null) {
                    ...
                    if (!d.containsKey(u)) {
                        ...
                        v.activate = (w) => u.an.add(w);
                        v.disactivate = (w) => u.an.remove(w);
                        d.item(u, v);
                        e.add(u);
                    }
                    else {
