...
var RadialPieSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialPieSeries.prototype.get_d4 = function () {
        return true;
    };
    RadialPieSeries.prototype.get_d2 = function () {
        return true;
    };
    RadialPieSeries.prototype.gu = function () {
        if (!isNaN_(this.gt)) {
            return _super.prototype.gu.call(this);
        }
        return Defaults.h;
    };
    RadialPieSeries.prototype.bx = function () {
        return new RadialPieSeriesView(this);
    };
    RadialPieSeries.prototype.ly = function (a) {
    ...
    RadialPieSeries.prototype.kx = function (a, b) {
    ...
    RadialPieSeries.prototype.ga = function () {
        return this.rk.k3(this.b0.bv, this.b0.bu, this.getEffectiveViewport1(this.b0));
    };
    RadialPieSeries.prototype.get_c2 = function () {
        return true;
    };
    RadialPieSeries.prototype.sp = function (a, b) {
        ...
        var u = this.rk;
        var v = new ScalerParams(1, b.bv, b.bu, u.cg);
        ...
        for (var x = 0; x < i.count; ++x) {
            ...
            var ad = null;
            if (q) {
                ad = this.ud(d, e, z - (m * 0.5), z + (m * 0.5), l, aa, n, ab, ac);
            }
            else {
                ad = this.ue(d, e, z - (m * 0.5), z + (m * 0.5), l, aa, n);
            }
            y.ak = ad;
            this.ry.ad(y, false, false, false, false);
            var ae = i._inner[x][2];
            if (ae > w) {
                w = ae;
            }
    ...
    RadialPieSeries.prototype.ue = function (a, b, c, d, e, f, g) {
    ...
    RadialPieSeries.prototype.ud = function (a, b, c, d, e, f, g, h, i) {
        var j = SliceCoords.a(a, b, c, d, e, f, g, h, i);
        if (j == null) {
            return this.ue(a, b, c, d, e, f, g);
        }
    ...
    RadialPieSeries.prototype.l3 = function (a, b, c, d) {
    ...
    RadialPieSeries.$$p = markDep(DependencyProperty, PropertyMetadata, RadialPieSeries, 'raisePropertyChanged', ['RadiusX:t7:ub', [1, 2], 'RadiusY:t8:uc', [1, 2]]);
    ...
    RadialPieSeriesView.prototype.al = function (a) {
        ...
        try {
            for (var _b = __values(fromEnum(this.c1.a)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
                this.e.a8.exportPathData(a, c, "slice" + b, ["Main", "Fill"]);
                b++;
            }
        }
        catch (e_1_1) {
