...
var RangeAreaSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RangeAreaSeries.prototype.bx = function () {
        return new RangeAreaSeriesView(this);
    };
    RangeAreaSeries.prototype.ly = function (a) {
        _super.prototype.ly.call(this, a);
        this.ud = a;
    };
    RangeAreaSeries.prototype.get_de = function () {
        return true;
    };
    RangeAreaSeries.prototype.get_dd = function () {
        return true;
    };
    RangeAreaSeries.prototype.ue = function (a, b, c, d) {
    ...
    RangeAreaSeries.prototype.ev = function (a, b) {
        if (this.eu(a, b)) {
            return true;
        }
        if (this.qf(a, b)) {
    ...
    RangeAreaSeries.prototype.kx = function (a, b) {
        _super.prototype.kx.call(this, a, b);
        var c = b;
        c.c3();
    };
    RangeAreaSeries.prototype.s6 = function (a, b) {
        ...
        if (k) {
            var m = new ScalerParams(0, b.bv, b.bu, this.xAxis.cg, j);
            this.s2(d, -1, this.lowColumn.count, this.xAxis, m, b.q);
        }
        var n = i.dc;
        var o = i.dd;
        var p = i.c7;
        this.rw.ad(n, true, false, true, true);
        this.rw.ad(o, true, false, true, true);
        this.rw.ad(p, false, true, false, false);
        if (b.cv(a)) {
            i.c4(a.f.count, d, false);
            b.cy(a);
        }
        i.c7._opacity = this.rw.j * this.fq;
    };
...
var RangeAreaSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RangeAreaSeriesView.prototype.al = function (a) {
        ...
        this.e.a8.exportPolylineData(a, this.da, "lowerShape", ["Lower"]);
        this.e.a8.exportPolylineData(a, this.db, "upperShape", ["Upper", "Main"]);
        this.e.a8.exportPolygonData(a, this.c6, "fillShape", ["Fill"]);
    };
