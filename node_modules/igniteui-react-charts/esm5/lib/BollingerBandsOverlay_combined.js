...
var BollingerBandsOverlay = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function BollingerBandsOverlay() {
        ...
        _this.tt = 0;
        _this.tu = 0;
        _this.tr = new List$1(Number_$type, 0);
        _this.ts = new List$1(Number_$type, 0);
        _this.ab = BollingerBandsOverlay.$;
        _this.qf = new CategoryFrame(4);
        _this.qh = new CategoryFrame(4);
        _this.qd = new CategoryFrame(4);
        return _this;
    }
    BollingerBandsOverlay.prototype.l3 = function (a, b, c, d) {
    ...
    BollingerBandsOverlay.prototype.tm = function () {
        this.tr.clear();
        this.ts.clear();
        var a = getEnumerator(TrendCalculators.e(new SafeEnumerable(this.rt), this.tw));
        var b = getEnumerator(TrendCalculators.f(new SafeEnumerable(this.rt), this.tw));
    ...
    BollingerBandsOverlay.prototype.ap = function (a) {
        ...
        var b = new AxisRange(this.tu, this.tt);
        return b;
    };
    BollingerBandsOverlay.prototype.s2 = function (a, b) {
        ...
        a.m.clear();
        a.p.clear();
        var j = typeCast(ISortingAxis_$type, this.qb);
        ...
        i.b = this.gc();
        var l = this.qb.el(2, h) - this.qb.el(1, h);
    ...
    BollingerBandsOverlay.prototype.kx = function (a, b) {
    ...
    BollingerBandsOverlay.prototype.s4 = function (a, b) {
        ...
        if (k) {
            var o = new ScalerParams(0, b.bv, b.bu, this.qb.cg, d);
    ...
    BollingerBandsOverlay.prototype.bx = function () {
        return new BollingerBandsOverlayView(this);
    };
    BollingerBandsOverlay.prototype.ly = function (a) {
        _super.prototype.ly.call(this, a);
        this.tq = typeCast(BollingerBandsOverlayView.$, a);
    };
    BollingerBandsOverlay.prototype.sb = function () {
        return 3;
    };
    BollingerBandsOverlay.prototype.gc = function () {
    ...
    BollingerBandsOverlay.$$p = markDep(DependencyProperty, PropertyMetadata, BollingerBandsOverlay, 'raisePropertyChanged', ['Multiplier:tv:tz', [1, 2], 'Period:tw:t0', [1, 14]]);
...
var BollingerBandsOverlayView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    BollingerBandsOverlayView.prototype.b5 = function (a, b, c, d, e, f) {
        ...
        try {
            for (var _d = __values(fromEnum(Flattener.d(a, b, d, this.e.ft))), _e = _d.next(); !_e.done; _e = _d.next()) {
                var g = _e.value;
        ...
        try {
            for (var _f = __values(fromEnum(Flattener.d(a, b, e, this.e.ft))), _g = _f.next(); !_g.done; _g = _f.next()) {
                var h = _g.value;
        ...
        try {
            for (var _h = __values(fromEnum(Flattener.d(a, c, f, this.e.ft))), _j = _h.next(); !_j.done; _j = _h.next()) {
                var i = _j.value;
