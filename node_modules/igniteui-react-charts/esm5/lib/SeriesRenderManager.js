...
var SeriesRenderManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SeriesRenderManager.prototype.w = function (a, b, c) {
        ...
        if (d) {
            ...
            this.d.m = 0;
            if (a.cd != null && a.bk != 1) {
                this.d.j = a.cd.a3.maxMarkerHighlightingProgress;
                this.d.l = a.cd.a3.sumMarkerHighlightingProgress;
                this.d.m = a.cd.a3.totalHighlightingProgress;
            }
            this.d.a = c;
        }
    };
    ...
    SeriesRenderManager.prototype.x = function (a, b, c) {
        ...
        if (d) {
            ...
            this.b.m = 0;
            if (a.cd != null && a.bk != 1) {
                this.b.j = a.cd.a3.maxHighlightingProgress;
                this.b.l = a.cd.a3.sumHighlightingProgress;
                this.b.m = a.cd.a3.totalHighlightingProgress;
            }
            this.b.a = c;
        }
    };
    ...
    SeriesRenderManager.prototype.u = function (a, b, c, d, e, f) {
        if (a.bk == 1) {
            return;
        }
    ...
    SeriesRenderManager.prototype.v = function (a, b, c, d, e) {
        if (a.bk == 1) {
            return;
        }
    ...
    SeriesRenderManager.prototype.z = function (a, b, c, d, e) {
        var f = this.b;
        this.ag = f.p;
        this.ah = f.q;
        this.m = f.t;
    ...
    SeriesRenderManager.prototype.y = function (a, b, c, d, e, f) {
        var g = this.d;
        this.ae = g.p;
        this.af = g.q;
        this.g = g.k;
