...
var SeriesViewer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function SeriesViewer() {
        ...
        _this.er = false;
        _this.dm = false;
        _this.bw = new SeriesViewerComponentsForView();
        _this.da = false;
        _this.ar = 0;
        _this.aq = 1;
        ...
        _this.hh = null;
        _this.ff = new Dictionary$2(String_$type, Base.$, 0);
        _this.ep = false;
        _this.f2 = NaN;
        _this.fr = NaN;
        _this.ft = NaN;
        ...
        _this.fh = new List$1(IDataLegend_$type, 0);
        ...
        _this.sa = Rect.empty;
        _this.r5 = { $type: Point_$type, x: NaN, y: NaN };
        _this.fi = dateNow();
        _this.d7 = false;
        _this.d8 = false;
        ...
        SeriesViewer.sr = new Rect(0, 0, 0, 1, 1);
        ...
        _this.oq(null, _this.actualSyncLink);
        _this.ap = new ChartContentManager(_this);
        _this.propertyUpdated = delegateCombine(_this.propertyUpdated, function (a, b) { return _this.nh(a, b.propertyName, b.oldValue, b.newValue); });
        var a = _this.series;
        a.collectionChanged = delegateCombine(a.collectionChanged, runOn(_this, _this.n7));
        var b = _this.series;
        b.collectionResetting = delegateCombine(b.collectionResetting, runOn(_this, _this.n8));
        _this.cs = new DoubleAnimator(0, 1, _this.hf);
        _this.cr = new DoubleAnimator(0, 1, _this.he);
        var c = _this.cr;
        c.propertyChanged = delegateCombine(c.propertyChanged, runOn(_this, _this.le));
        _this.cq.bx();
        _this.lh();
        _this.lg();
        return _this;
    ...
    Object.defineProperty(SeriesViewer.prototype, "c3", {
        get: function () {
            if (this.c2 == null) {
                this.c2 = new SRProvider(this.cq.j.ae);
            }
            return this.c2;
        },
        enumerable: false,
    ...
    Object.defineProperty(SeriesViewer.prototype, "a5", {
        get: function () {
            var _this = this;
            if (this.a4 == null) {
                this.a4 = DVContainer.instance.createInstance(ISeriesViewerInteractionManager_$type, function () { return _this.c3.n; });
            }
            return this.a4;
        },
        enumerable: false,
    ...
    Object.defineProperty(SeriesViewer.prototype, "ed", {
        get: function () {
    ...
    SeriesViewer.prototype.lf = function () {
        if (this.ci != null && this.cj == null) {
            var a = this.cj;
            a.thumbnailSizeChanged = delegateRemove(a.thumbnailSizeChanged, runOn(this, this.nd));
        }
        if (this.cj != null) {
            var b = this.cj;
            b.thumbnailSizeChanged = delegateCombine(b.thumbnailSizeChanged, runOn(this, this.nd));
        }
        if (this.hk != null) {
            this.cj.backgroundImageUri = this.hk;
        }
        if (this.cj != null) {
            this.cj.initializeScalingRatio(this.f4);
        }
        if (this.ci == null && this.cj != null) {
            this.lx();
        }
    ...
    SeriesViewer.prototype.get_eu = function () {
        return false;
    };
    ...
    SeriesViewer.prototype.get_et = function () {
        return false;
    };
    ...
    SeriesViewer.prototype.lg = function () {
        this.cq.co();
        if (this.cj != null) {
            this.cj.initializeScalingRatio(this.f4);
        }
    ...
    SeriesViewer.prototype.li = function () {
        this.l3();
    };
    SeriesViewer.prototype.l3 = function () {
    };
    ...
    SeriesViewer.prototype.n1 = function (a) {
    ...
    SeriesViewer.prototype.n8 = function (a, b) {
        var e_4, _a;
        this.dt = this.dz();
        try {
            for (var _b = __values(fromEnum(this.series)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    SeriesViewer.prototype.ll = function (a, b, c, d) {
        var e = this.su;
        var f = e.width;
        var g = e.height;
        var h = f / g;
    ...
    SeriesViewer.prototype.dz = function () {
        return false;
    };
    Object.defineProperty(SeriesViewer.prototype, "e5", {
        get: function () {
            return this.ek;
        },
        enumerable: false,
    ...
    Object.defineProperty(SeriesViewer.prototype, "d9", {
        get: function () {
            return this.a4 != null;
        },
        enumerable: false,
    ...
    Object.defineProperty(SeriesViewer.prototype, "ds", {
        get: function () {
            return this.a4 != null;
        },
        enumerable: false,
    ...
    Object.defineProperty(SeriesViewer.prototype, "dr", {
        get: function () {
            return this.bz != 0 || this.b0 != 0;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "dq", {
        get: function () {
    ...
    Object.defineProperty(SeriesViewer.prototype, "a3", {
        get: function () {
            var a = this.a5.f$b;
            if (a.executionContext == null) {
                a.executionContext = this.cq.l();
            }
            if (a.ensureAnimator == null) {
                a.ensureAnimator = runOn(this, this.k9);
            }
            return a;
        },
        enumerable: false,
    ...
    SeriesViewer.prototype.k9 = function () {
        {
            var a = this.cr;
            if (!a.f() && a.r > 0) {
                a.v();
    ...
    SeriesViewer.prototype.le = function (a, b) {
        this.ol(this.cr.o);
    };
    SeriesViewer.prototype.ol = function (a) {
        var b = this.a3.tick(a);
        if (a == 1 && b && this.cr.r > 0) {
            this.cr.v();
        }
        var c = this.a3.dirtySeries;
        if (this.a3.allDirty) {
            var d = this.series;
    ...
    SeriesViewer.prototype.ld = function () {
        this.cq.ck();
        this.lc();
    ...
    Object.defineProperty(SeriesViewer.prototype, "r6", {
        get: function () {
            return this.r5;
        },
        set: function (a) {
            if (PointUtil.notEquals(this.r5, a)) {
                var b = this.r5;
                this.r5 = a;
                this.nl("CrosshairPoint", b, this.r5);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(SeriesViewer.prototype, "ec", {
        get: function () {
    ...
    Object.defineProperty(SeriesViewer.prototype, "legend", {
        get: function () {
            return this.c(SeriesViewer.p2);
        },
        set: function (a) {
            this.h(SeriesViewer.p2, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "dn", {
        get: function () {
            return this.c(SeriesViewer.o7);
        },
        set: function (a) {
            this.h(SeriesViewer.o7, a);
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.mt = function (a, b) {
        this.dc = false;
        var c = false;
        c = false;
        if (this.cq.k.al) {
    ...
    SeriesViewer.prototype.bb = function (a, b, c) {
        ...
        f.manipulationOccurred = this.dc;
        return f;
    };
    SeriesViewer.prototype.bf = function (a, b, c) {
        var d = { $type: Point_$type, x: a.x, y: a.y };
        var e = { $type: Point_$type, x: a.x, y: a.y };
        if (!this.su.isEmpty) {
            if (c) {
    ...
    SeriesViewer.prototype.mu = function (a, b, c) {
        var d = false;
        d = false;
        if (this.cq.k.al) {
            return;
    ...
    Object.defineProperty(SeriesViewer.prototype, "ek", {
        get: function () {
            return this.c(SeriesViewer.py);
        },
        set: function (a) {
            this.h(SeriesViewer.py, a);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(SeriesViewer.prototype, "br", {
        get: function () {
            return EnumUtil.getEnumValue(SeriesHighlightingMode_$type, this.c(SeriesViewer.ph));
        },
        set: function (a) {
            this.h(SeriesViewer.ph, enumGetBox(SeriesHighlightingMode_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "b1", {
        get: function () {
            return EnumUtil.getEnumValue(SeriesViewerScrollbarMode_$type, this.c(SeriesViewer.pp));
        },
        set: function (a) {
            this.h(SeriesViewer.pp, enumGetBox(SeriesViewerScrollbarMode_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "b2", {
        get: function () {
            return EnumUtil.getEnumValue(SeriesViewerScrollbarMode_$type, this.c(SeriesViewer.qy));
        },
        set: function (a) {
            this.h(SeriesViewer.qy, enumGetBox(SeriesViewerScrollbarMode_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "by", {
        get: function () {
            return EnumUtil.getEnumValue(SeriesViewerHorizontalScrollbarPosition_$type, this.c(SeriesViewer.pr));
        },
        set: function (a) {
            this.h(SeriesViewer.pr, enumGetBox(SeriesViewerHorizontalScrollbarPosition_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "b3", {
        get: function () {
            return EnumUtil.getEnumValue(SeriesViewerVerticalScrollbarPosition_$type, this.c(SeriesViewer.q0));
        },
        set: function (a) {
            this.h(SeriesViewer.q0, enumGetBox(SeriesViewerVerticalScrollbarPosition_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "ru", {
        get: function () {
            return this.c(SeriesViewer.pl);
        },
        set: function (a) {
            this.h(SeriesViewer.pl, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "rv", {
        get: function () {
            return this.c(SeriesViewer.pq);
        },
        set: function (a) {
            this.h(SeriesViewer.pq, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gg", {
        get: function () {
            return this.c(SeriesViewer.pt);
        },
        set: function (a) {
            this.h(SeriesViewer.pt, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gf", {
        get: function () {
            return this.c(SeriesViewer.po);
        },
        set: function (a) {
            this.h(SeriesViewer.po, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gc", {
        get: function () {
            return this.c(SeriesViewer.pk);
        },
        set: function (a) {
            this.h(SeriesViewer.pk, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gd", {
        get: function () {
            return this.c(SeriesViewer.pm);
        },
        set: function (a) {
            this.h(SeriesViewer.pm, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "ge", {
        get: function () {
            return this.c(SeriesViewer.pn);
        },
        set: function (a) {
            this.h(SeriesViewer.pn, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gi", {
        get: function () {
            return this.c(SeriesViewer.pv);
        },
        set: function (a) {
            this.h(SeriesViewer.pv, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gh", {
        get: function () {
            return this.c(SeriesViewer.pu);
        },
        set: function (a) {
            this.h(SeriesViewer.pu, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "d1", {
        get: function () {
            return this.c(SeriesViewer.ps);
        },
        set: function (a) {
            this.h(SeriesViewer.ps, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "r3", {
        get: function () {
            return this.c(SeriesViewer.qv);
        },
        set: function (a) {
            this.h(SeriesViewer.qv, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "r4", {
        get: function () {
            return this.c(SeriesViewer.qz);
        },
        set: function (a) {
            this.h(SeriesViewer.qz, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "g0", {
        get: function () {
            return this.c(SeriesViewer.q2);
        },
        set: function (a) {
            this.h(SeriesViewer.q2, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gz", {
        get: function () {
            return this.c(SeriesViewer.qx);
        },
        set: function (a) {
            this.h(SeriesViewer.qx, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gx", {
        get: function () {
            return this.c(SeriesViewer.qu);
        },
        set: function (a) {
            this.h(SeriesViewer.qu, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "g3", {
        get: function () {
            return this.c(SeriesViewer.q5);
        },
        set: function (a) {
            this.h(SeriesViewer.q5, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gy", {
        get: function () {
            return this.c(SeriesViewer.qw);
        },
        set: function (a) {
            this.h(SeriesViewer.qw, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "g2", {
        get: function () {
            return this.c(SeriesViewer.q4);
        },
        set: function (a) {
            this.h(SeriesViewer.q4, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "g1", {
        get: function () {
            return this.c(SeriesViewer.q3);
        },
        set: function (a) {
            this.h(SeriesViewer.q3, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "fd", {
        get: function () {
            return this.c(SeriesViewer.q1);
        },
        set: function (a) {
            this.h(SeriesViewer.q1, a);
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.bq = function () {
        if (this.bp == 0) {
            return 1;
        }
        if (this.br == 3 || this.br == 5) {
            if (this.bp == 2) {
                return 4;
            }
        }
    ...
    Object.defineProperty(SeriesViewer.prototype, "bp", {
        get: function () {
            return EnumUtil.getEnumValue(SeriesHighlightingBehavior_$type, this.c(SeriesViewer.pg));
        },
        set: function (a) {
            this.h(SeriesViewer.pg, enumGetBox(SeriesHighlightingBehavior_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "a7", {
        get: function () {
            return EnumUtil.getEnumValue(LegendHighlightingMode_$type, this.c(SeriesViewer.pz));
        },
        set: function (a) {
            this.h(SeriesViewer.pz, enumGetBox(LegendHighlightingMode_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "a9", {
        get: function () {
            return EnumUtil.getEnumValue(LegendItemBadgeShape_$type, this.c(SeriesViewer.p1));
        },
        set: function (a) {
            this.h(SeriesViewer.p1, enumGetBox(LegendItemBadgeShape_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "a8", {
        get: function () {
            return EnumUtil.getEnumValue(LegendItemBadgeMode_$type, this.c(SeriesViewer.p0));
        },
        set: function (a) {
            this.h(SeriesViewer.p0, enumGetBox(LegendItemBadgeMode_$type, a));
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.nl = function (a, b, c) {
    ...
    SeriesViewer.prototype.mk = function () {
        this.ml(this.series);
    };
    SeriesViewer.prototype.ml = function (a) {
        var e_5, _a;
        try {
    ...
    SeriesViewer.prototype.mw = function (a, b, c) {
        this.nq(a, b, typeCast(MouseEventArgs.$, c));
    };
    SeriesViewer.prototype.m0 = function (a, b, c) {
        this.nu(a, b, typeCast(MouseEventArgs.$, c));
    };
    SeriesViewer.prototype.mx = function (a, b, c) {
        this.nr(a, b, typeCast(MouseEventArgs.$, c));
    };
    SeriesViewer.prototype.my = function (a, b, c) {
        this.ns(a, b, typeCast(MouseButtonEventArgs.$, c));
    };
    SeriesViewer.prototype.mz = function (a, b, c) {
        var d = typeCast(MouseButtonEventArgs.$, c);
        if (d != null) {
            this.nt(a, b, typeCast(MouseButtonEventArgs.$, c));
        }
    };
    SeriesViewer.prototype.ku = function (a, b) {
        return null;
    };
    ...
    SeriesViewer.prototype.l2 = function () {
        if (!this.c7) {
            this.c7 = true;
            this.dc = true;
    ...
    SeriesViewer.prototype.m1 = function (a, b, c) {
    };
    SeriesViewer.prototype.m2 = function (a, b, c) {
    };
    SeriesViewer.prototype.no = function (a, b) {
        if (this.seriesCursorMouseMove != null && this.dv) {
            this.seriesCursorMouseMove(this, new ChartCursorEventArgs(this, a, b));
        }
    };
    SeriesViewer.prototype.ns = function (a, b, c) {
        if (this.seriesMouseLeftButtonDown != null) {
            this.seriesMouseLeftButtonDown(this, new DataChartMouseButtonEventArgs(this, a, b, c));
        }
    };
    SeriesViewer.prototype.nt = function (a, b, c) {
    ...
    SeriesViewer.prototype.od = function (a) {
        a = { $type: Point_$type, x: a.x - this.su.left, y: a.y - this.su.top };
        var b = this.r9(a);
        if (this.e4) {
            this.k3(b);
        }
    ...
    SeriesViewer.prototype.l1 = function () {
        if (this.c7) {
            this.c7 = false;
    ...
    SeriesViewer.prototype.get_su = function () {
        return this.se;
    };
    Object.defineProperty(SeriesViewer.prototype, "su", {
        get: function () {
            return this.get_su();
        },
        enumerable: false,
    ...
    Object.defineProperty(SeriesViewer.prototype, "sj", {
        get: function () {
            return this.sc;
        },
        set: function (a) {
    ...
    SeriesViewer.prototype.get_d0 = function () {
        return false;
    };
    ...
    SeriesViewer.prototype.so = function (a, b, c) {
        if (c.isEmpty) {
            return c;
        }
        var d = c;
    ...
    SeriesViewer.prototype.get_si = function () {
        if (this.c5) {
            this.c5 = false;
            var a = this.sm(this.su, this.sj, this.sf);
            this.sb = a;
        }
        return this.sb;
    };
    Object.defineProperty(SeriesViewer.prototype, "si", {
        get: function () {
            return this.get_si();
        },
        enumerable: false,
    ...
    SeriesViewer.prototype.sm = function (a, b, c) {
        var d = b;
        var e = c;
        var f = a;
        if (f.isEmpty) {
    ...
    SeriesViewer.prototype.sh = function (a) {
        this.c5 = true;
        return Rect.empty;
    };
    SeriesViewer.prototype.sn = function () {
        return this.su;
    };
    SeriesViewer.prototype.oh = function (a) {
        a.kc = this.su;
    };
    Object.defineProperty(SeriesViewer.prototype, "hb", {
        get: function () {
            return this.g8;
        },
        set: function (a) {
    ...
    SeriesViewer.prototype.ng = function (a, b) {
        if (!b.isEmpty) {
            this.se = b;
            this.sc = this.sh(this.se);
            this.cq.eq(this.se);
        }
        if (this.dz()) {
            if (this.actualSyncLink != null) {
                this.ot(this.sf, false);
            }
        }
        this.mv(a, b);
        if (this.dq) {
            this.a6.updateScrollbars(this, this.sf, this.sf, a, b);
        }
    };
    SeriesViewer.prototype.bx = function () {
        return this.bw;
    };
    SeriesViewer.prototype.k0 = function (a, b) {
        var c = false;
        c = true;
        if (this.su.containsPoint(a)) {
            if (!this.da) {
                this.da = true;
                if (this.plotAreaMouseEnter != null) {
                    var d = this.bf(a, false, c);
    ...
    Object.defineProperty(SeriesViewer.prototype, "at", {
        get: function () {
            return this.ar;
        },
        set: function (a) {
            ...
            this.ar = a;
            if (b != this.ar) {
                this.nl("ContentHitTestMode", enumGetBox(ChartHitTestMode_$type, b), enumGetBox(ChartHitTestMode_$type, this.ar));
            }
        },
        enumerable: false,
        configurable: true
    ...
    SeriesViewer.prototype.au = function () {
        if (!this.ed) {
            return 1;
        }
        return this.a5.f$a(this);
    };
    Object.defineProperty(SeriesViewer.prototype, "as", {
        get: function () {
            return this.aq;
        },
        set: function (a) {
            ...
            this.aq = a;
            if (b != this.aq) {
                this.nl("ActualContentHitTestMode", enumGetBox(ChartHitTestMode_$type, b), enumGetBox(ChartHitTestMode_$type, this.aq));
            }
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.nn = function (a) {
        if (this.seriesAnimating != null) {
            this.seriesAnimating(a);
        }
    };
    SeriesViewer.prototype.el = function () {
    ...
    SeriesViewer.prototype.mn = function (a) {
        this.k3(this.r9(a));
    };
    SeriesViewer.prototype.mo = function (a, b) {
        var c = false;
        c = false;
        this.k3({ $type: Point_$type, x: NaN, y: NaN });
        if (this.da) {
            this.da = false;
            if (this.plotAreaMouseLeave != null) {
                var d = this.bf(a, false, c);
    ...
    SeriesViewer.prototype.ey = function (a, b) {
        return this.a5.f$f(this, a, b);
    };
    SeriesViewer.prototype.md = function (a) {
        this.a5.f$o(this, a);
    };
    SeriesViewer.prototype.ex = function (a) {
        return this.a5.f$e(this, a);
    };
    ...
    SeriesViewer.prototype.get_ee = function () {
        return this.dt || this.fa();
    };
    Object.defineProperty(SeriesViewer.prototype, "ee", {
        get: function () {
            return this.get_ee();
        },
        enumerable: false,
    ...
    SeriesViewer.prototype.mf = function (a) {
        this.a5.f$q(this, a);
    };
    Object.defineProperty(SeriesViewer.prototype, "dy", {
        get: function () {
            return this.c6;
        },
        enumerable: false,
    ...
    SeriesViewer.prototype.ms = function (a) {
        this.a5.f$ae(this, a);
    };
    SeriesViewer.prototype.mg = function (a, b) {
        this.a5.f$r(this, a, b);
    };
    SeriesViewer.prototype.me = function (a) {
        this.a5.f$p(this, a);
    };
    ...
    SeriesViewer.prototype.nb = function () {
        this.a5.f$al(this);
    };
    SeriesViewer.prototype.mr = function (a) {
        this.a5.f$ad(this, a);
    };
    SeriesViewer.prototype.nc = function (a, b, c, d) {
        this.a5.f$am(this, a, b, c, d);
    };
    SeriesViewer.prototype.mq = function (a) {
        this.a5.f$ac(this, a);
    };
    SeriesViewer.prototype.m8 = function (a, b, c, d) {
        this.a5.f$ai(this, a, b, c, d);
    };
    SeriesViewer.prototype.mm = function (a) {
        this.a5.f$z(this, a);
    };
    SeriesViewer.prototype.mp = function (a) {
        this.a5.f$ab(this, a);
    };
    SeriesViewer.prototype.mh = function (a) {
        this.a5.f$s(this, a);
    };
    SeriesViewer.prototype.m7 = function (a, b, c, d) {
        this.a5.f$ah(this, a, b, c, d);
    };
    SeriesViewer.prototype.m4 = function () {
        this.dc = false;
    };
    SeriesViewer.prototype.mj = function (a) {
        this.cq.ej(a.height);
    };
    SeriesViewer.prototype.lc = function () {
        if (this.c6) {
            this.k3({ $type: Point_$type, x: NaN, y: NaN });
            this.cq.ch();
        }
    ...
    SeriesViewer.prototype.l6 = function (a, b) {
        this.a5.f$n(this, a, b);
    };
    SeriesViewer.prototype.cf = function (a) {
        var b = this.cq.k != null && this.cq.k.al ? this.cg : this.ce;
        if (b != 3) {
            return b;
        }
        return this.cq.m(a);
    ...
    SeriesViewer.prototype.k7 = function () {
        if (this.dh) {
            this.ma();
        }
        this.a5.f$k(this);
    };
    SeriesViewer.prototype.k2 = function () {
        this.k1();
    };
    SeriesViewer.prototype.k1 = function () {
        if (this.ed) {
            this.a5.f$h(this);
        }
    };
    ...
    SeriesViewer.prototype.l5 = function (a, b) {
        this.a5.f$m(this, a, b);
    };
    SeriesViewer.prototype.e3 = function () {
        return false;
    };
    ...
    SeriesViewer.prototype.l4 = function (a, b, c) {
        this.a5.f$l(this, a, b, c);
    };
    ...
    SeriesViewer.prototype.oq = function (a, b) {
        var e_6, _a;
        if (a != null) {
            a.as(this);
    ...
    SeriesViewer.prototype.k3 = function (a) {
        if (this.dq) {
            this.a6.onCrosshairMoved(this.r7(a));
        }
    ...
    SeriesViewer.prototype.ou = function (a, b, c) {
        if (!b) {
    ...
    SeriesViewer.prototype.nf = function (a, b) {
        if (!b) {
    ...
    Object.defineProperty(SeriesViewer.prototype, "ei", {
        get: function () {
    ...
    SeriesViewer.prototype._fg = function () {
        var _a, _b, a, e_7_1;
        var e_7, _c;
    ...
    SeriesViewer.prototype.fg = function () {
        var _this = this;
        return toEnum(function () { return _this._fg(); });
    };
    SeriesViewer.prototype.r9 = function (a) {
        a = { $type: Point_$type, x: a.x + this.su.left, y: a.y + this.su.top };
        var b = this.si;
        var c = this.sf.left + this.sf.width * (a.x - b.left) / b.width;
        var d = this.sf.top + this.sf.height * (a.y - b.top) / b.height;
        return { $type: Point_$type, x: c, y: d };
    };
    SeriesViewer.prototype.r7 = function (a) {
        var b = this.si;
        var c = (a.x - this.sf.left) * b.width / this.sf.width + b.left;
        var d = (a.y - this.sf.top) * b.height / this.sf.height + b.top;
        a = { $type: Point_$type, x: a.x - this.su.left, y: a.y - this.su.top };
        return { $type: Point_$type, x: c, y: d };
    };
    SeriesViewer.prototype.st = function (a) {
        a = new Rect(0, a.left + this.su.left, a.top + this.su.top, a.width, a.height);
        var b = this.si;
        var c = this.sf.left + this.sf.width * (a.left - b.left) / b.width;
        var d = this.sf.top + this.sf.height * (a.top - b.top) / b.height;
        var e = this.sf.left + this.sf.width * (a.right - b.left) / b.width;
        var f = this.sf.top + this.sf.height * (a.bottom - b.top) / b.height;
        return new Rect(0, c, d, e - c, f - d);
    };
    SeriesViewer.prototype.nv = function (a, b) {
        if (this.windowRectChanged != null && Rect.l_op_Inequality(a, b)) {
            this.windowRectChanged(this, new RectChangedEventArgs(a, b));
        }
    };
    SeriesViewer.prototype.m6 = function (a, b) {
        this.nv(a, b);
    };
    SeriesViewer.prototype.m3 = function (a, b) {
    ...
    SeriesViewer.prototype.e1 = function (a, b) {
        if (a.width != b.width || a.height != b.height || a.x != b.x || a.y != b.y) {
            return true;
        }
        return false;
    };
    SeriesViewer.prototype.nj = function (a, b) {
        if (this.actualWindowRectChanged != null && this.e1(a, b)) {
    ...
    SeriesViewer.prototype.mv = function (a, b) {
        this.nk(a, b);
        if (this.ed) {
            this.a5.f$an(this);
        }
        if (this.ef && (Rect.l_op_Equality(a, null) || a.isEmpty || a.width == 0 || a.height == 0)) {
            this.ot(this.sv, false);
        }
        else {
            this.lh();
        }
    ...
    SeriesViewer.prototype.lk = function () {
        this.lh();
    };
    ...
    Object.defineProperty(SeriesViewer.prototype, "actualSyncLink", {
        ...
        set: function (a) {
            var b = this.b4;
            this.b4 = a;
            this.nl("ActualSyncLink", b, this.b4);
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.lj = function () {
        this.cq.d3();
    };
    SeriesViewer.prototype.mb = function () {
        this.dh = true;
    };
    SeriesViewer.prototype.l9 = function () {
        this.dh = false;
    };
    SeriesViewer.prototype.ma = function () {
        if (this.dh) {
            if (this.di) {
                this.di = false;
                if (this.viewerManipulationEnding != null) {
    ...
    Object.defineProperty(SeriesViewer.prototype, "cj", {
        get: function () {
            return this.cq.i().a;
        },
        enumerable: false,
    ...
    SeriesViewer.prototype.du = function () {
        return this.ch == 0 && !this.de && !this.df;
    };
    SeriesViewer.prototype.dl = function () {
        if (this.actualSyncLink != null && this.actualSyncLink.ai.count > 0) {
            ...
            for (var b = 0; b < this.actualSyncLink.ai.count; b++) {
                if (!this.actualSyncLink.ai.item(b).du()) {
                    return false;
                }
            }
            return true;
    ...
    SeriesViewer.prototype.kz = function () {
        if (this.ch == 2) {
            this.cq.bt();
            this.ch = 0;
            this.m9();
            this.nf(Rect.empty, true);
            if (this.b7 == 1) {
                this.ot(this.sw, true);
            }
        }
        if (this.ch == 1) {
            this.cq.bt();
    ...
    SeriesViewer.prototype.os = function (a, b) {
        var c = this.g6;
        this.sv = new Rect(0, this.f5, this.f6, MathUtil.c(a, c, 1), MathUtil.c(b, c, 1));
    };
    SeriesViewer.prototype.ga = function () {
        return 1;
    };
    SeriesViewer.prototype.gb = function () {
        return 1;
    };
    SeriesViewer.prototype.nh = function (a, b, c, d) {
        ...
        switch (b) {
            ...
            case "HorizontalViewScrollbarMode":
                this.bz = this.b1;
                if (this.ds || this.ed) {
                    this.a6.onHorizontalScrollbarModeChanged(this.bz);
                }
                break;
            case "VerticalViewScrollbarMode":
                this.b0 = this.b2;
                if (this.ds || this.ed) {
                    this.a6.onVerticalScrollbarModeChanged(this.b0);
                }
                break;
            ...
            case "PixelScalingRatio":
                if (isNaN_(DeviceUtils.a(this.gl))) {
                    this.lg();
                }
                else {
                    this.f4 = DeviceUtils.a(this.gl);
                }
                break;
            ...
            case SeriesViewer.$$p[11]:
                ...
                break;
            case "ActualSyncLink":
                this.oq(typeCast(SyncLink.$, c), typeCast(SyncLink.$, d));
                break;
            ...
            case SeriesViewer.$$p[42]:
                ...
                if (!this.sv.equals1(c) && this.ha == 0) {
                    this.m6(c, this.sv);
                }
                this.lh();
                break;
            ...
            case "HighlightingBehavior":
                ...
                if (this.ed) {
                    var e = this.a3;
                    e.highlightingBehavior = this.bo;
                }
                break;
            case "LegendItemBadgeShape":
                try {
                    for (var _d = __values(fromEnum(this.series)), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var f = _e.value;
                        f.legendItemBadgeShape = this.a9;
                    }
                }
                catch (e_8_1) {
                    e_8 = { error: e_8_1 };
            ...
            case "VerticalViewScrollbarStrokeThickness":
                if (this.ed) {
                    this.a6.updateBarAppearance(this, this.ru, this.r3, this.rv, this.r4, this.gg, this.g0, this.gf, this.gz);
                }
                break;
            case "HorizontalViewScrollbarHeight":
            case "HorizontalViewScrollbarInset":
            case SeriesViewer.ik:
            case "HorizontalViewScrollbarTrackStartInset":
            case "HorizontalViewScrollbarTrackEndInset":
                if (this.ed) {
                    this.a6.updateBarDimensions(this, this.gd, this.gc, this.ge, this.d1, this.gi, this.gh, this.g3, this.gx, this.gy, this.fd, this.g2, this.g1);
                }
                break;
            case "VerticalViewScrollbarPosition":
                if (this.ed) {
                    this.a6.updateVerticalScrollbarPosition(this.b3);
                }
                break;
            case "HorizontalViewScrollbarPosition":
                if (this.ed) {
                    this.a6.updateHorizontalScrollbarPosition(this.by);
                }
                break;
        }
    };
    Object.defineProperty(SeriesViewer.prototype, "ea", {
        get: function () {
            return this.bo == 2 || this.bo == 3 || this.bo == 4;
        },
        enumerable: false,
        configurable: true
    });
    ...
    SeriesViewer.prototype.op = function () {
        this.dg = this.s0 == 0;
        this.cq.dp();
        this.oo();
        this.cq.em();
    ...
    SeriesViewer.prototype.ly = function () {
        this.cq.cv();
    };
    SeriesViewer.prototype.oo = function () {
        ...
        this.cj.visibility = this.s0;
        this.cj.isZoomable = this.el();
    };
    Object.defineProperty(SeriesViewer.prototype, "sp", {
        get: function () {
            return this.sd;
        },
        set: function (a) {
            ...
            if (this.sd.isEmpty) {
                ...
                this.cq.en(this.su, this.ss(this.sp));
                this.cq.ec();
                this.nl("PreviewRect", b, this.sd);
            }
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.og = function () {
        this.f5 = this.sf.x;
        this.f6 = this.sf.y;
    };
    SeriesViewer.prototype.kv = function (a, b) {
        this.fe = false;
        this.fi = dateNow();
        if (this.d9) {
            for (var c = 0; c < this.series.count; c++) {
                this.series._inner[c].kv();
            }
            this.a3.clear();
        }
        if (this.cr.f()) {
        ...
        this.cq.ep(this.sf);
        if (this.dq) {
            this.a6.updateScrollbars(this, a, this.sf, this.su, this.su);
        }
        this.lz(a, b);
    };
    SeriesViewer.prototype.lz = function (a, b) {
    };
    SeriesViewer.prototype.ss = function (a) {
        if (this.su.isEmpty) {
            return Rect.empty;
        }
        var b = this.su;
        var c = b.left + (b.width * (a.left - this.sf.left) / this.sf.width);
        var d = b.top + (b.height * (a.top - this.sf.top) / this.sf.height);
        var e = b.left + (b.width * (a.right - this.sf.left) / this.sf.width);
        var f = b.top + (b.height * (a.bottom - this.sf.top) / this.sf.height);
        return new Rect(0, c, d, e - c, f - d);
    };
    ...
    SeriesViewer.prototype.m5 = function (a) {
        this.oo();
    };
    Object.defineProperty(SeriesViewer.prototype, "j3", {
        get: function () {
            return this.hm;
        },
        set: function (a) {
    ...
    Object.defineProperty(SeriesViewer.prototype, "jr", {
        ...
        set: function (a) {
            var b = this.hl;
            this.hl = a;
            this.nl("SubtitleTextStyle", b, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "r1", {
        get: function () {
            return this.ri;
        },
        set: function (a) {
            var b = this.ri;
            this.ri = a;
            this.nl("TitleTextColor", b, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "r0", {
        get: function () {
            return this.rh;
        },
        set: function (a) {
            var b = this.rh;
            this.rh = a;
            this.nl("SubtitleTextColor", b, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gv", {
        get: function () {
            return this.f1;
        },
        set: function (a) {
            var b = this.f1;
            this.f1 = a;
            this.nl("TitleTopMargin", b, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gt", {
        get: function () {
            return this.fz;
        },
        set: function (a) {
    ...
    Object.defineProperty(SeriesViewer.prototype, "gu", {
        ...
        set: function (a) {
            var b = this.f0;
            this.f0 = a;
            this.nl("TitleRightMargin", b, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gs", {
        get: function () {
            return this.fy;
        },
        set: function (a) {
    ...
    Object.defineProperty(SeriesViewer.prototype, "gp", {
        ...
        set: function (a) {
            var b = this.fv;
            this.fv = a;
            this.nl("SubtitleLeftMargin", b, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gq", {
        ...
        set: function (a) {
            var b = this.fw;
            this.fw = a;
            this.nl("SubtitleRightMargin", b, a);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "go", {
        ...
        set: function (a) {
            var b = this.fu;
            this.fu = a;
            this.nl("SubtitleBottomMargin", b, a);
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.sx = function () {
        return this.cq.fj();
    };
    SeriesViewer.prototype.sy = function () {
        return this.cq.fk();
    };
    SeriesViewer.prototype.an = function (a) {
        return this.cq.c(a);
    };
    ...
    SeriesViewer.prototype.get_ev = function () {
        return false;
    };
    ...
    SeriesViewer.prototype.l8 = function () {
    };
    SeriesViewer.prototype.provideContainer = function (a) {
        this.cq.c0(a);
    };
    SeriesViewer.prototype.l7 = function (a, b) {
        this.cq.c1(a, b);
    };
    ...
    SeriesViewer.prototype.sk = function () {
        return this.cq.fb();
    };
    SeriesViewer.prototype.k8 = function () {
        this.cq.b5();
    };
    SeriesViewer.prototype.r8 = function () {
        return this.cq.e8();
    };
    SeriesViewer.prototype.cu = function () {
        return this.cq.t();
    };
    SeriesViewer.prototype.ct = function () {
        return this.cq.q();
    };
    SeriesViewer.prototype.rn = function () {
        return this.cq.e0();
    };
    SeriesViewer.prototype.ro = function () {
        return this.cq.e3();
    };
    SeriesViewer.prototype.kx = function (a) {
        this.cq.bp(a);
    };
    SeriesViewer.prototype.n2 = function (a) {
        this.cq.dy(a);
    };
    Object.defineProperty(SeriesViewer.prototype, "es", {
        get: function () {
            return this.dd;
        },
        set: function (a) {
    ...
    SeriesViewer.prototype.kw = function (a) {
        this.cq.bn(a);
    };
    SeriesViewer.prototype.n4 = function (a) {
        this.cq.dz(a);
    };
    SeriesViewer.prototype.lv = function (source_, a, b, c) {
    ...
    SeriesViewer.prototype.lm = function (source_) {
        if (source_.dataView && source_.dataSource) {
            source_ = source_.dataView();
        }
        ;
    ...
    SeriesViewer.prototype.lt = function (source_, a, b) {
        if (source_.dataView && source_.dataSource) {
            source_ = source_.dataView();
        }
        ;
    ...
    SeriesViewer.prototype.lu = function (source_, a, b) {
        if (source_.dataView && source_.dataSource) {
            source_ = source_.dataView();
        }
        ;
    ...
    SeriesViewer.prototype.k6 = function () {
    };
    SeriesViewer.prototype.ob = function (source_) {
        if (source_.dataView && source_.dataSource) {
            source_ = source_.dataView();
        }
        ;
    ...
    SeriesViewer.prototype.oa = function (a, source_) {
        if (source_.dataView && source_.dataSource) {
            source_ = source_.dataView();
        }
        ;
        if (stringIsNullOrEmpty(a) == false) {
            if (!this.ff.containsKey(a)) {
                this.ff.addItem(a, source_);
            }
            else {
                this.ff.item(a, source_);
            }
        }
        this.ok();
    };
    SeriesViewer.prototype.n3 = function (a, b) {
        if (stringIsNullOrEmpty(a) == false) {
            if (this.ff.containsKey(a)) {
    ...
    SeriesViewer.prototype.n9 = function (a, b) {
        if (a.itemsSource != b) {
            a.itemsSource = b;
        }
    };
    SeriesViewer.prototype.oj = function (a) {
        ...
        if (typeCast(Series.$, a) !== null) {
            var b = a;
            if (this.ff.containsKey(b.name)) {
                var c = this.ff.item(b.name);
                this.n9(b, c);
            }
            else {
                this.n9(b, this.hh);
        ...
        if (typeCast(CategoryAxisBase.$, a) !== null) {
            var d = a;
            if (this.ff.containsKey(d.name)) {
                var e = this.ff.item(d.name);
                if (d.itemsSource != e) {
                    d.itemsSource = e;
                }
            }
            else {
                if (d.itemsSource != this.hh) {
                    d.itemsSource = this.hh;
                }
            }
        }
    };
    ...
    Object.defineProperty(SeriesViewer.prototype, "gw", {
        get: function () {
            return this.f2;
        },
        set: function (a) {
    ...
    SeriesViewer.prototype.e2 = function () {
        return false;
    };
    Object.defineProperty(SeriesViewer.prototype, "d6", {
        ...
        set: function (a) {
            var b = this.c9;
            this.c9 = a;
            this.nl("IsAntiAliasingEnabledDuringInteraction", b, this.c9);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gl", {
        get: function () {
            return this.fs;
        },
        set: function (a) {
            var b = this.fs;
            this.fs = a;
            this.nl("PixelScalingRatio", b, this.fs);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "gj", {
        ...
        set: function (a) {
            var b = this.fq;
            this.fq = a;
            this.nl("InteractionPixelScalingRatio", b, this.fq);
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.cc = function (a, b) {
    ...
    Object.defineProperty(SeriesViewer.prototype, "f4", {
        ...
        set: function (a) {
            var b = this.fk;
            this.fk = a;
            this.nl("ActualPixelScalingRatio", b, this.fk);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "f3", {
        ...
        set: function (a) {
            var b = this.fj;
            this.fj = a;
            this.nl("ActualInteractionPixelScalingRatio", b, this.fj);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "sf", {
        get: function () {
            return this.sa;
        },
        set: function (a) {
            var b = Rect.l_op_Inequality(this.sa, a);
            if (b) {
                var c = this.sa;
                this.sa = a;
                this.nl("ActualWindowRect", c, a);
            }
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.sl = function () {
        return this.sf;
    };
    SeriesViewer.prototype.lh = function () {
        if (this.d2) {
            return;
        }
        this.sf = this.sg();
    };
    SeriesViewer.prototype.sq = function () {
        return Rect.empty;
    };
    SeriesViewer.prototype.sg = function () {
        var a = this.sv.left;
        var b = this.sv.top;
        var c = this.sv.width;
        var d = this.sv.height;
        if (this.b9 == 1) {
            a = Math.min(1, Math.max(0, this.sv.left));
            c = Math.min(1, Math.max(0, this.sv.width));
        }
        if (this.b9 == 1) {
            b = Math.min(1, Math.max(0, this.sv.top));
            d = Math.min(1, Math.max(0, this.sv.height));
        }
        return new Rect(0, a, b, c, d);
    };
    SeriesViewer.prototype.hi = function (a, b) {
        return this.cq.bj(a, b);
    };
    Object.defineProperty(SeriesViewer.prototype, "f5", {
        get: function () {
            return this.fl;
        },
        set: function (a) {
            var b = this.fl;
            this.fl = a;
            this.nl("ActualWindowPositionHorizontal", b, this.fl);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SeriesViewer.prototype, "f6", {
        ...
        set: function (a) {
            var b = this.fm;
            this.fm = a;
            this.nl("ActualWindowPositionVertical", b, this.fm);
        },
        enumerable: false,
        configurable: true
    });
    SeriesViewer.prototype.lx = function () {
        if (this.dg && this.cj != null) {
            this.cj.surfaceIsDirty = true;
            this.cj.doRefresh(false);
        }
        this.k2();
        this.lr();
    };
    SeriesViewer.prototype.lw = function () {
        if (this.dg && this.cj != null) {
            this.cj.surfaceIsDirty = true;
            this.cj.doRefresh(false);
        }
    ...
    SeriesViewer.prototype.flush = function () {
        this.lb(true, true, true);
    };
    SeriesViewer.prototype.lb = function (a, b, c) {
        this.ap.y();
        if (a) {
            this.cq.b7();
            this.ap.y();
    ...
    SeriesViewer.prototype.nz = function (a, b) {
        if (this.o5 != null) {
            this.of(this.o5);
            this.o5 = null;
            this.av = null;
    ...
    SeriesViewer.prototype.of = function (a) {
        this.ap.ad(2, a);
        this.o5 = null;
        this.av = null;
    };
    SeriesViewer.prototype.k4 = function () {
        this.ap.ac(2, this.o5, this.av, false);
    };
    SeriesViewer.prototype.mi = function () {
        var a = false;
        var b = false;
        var c = false;
        for (var d = 0; d < this.series.count; d++) {
    ...
    SeriesViewer.prototype.hd = function () {
        var a = this.g9;
        this.g9++;
        return a;
    };
    SeriesViewer.prototype.cx = function () {
        if (this.j3 == null || this.cq.j.ae == null) {
            return null;
        }
        return FontUtil.toFontInfo(this.cq.j.ae, this.j3);
    };
    SeriesViewer.prototype.cw = function () {
        if (this.jr == null || this.cq.j.ae == null) {
            return null;
        }
        return FontUtil.toFontInfo(this.cq.j.ae, this.jr);
    };
    SeriesViewer.prototype.oi = function () {
        var a = false;
        a = this.dj;
        this.d3 = true;
        this.dv = (a && !this.fb) || this.sz == 0;
        this.d3 = false;
    };
    ...
    SeriesViewer.prototype.lq = function () {
        for (var a = 0; a < this.fh.count; a++) {
            this.fh._inner[a].notifySeriesCollectionChanged();
        }
    };
    SeriesViewer.prototype.lr = function () {
        for (var a = 0; a < this.fh.count; a++) {
            this.fh._inner[a].notifySeriesDataChanged();
        }
    };
    SeriesViewer.prototype.ls = function (a) {
        for (var b = 0; b < this.fh.count; b++) {
            this.fh._inner[b].notifyVisualPropertiesChanged(a);
        }
    };
    SeriesViewer.prototype.lp = function (a) {
        for (var b = 0; b < this.fh.count; b++) {
            this.fh._inner[b].notifyCursorPositionChanged(a);
        }
    };
    ...
    SeriesViewer.$t = markType(SeriesViewer, 'SeriesViewer', Control.$, [INotifyPropertyChanged_$type, ILegendOwner_$type, IInternalLegendOwner_$type, IDataLegendTarget_$type]);
    SeriesViewer.p2 = DependencyProperty.i("Legend", IChartLegend_$type, SeriesViewer.$, new PropertyMetadata(2, null, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("Legend", b.oldValue, b.newValue);
    }));
    SeriesViewer.o7 = DependencyProperty.i("AnimateSeriesWhenAxisRangeChanges", Boolean_$type, SeriesViewer.$, new PropertyMetadata(2, false, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("AnimateSeriesWhenAxisRangeChanges", b.oldValue, b.newValue);
    }));
    SeriesViewer.py = DependencyProperty.i("IsWindowSyncedToVisibleRange", Boolean_$type, SeriesViewer.$, new PropertyMetadata(2, false, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("IsWindowSyncedToVisibleRange", b.oldValue, b.newValue);
    }));
    SeriesViewer.qk = DependencyProperty.i("ShouldSimulateHoverMoveCrosshairPoint", Boolean_$type, SeriesViewer.$, new PropertyMetadata(2, false, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("ShouldSimulateHoverMoveCrosshairPoint", b.oldValue, b.newValue);
    }));
    SeriesViewer.ph = DependencyProperty.i("HighlightingMode", SeriesHighlightingMode_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(SeriesHighlightingMode_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HighlightingMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.pp = DependencyProperty.i("HorizontalViewScrollbarMode", SeriesViewerScrollbarMode_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(SeriesViewerScrollbarMode_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.qy = DependencyProperty.i("VerticalViewScrollbarMode", SeriesViewerScrollbarMode_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(SeriesViewerScrollbarMode_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.pr = DependencyProperty.i("HorizontalViewScrollbarPosition", SeriesViewerHorizontalScrollbarPosition_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(SeriesViewerHorizontalScrollbarPosition_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarPosition", b.oldValue, b.newValue);
    }));
    SeriesViewer.q0 = DependencyProperty.i("VerticalViewScrollbarPosition", SeriesViewerVerticalScrollbarPosition_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(SeriesViewerVerticalScrollbarPosition_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarPosition", b.oldValue, b.newValue);
    }));
    SeriesViewer.pl = DependencyProperty.i("HorizontalViewScrollbarFill", Brush.$, SeriesViewer.$, new PropertyMetadata(2, null, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarFill", b.oldValue, b.newValue);
    }));
    SeriesViewer.pq = DependencyProperty.i("HorizontalViewScrollbarOutline", Brush.$, SeriesViewer.$, new PropertyMetadata(2, null, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarOutline", b.oldValue, b.newValue);
    }));
    SeriesViewer.pt = DependencyProperty.i("HorizontalViewScrollbarStrokeThickness", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarStrokeThickness", b.oldValue, b.newValue);
    }));
    SeriesViewer.po = DependencyProperty.i("HorizontalViewScrollbarMaxOpacity", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarMaxOpacity", b.oldValue, b.newValue);
    }));
    SeriesViewer.pk = DependencyProperty.i("HorizontalViewScrollbarCornerRadius", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarCornerRadius", b.oldValue, b.newValue);
    }));
    SeriesViewer.pm = DependencyProperty.i("HorizontalViewScrollbarHeight", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarHeight", b.oldValue, b.newValue);
    }));
    SeriesViewer.pn = DependencyProperty.i("HorizontalViewScrollbarInset", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.pv = DependencyProperty.i("HorizontalViewScrollbarTrackStartInset", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarTrackStartInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.pu = DependencyProperty.i("HorizontalViewScrollbarTrackEndInset", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HorizontalViewScrollbarTrackEndInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.ik = "HorizontalViewScrollbarShouldAddAutoTrackInsets";
    SeriesViewer.ps = DependencyProperty.i(SeriesViewer.ik, Boolean_$type, SeriesViewer.$, new PropertyMetadata(2, true, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl(SeriesViewer.ik, b.oldValue, b.newValue);
    }));
    SeriesViewer.qv = DependencyProperty.i("VerticalViewScrollbarFill", Brush.$, SeriesViewer.$, new PropertyMetadata(2, null, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarFill", b.oldValue, b.newValue);
    }));
    SeriesViewer.qz = DependencyProperty.i("VerticalViewScrollbarOutline", Brush.$, SeriesViewer.$, new PropertyMetadata(2, null, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarOutline", b.oldValue, b.newValue);
    }));
    SeriesViewer.q2 = DependencyProperty.i("VerticalViewScrollbarStrokeThickness", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarStrokeThickness", b.oldValue, b.newValue);
    }));
    SeriesViewer.qx = DependencyProperty.i("VerticalViewScrollbarMaxOpacity", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarMaxOpacity", b.oldValue, b.newValue);
    }));
    SeriesViewer.qu = DependencyProperty.i("VerticalViewScrollbarCornerRadius", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarCornerRadius", b.oldValue, b.newValue);
    }));
    SeriesViewer.q5 = DependencyProperty.i("VerticalViewScrollbarWidth", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarWidth", b.oldValue, b.newValue);
    }));
    SeriesViewer.qw = DependencyProperty.i("VerticalViewScrollbarInset", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.q4 = DependencyProperty.i("VerticalViewScrollbarTrackStartInset", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarTrackStartInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.q3 = DependencyProperty.i("VerticalViewScrollbarTrackEndInset", Number_$type, SeriesViewer.$, new PropertyMetadata(2, NaN, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("VerticalViewScrollbarTrackEndInset", b.oldValue, b.newValue);
    }));
    SeriesViewer.kh = "VerticalViewScrollbarShouldAddAutoTrackInsets";
    SeriesViewer.q1 = DependencyProperty.i(SeriesViewer.kh, Boolean_$type, SeriesViewer.$, new PropertyMetadata(2, true, function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl(SeriesViewer.kh, b.oldValue, b.newValue);
    }));
    SeriesViewer.pg = DependencyProperty.i("HighlightingBehavior", SeriesHighlightingBehavior_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(SeriesHighlightingBehavior_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("HighlightingBehavior", b.oldValue, b.newValue);
    }));
    SeriesViewer.pz = DependencyProperty.i("LegendHighlightingMode", LegendHighlightingMode_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(LegendHighlightingMode_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("LegendHighlightingMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.p1 = DependencyProperty.i("LegendItemBadgeShape", LegendItemBadgeShape_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(LegendItemBadgeShape_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("LegendItemBadgeShape", b.oldValue, b.newValue);
    }));
    SeriesViewer.p0 = DependencyProperty.i("LegendItemBadgeMode", LegendItemBadgeMode_$type, SeriesViewer.$, new PropertyMetadata(2, enumGetBox(LegendItemBadgeMode_$type, 0), function (a, b) {
        var c = typeCast(SeriesViewer.$, a);
        c.nl("LegendItemBadgeMode", b.oldValue, b.newValue);
    }));
    SeriesViewer.sr = Rect.empty;
    SeriesViewer.$$p = markDep(DependencyProperty, PropertyMetadata, SeriesViewer, 'nl', ['ActualPlotAreaBorderBrush:rj:o6', [Brush.$, null], 'Brushes:ag:o8', [BrushCollection.$, null], 'CircleMarkerTemplate:ov:o9', [DataTemplate.$, null], 'CrosshairVisibility:sz:pa', [Visibility_$type, enumGetBox(Visibility_$type, 0)], 'DefaultInteraction:ce:pb', [InteractionState_$type, enumGetBox(InteractionState_$type, 3)], 'DiamondMarkerTemplate:ow:pc', [DataTemplate.$, null], 'DragModifier:rf:pd', [ModifierKeys_$type, enumGetBox(ModifierKeys_$type, 2)], 'HexagonMarkerTemplate:ox:pe', [DataTemplate.$, null], 'HexagramMarkerTemplate:oy:pf', [DataTemplate.$, null], 'HighlightingTransitionDuration:he:pi', [1, 300], 'HorizontalCrosshairBrush:rt:pj', [Brush.$, null], 'IsPagePanningAllowed:eg:pw', [0, true], 'IsSurfaceInteractionDisabled:eh:px', [0, false], 'MarkerAutomaticBehavior:ba:p3', [MarkerAutomaticBehavior_$type, enumGetBox(MarkerAutomaticBehavior_$type, 4)], 'MarkerBrushes:ah:p4', [BrushCollection.$, null], 'MarkerOutlines:ai:p5', [BrushCollection.$, null], 'Outlines:aj:p6', [BrushCollection.$, null], 'OverviewPlusDetailPaneVisibility:s0:p7', [Visibility_$type, enumGetBox(Visibility_$type, 1)], 'PanModifier:rg:p8', [ModifierKeys_$type, enumGetBox(ModifierKeys_$type, 4)], 'PentagonMarkerTemplate:oz:p9', [DataTemplate.$, null], 'PentagramMarkerTemplate:o0:qa', [DataTemplate.$, null], 'PlotAreaBackground:rw:qb', [Brush.$, null], 'PlotAreaBorderBrush:rx:qc', [Brush.$, null], 'PreferHigherResolutionTiles:e0:qd', [0, false], 'PreviewPathFill:ry:qe', [Brush.$, null], 'PreviewPathOpacity:gm:qf', [1, NaN], 'PreviewPathStroke:rz:qg', [Brush.$, null], 'PyramidMarkerTemplate:o1:qh', [DataTemplate.$, null], 'RightButtonDefaultInteraction:cg:qi', [InteractionState_$type, enumGetBox(InteractionState_$type, 3)], 'ScrollbarsAnimationDuration:hf:qj', [1, 300], 'SquareMarkerTemplate:o2:ql', [DataTemplate.$, null], 'SubtitleHorizontalAlignment:rd:qm', [HorizontalAlignment_$type, enumGetBox(HorizontalAlignment_$type, 1)], 'Subtitle:jk:qn', [2, null], 'TetragramMarkerTemplate:o3:qo', [DataTemplate.$, null], 'TitleHorizontalAlignment:re:qp', [HorizontalAlignment_$type, enumGetBox(HorizontalAlignment_$type, 1)], 'Title:jw:qq', [2, null], 'TriangleMarkerTemplate:o4:qr', [DataTemplate.$, null], 'UseTiledZooming:fc:qs', [0, false], 'VerticalCrosshairBrush:r2:qt', [Brush.$, null], 'WindowPositionHorizontal:g4:q6', [1, NaN], 'WindowPositionVertical:g5:q7', [1, NaN], 'WindowRectMinWidth:g6:q8', [1, 0.0001], 'WindowRect:sv:q9', [Rect.$, new Rect(0, 0, 0, 1, 1)], 'WindowResponse:b7:ra', [WindowResponse_$type, enumGetBox(WindowResponse_$type, 1)], 'ZoomCoercionMode:cb:rb', [ZoomCoercionMode_$type, enumGetBox(ZoomCoercionMode_$type, 0)], 'ZoomTileCacheSize:hg:rc', [1, 30]]);
    return SeriesViewer;
}(Control));
export { SeriesViewer };
/**
...
var SeriesViewerView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function SeriesViewerView(a) {
        ...
        _this.a7 = 0;
        _this.p = a;
        _this.p.r6 = { $type: Point_$type, x: NaN, y: NaN };
        _this.p.b7 = 1;
    ...
    SeriesViewerView.prototype.cn = function () {
        ...
        this.p.cj.provideContext(this.z);
        this.p.cj.provideContainer(this.bi);
        this.p.cj.provideEventSource(this.k);
        this.n.world = new Rect(0, 0, 0, 1, 1);
        this.n.window = this.p.sv;
    ...
    SeriesViewerView.prototype.dn = function (a, b) {
        var c = b.newValue;
        if (this.n != null) {
            c = this.n.changeRect(b.oldValue, b.newValue, this.p.em(), this.p.en(), this.n.world);
        }
        if (c.isEmpty) {
        ...
        if (this.p.b7 == 1) {
            var d = this.p.su.width / this.p.su.height;
    ...
    SeriesViewerView.prototype.em = function () {
        ...
        var a = 1;
        if (this.p.su.isEmpty == false) {
            a = this.p.su.width / this.p.su.height;
        }
        var b = this.n.world;
        ...
        this.n.window = new Rect(0, this.p.sv.left * a, this.p.sv.top, this.p.sv.width * a, this.p.sv.height);
    };
    ...
    SeriesViewerView.prototype.dc = function () {
        ...
        if (this.g.count == 0) {
            if (this.y != null && Rect.l_op_Inequality(this.p.su, null) && !this.p.su.isEmpty) {
                this.er();
            }
        }
    ...
    SeriesViewerView.prototype.er = function () {
        ...
        if (this.y != null && Rect.l_op_Inequality(this.p.su, null) && !this.p.su.isEmpty) {
            if (this.p.f4 != 1) {
                this.y.z();
                this.y.aa(this.p.f4, this.p.f4);
            }
            this.y.k(this.p.su.left, this.p.su.top, this.p.su.width, this.p.su.height);
            if (this.p.f4 != 1) {
                this.y.y();
            }
        }
    ...
    SeriesViewerView.prototype.eg = function (a) {
        this.fi.o = a.top + this.p.su.top;
        this.fi.n = a.left + this.p.su.left;
    ...
    SeriesViewerView.prototype.c0 = function (a) {
        ...
        if (a == null) {
            ...
            this.k = null;
            if (this.p.cj != null) {
                this.p.cj.provideContext(null);
                this.p.cj.provideContainer(null);
                this.p.cj.provideEventSource(null);
            }
            return;
        }
        this.bi = a;
        ...
        if (this.k != null) {
            ...
            var g = this.k;
            g.onDragCompleted = delegateCombine(g.onDragCompleted, runOn(this.p, this.p.me));
            var h = this.k;
            h.onFlingStarted = delegateCombine(h.onFlingStarted, runOn(this, this.al));
            var i = this.k;
            i.onDragDelta = delegateCombine(i.onDragDelta, function (i) { return _this.p.mf(i); });
            var j = this.k;
            j.onDragStarted = delegateCombine(j.onDragStarted, function (j) { return _this.p.mg(j, true); });
            var k = this.k;
            k.onKeyDown = delegateCombine(k.onKeyDown, runOn(this.p, this.p.ex));
            var l = this.k;
            ...
            var p = this.k;
            p.onMouseWheel = delegateCombine(p.onMouseWheel, runOn(this.p, this.p.ey));
            if (this.k.an) {
                var q = this.k;
                q.onZoomDelta = delegateCombine(q.onZoomDelta, function (q, r, s, t) { return _this.p.m8(q, r, s, t); });
                var r = this.k;
                r.onZoomStarted = delegateCombine(r.onZoomStarted, function (r, s, t, u) { return _this.p.nc(r, s, t, u); });
                var s = this.k;
                ...
                var t = this.k;
                t.onPinchDelta = delegateCombine(t.onPinchDelta, function (t, u) { return _this.p.mq(u); });
                var u = this.k;
                u.onPinchStarted = delegateCombine(u.onPinchStarted, function (u, v) { return _this.p.mr(u); });
                var v = this.k;
                v.onGestureCompleted = delegateCombine(v.onGestureCompleted, function (v, w) { return _this.p.mh(v); });
            }
            var w = this.k;
            w.onDoubleTap = delegateCombine(w.onDoubleTap, function (w) { return _this.p.md(w); });
            var x = this.k;
            x.onHold = delegateCombine(x.onHold, runOn(this, this.c3));
        }
        if (this.p.cj != null) {
            this.p.cj.provideContext(this.z);
            this.p.cj.provideContainer(a);
            this.p.cj.provideEventSource(this.k);
        }
        try {
    ...
    SeriesViewerView.prototype.f = function (a, b, c, d) {
        var _this = this;
        return {
            ret: ((function () { var e = _this.p.a5.f$d(_this.p, _this.g, _this.x, a, b, c, d); c = e.p5; return e.ret; })()),
            p2: c
        };
    };
    ...
    SeriesViewerView.prototype.b2 = function () {
        ...
        try {
            for (var _e = __values(fromEnum(this.b)), _f = _e.next(); !_f.done; _f = _e.next()) {
                ...
                if (k.av != null) {
                    j.add(k.av);
                    k.av.bx = function () { return _this.aj; };
                }
            }
        }
        catch (e_15_1) {
    ...
    SeriesViewerView.prototype.ek = function () {
        if (this.p.cj != null && !this.e9.isEmpty) {
            var a = this.p.cj;
            var b = (this.p.dj) ? this.e9.width : Number.POSITIVE_INFINITY;
            var c = (this.p.dj) ? this.e9.height : Number.POSITIVE_INFINITY;
            var d = a.getDesiredSize(new Size(1, b, c));
            this.p.cj.arrange(new Rect(0, this.e9.right - d.width, this.e9.bottom - d.height, d.width, d.height));
            this.em();
        }
    };
    ...
    SeriesViewerView.prototype.bf = function () {
        if (this.p.jw == null || !(typeCast(XamDataChart.$, this.p) !== null)) {
            return 0;
        }
        var a = this.v();
        var b = 0;
    ...
    SeriesViewerView.prototype.be = function () {
        if (this.p.jk == null || !(typeCast(XamDataChart.$, this.p) !== null)) {
            return 0;
        }
        if (!isNaN_(this.a2)) {
            return this.a2;
    ...
    SeriesViewerView.prototype.fm = function () {
        var a = this.j.cd();
        var b = isNaN_(this.p.gv) ? a.top : this.p.gv;
        var c = isNaN_(this.p.gt) ? a.left : this.p.gt;
        var d = isNaN_(this.p.gu) ? a.right : this.p.gu;
        var e = isNaN_(this.p.gs) ? a.bottom : this.p.gs;
        return new Thickness(1, c, b, d, e);
    };
    SeriesViewerView.prototype.fl = function () {
        var a = this.j.cc();
        var b = isNaN_(this.p.gr) ? a.top : this.p.gr;
        var c = isNaN_(this.p.gp) ? a.left : this.p.gp;
        var d = isNaN_(this.p.gq) ? a.right : this.p.gq;
        var e = isNaN_(this.p.go) ? a.bottom : this.p.go;
        return new Thickness(1, c, b, d, e);
    };
    ...
    SeriesViewerView.prototype.d1 = function () {
        if (this.z.d) {
            ...
            if (this.ax != null && this.ax.count > 0) {
                ...
                this.z.ae(this.p.su);
                if (!this.au) {
                    this.z.k(this.p.su.left, this.p.su.top, this.p.su.width, this.p.su.height);
                }
            }
            this.z.r(this.fd);
            this.z.r(this.fe);
    ...
    SeriesViewerView.prototype.dp = function () {
        ...
        if (this.p.cj != null) {
            var a = this.p.s0;
            this.p.cj.visibility = a;
            this.p.cj.doRefresh(false);
        }
    };
    SeriesViewerView.prototype.as = function (a) {
        return this.p.a5.f$g(this.p, a);
    };
    SeriesViewerView.prototype.c8 = function (a, b, c) {
        this.p.a5.f$w(this.p, this.g, this.x, a, b, c);
        this.p.k0(a, this.p.ch != 0 || this.p.eq);
    };
    SeriesViewerView.prototype.c7 = function (a) {
        this.p.a5.f$v(this.p, a);
    };
    SeriesViewerView.prototype.c6 = function (a) {
        this.p.a5.f$u(this.p, this.k, a);
    };
    SeriesViewerView.prototype.c9 = function (a) {
        this.p.a5.f$x(this.p, this.k, a);
    };
    ...
    SeriesViewerView.prototype.c5 = function () {
        ...
        if (this.n != null) {
            this.n.isSurfaceInteractionDisabled = this.p.eh;
        }
    };
    ...
    SeriesViewerView.prototype.di = function () {
        this.et = typeCast(XamDataChart.$, this.p) !== null ? this.eu(this.p.jw, this.fm(), this.v(), this.ey()) : null;
    };
    SeriesViewerView.prototype.de = function () {
        this.a2 = NaN;
        this.es = typeCast(XamDataChart.$, this.p) !== null ? this.eu(this.p.jk, this.fl(), this.u(), this.ex()) : null;
        if (this.es != null) {
            this.es.o += this.bf();
        }
    };
    SeriesViewerView.prototype.c = function (a) {
        var b = this.j.c();
        if (b == 0) {
            var c = LabelPanelArranger.b(a.av);
            if (a.ai == null) {
                if (c == 4) {
                    return 4;
                }
    ...
    SeriesViewerView.prototype.dk = function () {
        if (!isNaN_(this.p.f3)) {
            if (!isNaN_(DeviceUtils.a(this.p.gl))) {
                this.p.f4 = DeviceUtils.a(this.p.gl);
            }
            else {
                this.co();
            }
    ...
    SeriesViewerView.prototype.dl = function () {
        if (!isNaN_(DeviceUtils.a(this.p.f3))) {
            this.p.f4 = DeviceUtils.a(this.p.f3);
        }
        if (!this.p.d6) {
            this.j.a3();
        }
    ...
    SeriesViewerView.prototype.am = function () {
        ...
        if ((dateNow().getTime() - this.p.fi.getTime()) < 300) {
            return true;
        }
        return false;
    };
    ...
    SeriesViewerView.prototype.db = function () {
        this.ff._fill = this.p.ry == null ? this.j.b2() : this.p.ry;
        this.ff._opacity = isNaN_(this.p.gm) ? 0.1 : this.p.gm;
        this.fi._stroke = this.p.rz == null ? this.j.b2() : this.p.rz;
    };
    ...
    SeriesViewerView.prototype.bj = function (a, b) {
...
var OverviewPlusDetailViewportHost = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    OverviewPlusDetailViewportHost.prototype.getEffectiveViewport = function () {
        if (!this.a.p.ef) {
            if (this.a.p.sj.isEmpty) {
                return this.a.p.sj;
            }
            return this.a.p.so(this.a.n.previewViewportdRect, this.a.p.su, this.a.p.sj);
        }
        return Rect.empty;
    };
...
var LegendTemplates = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LegendTemplates.g = function (a) {
        ...
        LegendItemHelper.d(a.context, a.xPosition, a.yPosition, a.availableWidth, a.availableHeight, a.data, e.toString(), d, a.passInfo, c.a1 != null && c.a1.isFinancial, c.f1, c.gs);
    };
...
var SeriesViewerViewManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SeriesViewerViewManager.prototype.bf = function (a) {
        if (a == null) {
            if (this.f != null) {
                this.f.av();
            }
        ...
        this.ae = a;
        this.j.p.cr.u(this.ae);
        this.j.p.cs.u(this.ae);
        ...
        this.ah.addClass(this.j.p.j6);
        this.ae.append(this.ah);
    };
    SeriesViewerViewManager.bx = function (a, b) {
        b();
        return;
    };
    ...
    SeriesViewerViewManager.prototype.a9 = function () {
        ...
        if (window.devicePixelRatio != undefined && window.devicePixelRatio != b) {
            this.j.p.f4 = window.devicePixelRatio;
        }
    };
    ...
    SeriesViewerViewManager.prototype.bl = function () {
    ...
    SeriesViewerViewManager.prototype.b2 = function () {
        return ((function () {
            var $ret = new Brush();
            $ret.fill = "#000000";
            return $ret;
    ...
    SeriesViewerViewManager.prototype.ay = function (a, b, c) {
        this.ab = a;
        this.aa = b;
        this.ac = c;
        var d = a;
    ...
    SeriesViewerViewManager.prototype.a7 = function (a, b, c, d, e) {
        var f = this.e();
        a = f.a;
        b = f.f;
        c = f.k;
    ...
    SeriesViewerViewManager.prototype.a6 = function (a, b, c, d, e, f) {
        this.ae.startCSSQuery();
    ...
    SeriesViewerViewManager.prototype.bt = function (x_) {
        var box_ = this.ah;
        var offset_ = this.f.bk(this.ah);
        var a = this.b7();
        x_ = a.x + this.j.p.su.left + x_;
        box_.setOffset(x_, this.j.p.su.top + this.ad + a.y);
    };
    SeriesViewerViewManager.prototype.bu = function (y_) {
        this.ad = y_;
        var box_ = this.ah;
        var offset_ = this.ah.getOffset();
        var a = this.b7();
        y_ = this.j.p.su.top + this.ad + a.y;
        box_.setOffset(offset_.left, y_);
    };
    SeriesViewerViewManager.prototype.at = function (a) {
        var b = a;
        b.show();
        this.ah.append(b);
    };
    SeriesViewerViewManager.prototype.a8 = function () {
        this.ah.hide();
    };
    ...
    SeriesViewerViewManager.prototype.bj = function (a) {
        a.remove();
    };
    SeriesViewerViewManager.prototype.bc = function () {
        if (this.ae == null) {
            return;
        }
        this.a9();
    ...
    SeriesViewerViewManager.prototype.cc = function () {
        return this.b8;
    };
    ...
    SeriesViewerViewManager.prototype.bw = function () {
    ...
    SeriesViewerViewManager.prototype.a5 = function (a, b) {
        var c = this.j.p.f4;
        if (a != this.ab || b != this.aa || c != this.ac) {
            this.ay(a, b, this.j.p.f4);
            this.j.p.al.i();
            this.j.a.i();
        }
    };
    ...
    SeriesViewerViewManager.prototype.ba = function (a) {
        if (this.f == null) {
            return;
        }
        this.f.ab = a;
    ...
    SeriesViewerViewManager.prototype.a2 = function (a) {
        this.z.removeItem(a.iD.toString());
    };
    SeriesViewerViewManager.prototype.a1 = function () {
        this.z.clear();
    };
    SeriesViewerViewManager.prototype.bk = function (a) {
        for (var b = 0; b < a.count; b++) {
            var c = a._inner[b];
            var d = c.content;
            this.j.z.m(d.getNativeElement(), 1, c.xPosition + this.j.p.su.left, c.yPosition + this.j.p.su.top, c.width, c.height);
        }
    };
    SeriesViewerViewManager.prototype.az = function () {
        ...
        if (this.ae != null) {
            this.al = this.ae.setTimeout(function () { return _this.j.p.a5.f$j(_this.j.p); }, 5000);
        }
        else {
            this.al = window.setTimeout(function () { return _this.j.p.a5.f$j(_this.j.p); }, 5000);
        }
    };
    SeriesViewerViewManager.prototype.av = function () {
        if (this.al != -1) {
            if (this.ae != null) {
    ...
    SeriesViewerViewManager.prototype.a0 = function (a) {
        var _this = this;
        if (this.am != -1) {
            this.aw();
        }
        if (this.ae != null) {
            this.am = this.ae.setTimeout(function () { return _this.j.p.k7(); }, a);
        }
        else {
            this.am = window.setTimeout(function () { return _this.j.p.k7(); }, a);
        }
    };
    ...
    SeriesViewerViewManager.prototype.bv = function (a) {
        if (this.ae != null) {
            var b = "igTouch";
            if (a) {
    ...
    SeriesViewerViewManager.prototype.a3 = function () {
    };
    SeriesViewerViewManager.prototype.a4 = function () {
    };
    SeriesViewerViewManager.prototype.bg = function () {
        if (this.f != null) {
            this.f.bh(this.aj, "");
        }
    };
    ...
    SeriesViewerViewManager.prototype.ao = function (a, b) {
        var c = this.ae.createElement("canvas");
        c.setStyleProperty("width", a + "px");
        c.setStyleProperty("height", b + "px");
        c.setProperty("width", a);
        c.setProperty("height", b);
        var d = this.ae.get2DCanvasContext(c);
        if (this.t != null) {
        ...
        var e = this.ae.createElement("img");
        var sCanv_ = c.getNativeElement();
        ...
        if (!isInfinity(h) && !isInfinity(i)) {
            ...
            if (d) {
                ...
                if (a != null && p > 0 && (!a.le && !a.ld)) {
                    var q = new LinearNumericSnapper(0, h, i, p, a.ex());
                    o = q.g;
                }
                    ...
                    var t = new LinearNumericSnapper(0, r, s, p, a.ex());
                    o = t.g;
                }
                ...
                if (a.la) {
                    if (a.la && p > 0 && (!a.le || !a.ld)) {
                        var v = new LinearNumericSnapper(0, h, i, p, a.ex());
                        var w = v.g;
                        if (w != o) {
                            o = w;
                            if ((isNaN_(b) || isInfinity(b)) && !isNaN_(h) && !isNaN_(o) && o != 0) {
...
var Axis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function Axis() {
        ...
        _this.ak = new AxisAnnotationCollection();
        ...
        _this.propertyUpdated = null;
        _this.dd = null;
        _this.c9 = new Dictionary$2(String_$type, String_$type, 0);
        _this.c8 = new Dictionary$2(String_$type, FastReflectionHelper.$, 0);
        _this.kh = new Size();
        _this.ao = new AxisComponentsForView();
        _this.d2 = 0;
        _this.dg = 0;
        _this.bq = null;
        _this.bp = null;
        _this.bo = null;
        _this.aw = new AxisLabelSettings();
        _this.fj = null;
        DVContainer.instance.registerIfLoaded("VisualDataFactoryManager");
        DVContainer.instance.registerIfLoaded("AnnotationFactoryManager");
        _this.d2 = NaN;
        ...
        _this.bq = ((function () {
            ...
            $ret.create = runOn(_this.a4, _this.a4.a0);
            $ret.activate = runOn(_this.a4, _this.a4.at);
            $ret.disactivate = runOn(_this.a4, _this.a4.av);
            $ret.destroy = runOn(_this.a4, _this.a4.au);
            return $ret;
        })());
        _this.bp = ((function () {
            var $ret = new Pool$1(TextBlock.$);
        ...
        _this.bo = ((function () {
            ...
            $ret.create = runOn(_this.a4, _this.a4.bf);
            $ret.activate = runOn(_this.a4, _this.a4.s);
            $ret.disactivate = runOn(_this.a4, _this.a4.u);
            $ret.destroy = runOn(_this.a4, _this.a4.t);
            return $ret;
        })());
        _this.kb = Rect.empty;
        _this.db = new List$1(Base.$, 0);
        _this.dc = new List$1(LabelPosition.$, 0);
        _this.av = _this.au();
        _this.av.ag = _this.ay;
        _this.av.ad = _this;
        _this.dd = new List$1(Series.$, 0);
        var a = _this.ak;
        a.collectionResetting = delegateCombine(a.collectionResetting, runOn(_this, _this.hb));
        var b = _this.ak;
        b.collectionChanged = delegateCombine(b.collectionChanged, runOn(_this, _this.ha));
        var c = _this.al;
        c.collectionResetting = delegateCombine(c.collectionResetting, runOn(_this, _this.hd));
        var d = _this.al;
        d.collectionChanged = delegateCombine(d.collectionChanged, runOn(_this, _this.hc));
        _this.ab = Axis.$;
        if (_this.ay != null) {
            _this.aw = _this.ay;
        }
        _this.propertyUpdated = delegateCombine(_this.propertyUpdated, function (e, f) { return _this.hv(e, f.propertyName, f.oldValue, f.newValue); });
        _this.br = function (e, f) {
            if (_this.bh == null || !_this.bh.d4) {
                _this.ip(f.oldRect, f.newRect);
            }
        };
        _this.a4.y();
        return _this;
    }
    Axis.prototype.a3 = function () {
        return new AxisView(this);
    };
    Axis.prototype.hr = function (a) {
    };
    Axis.prototype.he = function () {
        if (this.b9) {
            this.a7.onAddAnnotations(this);
        }
    };
    Object.defineProperty(Axis.prototype, "bt", {
        get: function () {
            if (this.bs == null) {
    ...
    Object.defineProperty(Axis.prototype, "a9", {
        get: function () {
            var _this = this;
            if (this.a8 == null) {
                this.a8 = DVContainer.instance.createInstance(IAxisVisualDataManager_$type, function () { return _this.bt.q; });
            }
            return this.a8;
        },
        enumerable: false,
    ...
    Axis.prototype.get_ca = function () {
        return false;
    };
    ...
    Axis.prototype.get_ci = function () {
        return false;
    };
    Object.defineProperty(Axis.prototype, "ci", {
        get: function () {
            return this.get_ci();
        },
        enumerable: false,
    ...
    Axis.prototype.get_b8 = function () {
        return false;
    };
    Object.defineProperty(Axis.prototype, "b8", {
        get: function () {
            return this.get_b8();
        },
        enumerable: false,
    ...
    Axis.prototype.get_co = function () {
        return false;
    };
    Object.defineProperty(Axis.prototype, "co", {
        get: function () {
            return this.get_co();
        },
        enumerable: false,
    ...
    Object.defineProperty(Axis.prototype, "a7", {
        get: function () {
            var _this = this;
            if (this.a6 == null) {
                this.a6 = DVContainer.instance.createInstance(IAxisAnnotationManager_$type, function () { return _this.bt.n; });
                this.a6.owner = this;
            }
            return this.a6;
        },
    ...
    Axis.prototype.hc = function (a, b) {
        if (!this.b9) {
            return;
        }
    ...
    Axis.prototype.ha = function (a, b) {
        if (!this.b9) {
            return;
        }
        this.a7.onAnnotionsChanged(this, this.ak, b);
    };
    Axis.prototype.hb = function (a, b) {
        if (!this.b9) {
            return;
        }
    ...
    Axis.prototype.ho = function (a, b) {
        if (!a.equals1(b)) {
            this.io(a, b);
        }
    };
    ...
    Object.defineProperty(Axis.prototype, "bn", {
        get: function () {
            return this.bm;
        },
        set: function (a) {
    ...
    Object.defineProperty(Axis.prototype, "bh", {
        get: function () {
            return this.bg;
        },
        set: function (a) {
    ...
    Object.defineProperty(Axis.prototype, "bf", {
        get: function () {
    ...
    Object.defineProperty(Axis.prototype, "c5", {
        get: function () {
            return this.bx;
        },
        set: function (a) {
            ...
            if (this.bh != null && this.bh.cq != null) {
                this.av.af.al(this.bh.cq.y);
                this.h5(true);
            }
        },
        enumerable: false,
    ...
    Object.defineProperty(Axis.prototype, "e5", {
        get: function () {
            return this.dk;
        },
        set: function (a) {
    ...
    Object.defineProperty(Axis.prototype, "dw", {
        get: function () {
            return this.de;
        },
        set: function (a) {
    ...
    Object.defineProperty(Axis.prototype, "e4", {
        get: function () {
            return this.dj;
        },
        set: function (a) {
    ...
    Object.defineProperty(Axis.prototype, "bl", {
        get: function () {
            if (this.bj == null) {
                if (this.bi == null) {
                    this.bi = this.a4.i();
    ...
    Object.defineProperty(Axis.prototype, "e6", {
        get: function () {
            return this.dl;
        },
        set: function (a) {
    ...
    Object.defineProperty(Axis.prototype, "fs", {
        get: function () {
            return this.fn;
        },
        set: function (a) {
    ...
    Object.defineProperty(Axis.prototype, "fr", {
        get: function () {
            return this.fm;
        },
        set: function (a) {
    ...
    Object.defineProperty(Axis.prototype, "fq", {
        get: function () {
            return this.fl;
        },
        set: function (a) {
    ...
    Axis.prototype.h4 = function () {
        this.h5(false);
    };
    Axis.prototype.h5 = function (a) {
        if (a) {
            this.av.co();
        }
        this.cp = true;
    ...
    Object.defineProperty(Axis.prototype, "b3", {
        get: function () {
            return this.bv;
        },
        enumerable: false,
    ...
    Object.defineProperty(Axis.prototype, "b6", {
        get: function () {
    ...
    Object.defineProperty(Axis.prototype, "c3", {
        get: function () {
    ...
    Axis.prototype.d4 = function () {
        return 0;
    };
    Axis.prototype.jq = function () {
        if (this.co) {
            return 2;
        }
        return 0;
    ...
    Axis.prototype.jr = function () {
        return 1;
    };
    Axis.prototype.kk = function () {
        return 1;
    };
    ...
    Axis.prototype.d3 = function () {
        return NaN;
    };
    Object.defineProperty(Axis.prototype, "am", {
        get: function () {
            return this.ak;
        },
        enumerable: false,
    ...
    Object.defineProperty(Axis.prototype, "kc", {
        get: function () {
            if (this.kb.isEmpty) {
                return this.j5;
            }
    ...
    Axis.prototype.ik = function () {
        var a = 0;
        var b = typeCast(XamDataChart.$, this.bh);
        if (b != null && b.s6 == 0) {
            a = 1;
        }
        this.a4.ay(a);
    };
    Axis.prototype.c7 = function (a, b, c) {
        return this.bh != null;
    };
    Axis.prototype.cn = function () {
        var a = Rect.empty;
        if (this.bh != null) {
            a = this.bh.sv;
        }
    ...
    Axis.prototype.io = function (a, b) {
        this.cq = false;
        this.kc = b;
        this.cp = true;
        this.c0();
    ...
    Axis.prototype.j9 = function () {
        if (this.bh == null || this.bh.sj.isEmpty) {
            return Rect.empty;
        }
        var a = this.bh.sj;
        var b = this.kc;
    ...
    Axis.prototype.ip = function (a, b) {
        this.cp = true;
        this.h7(true);
    };
    Axis.prototype.h3 = function () {
        this.h7(false);
    };
    Axis.prototype.hv = function (a, b, c, d) {
        var e_20, _a;
        switch (b) {
            case Axis.$$p[10]:
            case Axis.$$p[11]:
            ...
            case "SeriesViewer":
                ...
                if (f != null) {
                    ...
                    this.a5 = f.ap.k(1, this, runOn(this, this.hj));
            ...
            case Axis.$$p[9]:
                ...
                this.hi(g);
                try {
                    for (var _b = __values(fromEnum(this.dd)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var h = _c.value;
                        h.le();
                        if (h.cd != null) {
                            h.lo();
    ...
    Axis.prototype.im = function (a, b, c, d) {
        var e = Math.min(b, c);
        var f = Math.max(b, c);
    ...
    Axis.prototype.il = function (a, b, c, d, e) {
    ...
    Axis.prototype.cf = function (a, b, c, d) {
        var e_21, _a;
        var e = false;
        var f = typeCast(XamDataChart.$, this.bh);
        if (f != null && (f.tx || f.ty) && !c.isEmpty) {
            var g = this.bh.sf.width == 1 && this.bh.sf.height == 1;
            try {
                for (var _b = __values(fromEnum(f.axes)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    if (h.ai != null && h.b4()) {
                        if (f.tx) {
                            var i = this.co ? c.left : c.top;
                            var j = 0;
                            var k = h.id(i, j, h.bh.sv, c, h.j7(), d ? c.left : c.top, d ? c.right : c.bottom);
                            i = k.p0;
                            j = k.p1;
                            var l = Rect.empty;
                            var m = Rect.empty;
    ...
    Axis.prototype.id = function (a, b, c, d, e, f, g) {
        var h = Math.abs(f - g);
        a = this.fu;
        a = this.ai.e3(a);
        var i = typeCast(CategoryAxisBase.$, this.ai);
    ...
    Axis.prototype.dz = function (a, b, c, d) {
        var e = a;
        if (d != null && d.c > 0) {
            var f = d.c % 2;
            if (f == 0 || f == 1) {
    ...
    Axis.prototype.h6 = function () {
        this.h7(false);
    };
    Axis.prototype.h7 = function (a) {
        if (this.bh != null) {
    ...
    Axis.prototype.d1 = function (a, b, c, d, e) {
        if (a == 1) {
            return 1;
        }
        if (b) {
    ...
    Axis.prototype.ep = function (a, b, c, d, e) {
        var f = false;
        if (this.co) {
        ...
        if (f) {
            var g = this.ef(a, c, d, e);
            if (isNaN_(g)) {
                return a;
            }
            var h = this.eg(a, c, d, e);
            if (g <= h) {
                return a;
            }
    ...
    Axis.prototype.eg = function (a, b, c, d) {
        if (this.co) {
            var e = this.bb.b;
            return e;
        }
            ...
            var f = this.dh;
            if (this.bh != null && this.bh.eu) {
                f = this.bb.b;
            }
            return f;
        }
    };
    Axis.prototype.cy = function (a, b, c, d) {
        if (this.co) {
    ...
    Axis.prototype.ef = function (a, b, c, d) {
        return NaN;
    };
    ...
    Object.defineProperty(Axis.prototype, "cz", {
        get: function () {
            return this.fp == -1;
        },
        enumerable: false,
    ...
    Axis.prototype.b1 = function () {
        ...
        for (var c = 0; c < this.db.count; c++) {
            var d = this.db._inner[c];
            if (typeof d === 'string') {
                var e = FontUtil.measureStringWidth(d, a, this.a4.j);
                b = Math.max(e, b);
            }
        }
        b += 5;
    ...
    Axis.prototype.d0 = function (a, b) {
        return a;
    };
    Axis.prototype.ic = function () {
        this.dh = NaN;
    };
    Axis.prototype.ba = function () {
        var a = this.bk();
        if (a == null) {
            return null;
        }
        ...
        var c = FontUtil.measureStringWidth(b, a, this.a4.j);
        if (this.di != c || this.bb == null) {
            this.di = c;
            var d = FontUtil.getCurrentFontHeight(this.bh.cq.j.ae, a);
            if (this.bb == null) {
    ...
    Axis.prototype.bk = function () {
        ...
        if (this.ay != null && this.ay.j) {
            if (this.bh != null) {
                a = this.ay.h(this.bh.cq.j.ae);
            }
        }
        return a;
    };
    Axis.prototype.hk = function () {
        if (!this.a4.o()) {
            return;
        }
        if (!this.b7()) {
    ...
    Axis.prototype.c0 = function () {
        return this.c1(false);
    };
    Axis.prototype.c1 = function (a) {
        if (a || this.bh == null) {
            var b = this.c2();
            if (b) {
                this.cp = true;
    ...
    Axis.prototype.ii = function () {
        ...
        if (this.ca && !this.b8) {
            b = a.w2;
            try {
                for (var _c = __values(fromEnum(this.dd)), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var e = _d.value;
                    if (e.ec || e.ea || e.d6 || e.ea) {
                        c = a.w0;
                        d = a.w1;
                        break;
                    }
            ...
            c = a.w0;
            d = a.w1;
            b = this.ai != null ? a.w2 : null;
            try {
                for (var _e = __values(fromEnum(this.dd)), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var f = _f.value;
                    if (f.ec || f.ea || f.d6 || f.ea) {
                        b = a.w2;
                        break;
                    }
                }
    ...
    Axis.prototype.h1 = function (a, b, c) {
        if (this.propertyChanged != null) {
            this.propertyChanged(this, new PropertyChangedEventArgs(a));
        }
        if (this.propertyUpdated != null) {
    ...
    Axis.prototype.cs = function (a) {
        var b = this.dd.contains(a);
        if (!b) {
            this.dd.add(a);
        }
        this.ii();
    ...
    Axis.prototype.fw = function (a, b) {
        var c = this.gr(b);
        if (c == Axis.$$p[12]) {
    ...
    Axis.prototype.fx = function (a, b, c) {
        var d = null;
    ...
    Axis.prototype.fy = function (a) {
        return this.a4.p(a);
    };
    Axis.prototype.gc = function (a) {
        return this.a4.r(a);
    };
    Axis.prototype.eu = function () {
        return NaN;
    };
    Axis.prototype.ei = function (a, b) {
        return 0;
    };
    Axis.prototype.ej = function (a, b, c) {
        return 0;
    };
    Axis.prototype.j8 = function (a) {
        if (this.bh == null) {
            return Rect.empty;
        }
    ...
    Axis.prototype.j7 = function () {
        if (this.bh == null) {
            return Rect.empty;
        }
        return this.bh.sj;
    };
    Axis.prototype.j6 = function () {
        if (this.bh == null || this.bh.si.isEmpty) {
            return this.kc;
        }
        return this.bh.si;
    };
    ...
    Axis.prototype.ek = function (a, b, c) {
        var d = this.j8(c);
        var e = new ScalerParams(0, b, c, this.cg, d);
        return this.ei(a, e);
    };
    Axis.prototype.hm = function (a, b, c, d) {
    };
    Axis.prototype.hl = function (a, b, c, d, e) {
    };
    ...
    Axis.prototype.hn = function (a, b, c, d) {
    };
    Axis.prototype.e3 = function (a) {
        var b = this.j7();
        var c = new ScalerParams(0, this.bh.sf, this.kc, this.cg, b);
        return this.ei(a, c);
    };
    Axis.prototype.hs = function (a) {
        var b = false;
    ...
    Object.defineProperty(Axis.prototype, "er", {
        get: function () {
            return this.dg;
        },
        set: function (a) {
    ...
    Axis.prototype.hf = function () {
        this.a4.w();
    };
    Axis.prototype.hi = function (a) {
        this.h2(a);
    };
    Object.defineProperty(Axis.prototype, "kd", {
        get: function () {
            return this.aq().a;
        },
        enumerable: false,
    ...
    Object.defineProperty(Axis.prototype, "ke", {
        get: function () {
            return this.aq().b;
        },
        enumerable: false,
    ...
    Object.defineProperty(Axis.prototype, "kg", {
        get: function () {
            return this.a4.c().d;
        },
        enumerable: false,
    ...
    Object.defineProperty(Axis.prototype, "kf", {
        get: function () {
            return this.aq().c;
        },
        enumerable: false,
    ...
    Axis.prototype.bd = function () {
        return SyncManager.a(this.bg);
    };
    Axis.prototype.aq = function () {
        return this.a4.c();
    };
    Object.defineProperty(Axis.prototype, "ax", {
        get: function () {
            return this.aw;
        },
        enumerable: false,
    ...
    Axis.prototype.hw = function (a, b) {
        if (this.av != null) {
            this.av.cj(a);
        }
        this.a4.ai(a, b);
    };
    Axis.prototype.b4 = function () {
        return this.fu != null;
    };
    Axis.prototype.fv = function () {
        return this.a9.exportVisualData(this);
    };
    Axis.prototype._da = function () {
        var a, b;
    ...
    Axis.prototype.da = function () {
        var _this = this;
        return toEnum(function () { return _this._da(); });
    };
    Axis.prototype.hx = function (a) {
    };
    Axis.prototype.h0 = function (a) {
    };
    Axis.prototype.hz = function (a) {
    };
    Axis.prototype.j4 = function (a, b, c, d, e) {
        if (d === void 0) {
            d = null;
        }
        if (e === void 0) {
    ...
    Axis.jo = DependencyProperty.i("UseEnhancedIntervalManagement", Boolean_$type, Axis.$, new PropertyMetadata(2, false, function (a, b) { return a.h1("UseEnhancedIntervalManagement", b.oldValue, b.newValue); }));
    Axis.es = 7;
    Axis.$$p = markDep(DependencyProperty, PropertyMetadata, Axis, 'h1', ['ActualMajorStroke:js:is', [Brush.$], 'ActualMinorStroke:jt:it', [Brush.$], 'ActualStroke:ju:iu', [Brush.$], 'CrossingAxis:ai:iv', [Axis.$], 'CrossingValue:fu:iw', [4, null], 'EnhancedIntervalMinimumCharacters:fp:ix', [1, -1], 'EnhancedIntervalPreferMoreCategoryLabels:b0:iy', [0, false], 'FormatLabel:at:iz', [Delegate_$type], 'IsDisabled:ce:i0', [0, false], 'IsInverted:cg:i1', [0, false], 'LabelFormat:gf:i2', [2, null], 'LabelFormatSpecifiers:ag:i3', [Array_$type, null], 'Label:fz:i4', [4, null], 'LabelSettings:ay:i5', [AxisLabelSettings.$, null], 'MajorStrokeDashArray:j0:i6', [DoubleCollection.$], 'MajorStroke:jv:i7', [Brush.$], 'MajorStrokeThickness:eq:i8', [1, 1], 'MinorStrokeDashArray:j1:i9', [DoubleCollection.$], 'MinorStroke:jw:ja', [Brush.$], 'MinorStrokeThickness:et:jb', [1, 1], 'ShouldAvoidAnnotationCollisions:ct:jc', [0, false], 'ShouldKeepAnnotationsInView:cv:jd', [0, false], 'Strip:jx:je', [Brush.$], 'StrokeDashArray:j2:jf', [DoubleCollection.$], 'Stroke:jy:jg', [Brush.$], 'StrokeThickness:ff:jh', [1, DeviceUtils.g(2)], 'TickLength:fg:ji', [1, NaN], 'TickStrokeDashArray:j3:jj', [DoubleCollection.$], 'TickStroke:jz:jk', [Brush.$], 'TickStrokeThickness:fh:jl', [1, DeviceUtils.g(2)], 'Title:g5:jm', [2], 'TitleSettings:be:jn', [TitleSettings.$, null], 'UsePerLabelHeightMeasurement:c4:jp', [0, false]]);
    return Axis;
}(Control));
export { Axis };
/**
...
var AxisLabelPanelBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AxisLabelPanelBase.prototype.at = function (a, b) {
        if (a == 0 && !this.ad.b8 && this.ag != null) {
            if (this.ad.co) {
                if (!this.ag.showFirstLabel && this.ad.bh.gb() == 1) {
                    return false;
                }
            }
            else {
                if (!this.ag.showFirstLabel && this.ad.bh.ga() == 1) {
                    return false;
                }
            }
        }
    ...
    AxisLabelPanelBase.prototype.a6 = function (a) {
        ...
        if (this.ad.ct || this.ad.cv) {
            ...
            for (var j = 0; j < h.count; j++) {
                ...
                var n = this.ad.bh.su.top;
                if (this.ad.cv) {
                    if (l.top < (this.ad.bh.su.top - n)) {
                        l = new Rect(0, l.left, l.top + ((this.ad.bh.su.top - n) - l.top), l.width, l.height);
                        a._inner[k] = l;
                    }
                }
            }
            ...
            for (var x = h.count - 1; x >= 0; x--) {
                ...
                var ab = this.ad.bh.cq.a3;
                if (this.ad.cv) {
                    if (aa.bottom > this.ad.bh.su.bottom + ab) {
                        z = new Rect(0, z.left, z.top - (aa.bottom - (this.ad.bh.su.bottom + ab)), z.width, z.height);
                        a._inner[y] = z;
                    }
                }
            }
    ...
    AxisLabelPanelBase.prototype.c6 = function (a) {
        ...
        this.b2(a);
        if (this.aq() && this.am && this.ad != null && this.ad.bf != null && !this.ad.cq && this.ad.bf.tk && !this.ad.bf.tr && this.a8 != null && this.a8.count > 0) {
            ...
            this.ad.bf.v5(this, this.c1, this.a8._inner[0], this.a8._inner[h]);
        }
        return a;
    };
    ...
    AxisLabelPanelBase.prototype.a2 = function () {
        ...
        if (typeCast(NumericAxisBase.$, this.ad) !== null) {
            ...
            for (var c = 0; c < d.length; c++) {
                var b = d[c];
                var e = this.ad.j7();
                var f = new ScalerParams(0, this.ad.bh.sv, this.ad.kc, this.ad.ch, e);
    ...
    AxisLabelPanelBase.prototype.ac = function (a, b) {
        ...
        if (h != 0 && h != 360) {
            if (h > 0 && h < 180) {
                j = -Math.sin(MathUtil.n(h)) * (c / 2);
            }
            else {
                i.k = d;
                k = -d;
                j = -Math.sin(MathUtil.n(h - 180)) * (c / 2);
            }
        }
        var l = ((function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(a < this.ad.bq.count))
                        return [3 /*break*/, 4];
                    return [4 /*yield*/, this.ad.bq.item(a)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    if (!(b < this.ad.bp.count))
                        return [3 /*break*/, 8];
                    return [4 /*yield*/, this.ad.bp.item(b)];
                case 6:
                    _a.sent();
                    _a.label = 7;
                case 7:
...
var CategoryAxisBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryAxisBase.prototype.a3 = function () {
        return new CategoryAxisBaseView(this);
    };
    CategoryAxisBase.prototype.get_cc = function () {
        return false;
    };
    CategoryAxisBase.prototype.hr = function (a) {
        _super.prototype.hr.call(this, a);
        this.km = a;
    };
    CategoryAxisBase.prototype.ef = function (a, b, c, d) {
        var e = this.getCategorySize(b, c, d);
        var f = e * a;
        return f;
    };
    CategoryAxisBase.prototype.c7 = function (a, b, c) {
    ...
    CategoryAxisBase.prototype.l0 = function () {
        if (this.kq != null && this.bn != null && this.itemsSource != null) {
            this.kq = this.bn.releaseFastItemsSource(this.itemsSource);
        }
    };
    CategoryAxisBase.prototype.lz = function () {
        if (this.kq == null && this.bn != null && this.itemsSource != null) {
            this.kq = this.bn.getFastItemsSource(this.itemsSource);
        }
    };
    CategoryAxisBase.prototype.get_ca = function () {
        return true;
    };
    CategoryAxisBase.prototype.md = function (a, b, c) {
        if (this.b8) {
            return Rect.empty;
        }
        return this.me(a, b, c, this.co);
    };
    CategoryAxisBase.prototype.me = function (a, b, c, d) {
        var e = 0;
        var f = a.x;
        var g = this.kc.left;
        var h = this.kc.right;
        ...
        if ((d && !this.cg) || (!d && this.cg)) {
            ...
            for (var j = this.kx.count - 1; j >= 0; j--) {
    ...
    Object.defineProperty(CategoryAxisBase.prototype, "lf", {
        get: function () {
            return this.lc;
        },
        set: function (a) {
    ...
    CategoryAxisBase.prototype.la = function (a, b, c) {
        var d = !isNaN_(this.k0) ? MathUtil.c(this.k0, 0, this.kz) : 0;
        if (!this.b8 && this.k8 > 0) {
            ...
            if (g < this.k8) {
                ...
                f = g / e;
                d = f / 0.5;
                d = MathUtil.c(d, 0, this.kz);
            }
        }
        return d;
    };
    Object.defineProperty(CategoryAxisBase.prototype, "lg", {
        get: function () {
            return this.ld;
        },
        set: function (a) {
    ...
    CategoryAxisBase.prototype.el = function (a, b) {
        return NaN;
    };
    ...
    CategoryAxisBase.prototype.k3 = function (a, b, c) {
        return NaN;
    };
    CategoryAxisBase.prototype.getGroupCenter = function (a, b, c, d) {
        return NaN;
    };
    CategoryAxisBase.prototype.lb = function (a) {
        var b = this.bh.sv;
        var c = this.kc;
        var d = this.j7();
        var e = new ScalerParams(0, b, c, this.cg, d);
    ...
    CategoryAxisBase.prototype._kw = function () {
        var _a, _b, a, e_26_1, _c, _d, b, _e, _f, c, e_27_1, e_28_1;
        var e_26, _g, e_28, _h, e_27, _j;
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    _k.trys.push([0, 5, 6, 7]);
                    _a = __values(fromEnum(this.dd)), _b = _a.next();
                    _k.label = 1;
                case 1:
                    if (!!_b.done)
                        return [3 /*break*/, 4];
                ...
                case 6:
                    ...
                    return [7 /*endfinally*/];
                case 7:
                    if (!(this.bh != null && this.bh.ei && this.kt(this.bh)))
                        return [3 /*break*/, 21];
                    _k.label = 8;
                case 8:
                    _k.trys.push([8, 19, 20, 21]);
                    _c = __values(fromEnum(this.bh.fg())), _d = _c.next();
                    _k.label = 9;
                case 9:
                    if (!!_d.done)
                        return [3 /*break*/, 18];
                ...
                case 10:
                    ...
                    _e = (e_27 = void 0, __values(fromEnum(b.series))), _f = _e.next();
                    _k.label = 11;
                case 11:
                    if (!!_f.done)
                        return [3 /*break*/, 14];
    ...
    CategoryAxisBase.prototype.kw = function () {
        var _this = this;
        return toEnum(function () { return _this._kw(); });
    };
    CategoryAxisBase.prototype.ks = function (a) {
        return this.dd.contains(a);
    };
    CategoryAxisBase.prototype.kt = function (a) {
        return false;
    };
    CategoryAxisBase.prototype._kv = function () {
        var a, _a, _b, b, c, _c, _d, d, e_29_1, e_30_1;
        var e_30, _e, e_29, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    a = typeCast(XamDataChart.$, this.bh);
                    if (!(a != null && a.ei && this.kt(a)))
                        return [3 /*break*/, 14];
                    _g.label = 1;
                case 1:
                    _g.trys.push([1, 12, 13, 14]);
                    _a = __values(fromEnum(a.fg())), _b = _a.next();
                    _g.label = 2;
                case 2:
                    if (!!_b.done)
                        return [3 /*break*/, 11];
                ...
                case 3:
                    ...
                    _c = (e_29 = void 0, __values(fromEnum(c.axes))), _d = _c.next();
                    _g.label = 4;
                case 4:
                    if (!!_d.done)
                        return [3 /*break*/, 7];
    ...
    CategoryAxisBase.prototype.kv = function () {
        var _this = this;
        return toEnum(function () { return _this._kv(); });
    };
    CategoryAxisBase.prototype.l4 = function (a) {
        var e_31, _a, e_32, _b;
        if (this.kr) {
            return;
        }
        try {
            ...
            var d = false;
            try {
                for (var _c = __values(fromEnum(this.kw())), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var e = _d.value;
                    if (!e.dg && !e.ea && !e.dp) {
                        continue;
                    }
            ...
            var h = this.ku;
            try {
                for (var _e = __values(fromEnum(this.kv())), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var i = _f.value;
                    if (i.ku) {
                        h = true;
                    }
    ...
    CategoryAxisBase.prototype.hv = function (a, b, c, d) {
        ...
        switch (b) {
            ...
            case CategoryAxisBase.$$p[0]:
                ...
                if (this.kq != null) {
                    ...
                    this.hg();
                    try {
                        for (var _f = __values(fromEnum(this.da())), _g = _f.next(); !_g.done; _g = _f.next()) {
                            var h = _g.value;
                            h.kx(true, h.b0);
                            if (h.cd != null) {
                                h.lo();
            ...
            case CategoryAxisBase.$$p[1]:
                ...
                this.cp = true;
                try {
                    for (var _h = __values(fromEnum(this.da())), _j = _h.next(); !_j.done; _j = _h.next()) {
                        var i = _j.value;
                        i.ez = true;
    ...
    CategoryAxisBase.prototype.ls = function () {
        var e_36, _a;
        try {
    ...
    CategoryAxisBase.prototype.lu = function (a, b) {
        this.l1(b);
    };
    CategoryAxisBase.prototype.l1 = function (a) {
        switch (a.action) {
            case 3:
            case 0:
            case 1:
    ...
    CategoryAxisBase.prototype.cs = function (a) {
        var e_38, _a;
        var b = _super.prototype.cs.call(this, a);
        if (b) {
            this.l4(true);
    ...
    CategoryAxisBase.prototype.bz = function (a) {
        var e_39, _a;
        var b = _super.prototype.bz.call(this, a);
        if (b) {
            this.l4(true);
            var c = typeCast(IHasCategoryModePreference_$type, a);
    ...
    CategoryAxisBase.prototype.l2 = function () {
        var e_40, _a;
        var a = null;
        try {
            for (var _b = __values(fromEnum(this.da())), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    CategoryAxisBase.prototype.lr = function () {
        this.kp = this.kq;
    };
    CategoryAxisBase.prototype.l3 = function () {
        var a = this.ay;
        if (a == null) {
    ...
    CategoryAxisBase.prototype.lt = function (a) {
        if (this.kq != null) {
            this.kq.handleCollectionChanged(a);
        }
    };
    CategoryAxisBase.prototype.ly = function (a, b, c) {
        this.lt(new NotifyCollectionChangedEventArgs(2, 2, c, b, a));
    };
    CategoryAxisBase.prototype.lv = function () {
        this.lt(new NotifyCollectionChangedEventArgs(0, 4));
    };
    CategoryAxisBase.prototype.lw = function (a, b) {
        this.lt(new NotifyCollectionChangedEventArgs(1, 0, b, a));
    };
    CategoryAxisBase.prototype.lx = function (a, b) {
        this.lt(new NotifyCollectionChangedEventArgs(1, 1, b, a));
    };
    CategoryAxisBase.prototype.k4 = function (a, b, c, d) {
        return this.k5(a, b, c, d, this.categoryMode);
    };
    CategoryAxisBase.prototype.k5 = function (a, b, c, d, e) {
        var f = 0;
        var g = e;
    ...
    CategoryAxisBase.prototype.j$b = function (a, b) {
        return this.ei.apply(this, arguments);
    };
    CategoryAxisBase.prototype.j$d = function (a, b, c, d, e) {
        this.hl.apply(this, arguments);
    };
    CategoryAxisBase.prototype.j$e = function (a, b, c, d) {
        this.hm.apply(this, arguments);
    };
    CategoryAxisBase.prototype.j$f = function (a, b, c, d) {
        this.hn.apply(this, arguments);
    };
    Object.defineProperty(CategoryAxisBase.prototype, "j$a", {
        get: function () {
            return this.cg;
        },
        enumerable: false,
    ...
    CategoryAxisBase.l8 = DependencyProperty.i("ItemsSource", IEnumerable_$type, CategoryAxisBase.$, new PropertyMetadata(2, null, function (a, b) {
    ...
    CategoryAxisBase.$$p = markDep(DependencyProperty, PropertyMetadata, CategoryAxisBase, 'h1', ['FastItemsSource:kq:l6', [IFastItemsSource_$type], 'Gap:k0:l7', [1, 0.2], 'MaximumGap:k7:l9', [1, 1], 'MinimumGapSize:k8:ma', [1, 0], 'Overlap:k9:mb', [1, 0], 'UseClusteringMode:ku:mc', [0, false]]);
...
var HorizontalAxisLabelPanelBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    HorizontalAxisLabelPanelBase.prototype.a5 = function () {
        ...
        this.ao = false;
        this.dn(a, b, d);
        if (this.ad != null && this.ad.bh != null && (this.ad.bh.eu || this.ad.bh.et) && a != null) {
    ...
    HorizontalAxisLabelPanelBase.prototype.da = function () {
        if (this.ad != null && this.ad.bh != null && this.ad.bh.ev) {
            return false;
        }
        return true;
    };
    ...
    HorizontalAxisLabelPanelBase.prototype.c0 = function () {
        ...
        var e = this.bu();
        var f = 0;
        var g = this.ad.be == null ? 1 : this.ad.be.horizontalAlignment;
        if (g == 0) {
            f = this.c1.left;
        }
        else if (g == 2) {
    ...
    HorizontalAxisLabelPanelBase.prototype.a6 = function (a) {
        ...
        if (this.ad.ct || this.ad.cv) {
            ...
            for (var j = 0; j < h.count; j++) {
                ...
                var n = this.ad.bh.su.left;
                if (this.ad.cv) {
                    if (l.left < (this.ad.bh.su.left - n)) {
                        l = new Rect(0, l.left + ((this.ad.bh.su.left - n) - l.left), l.top, l.width, l.height);
                        a._inner[k] = l;
                    }
                }
            }
            ...
            for (var x = h.count - 1; x >= 0; x--) {
                ...
                var ab = this.ad.bh.cq.a5;
                if (this.ad.cv) {
                    if (aa.right > this.ad.bh.su.right + ab) {
                        z = new Rect(0, z.left - (aa.right - (this.ad.bh.su.right + ab)), z.top, z.width, z.height);
                        a._inner[y] = z;
                    }
                }
            }
...
var NumericAxisBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericAxisBase.prototype.a3 = function () {
        return new NumericAxisBaseView(this);
    };
    NumericAxisBase.prototype.hr = function (a) {
        _super.prototype.hr.call(this, a);
        this.kv = a;
    };
    NumericAxisBase.prototype.d0 = function (a, b) {
        var c = a < this.lv ? this.lv : a;
        c = a > this.lu ? this.lu : c;
        return c;
    };
    NumericAxisBase.prototype.get_ci = function () {
        return true;
    };
    Object.defineProperty(NumericAxisBase.prototype, "ks", {
        get: function () {
    ...
    Object.defineProperty(NumericAxisBase.prototype, "kt", {
        get: function () {
            return this.kr;
        },
        set: function (a) {
    ...
    Object.defineProperty(NumericAxisBase.prototype, "lv", {
        get: function () {
            return this.ln;
        },
        set: function (a) {
    ...
    NumericAxisBase.prototype.f1 = function () {
        return this.l3;
    };
    Object.defineProperty(NumericAxisBase.prototype, "ly", {
        get: function () {
            return this.lq;
        },
        set: function (a) {
    ...
    Object.defineProperty(NumericAxisBase.prototype, "lu", {
        get: function () {
            return this.lm;
        },
        set: function (a) {
    ...
    NumericAxisBase.prototype.f0 = function () {
        return this.lu;
    };
    Object.defineProperty(NumericAxisBase.prototype, "lx", {
        get: function () {
            return this.lp;
        },
        set: function (a) {
    ...
    Object.defineProperty(NumericAxisBase.prototype, "lt", {
        get: function () {
            return this.ll;
        },
        set: function (a) {
    ...
    NumericAxisBase.prototype.eu = function () {
        return this.lt;
    };
    Object.defineProperty(NumericAxisBase.prototype, "lw", {
        get: function () {
            return this.lo;
        },
        set: function (a) {
    ...
    NumericAxisBase.prototype.h8 = function (a) {
        _super.prototype.h8.call(this, a);
        if (this.lh && this.bh != null) {
            var b = this.j7();
            var c = this.j6();
            var d = this.kz(this.kc, this.bh.sf, b, c);
            if (d == null) {
                return;
            }
            var _loop_3 = function (e) {
                ...
                if (k - j < 2) {
                    if (typeCast(LogarithmicTickmarkValues.$, this_1.k2) !== null) {
                        this_1.k2 = new LinearTickmarkValues();
                    }
                }
                else {
                    this_1.k2 = this_1.k4 != null ? this_1.k4 : ((function () {
    ...
    NumericAxisBase.prototype.h0 = function (a) {
        _super.prototype.h0.call(this, a);
        this.l3 = a;
    };
    NumericAxisBase.prototype.hz = function (a) {
        _super.prototype.h0.call(this, a);
        this.l2 = a;
    };
    NumericAxisBase.prototype.hv = function (a, b, c, d) {
        _super.prototype.hv.call(this, a, b, c, d);
        switch (b) {
            ...
            case NumericAxisBase.$$p[10]:
                var e = new AxisRangeChangedEventArgs(0, this.lv, this.lv, this.lu, this.lu);
                this.h2(e);
                this.cp = true;
                this.h7(false);
                break;
    ...
    NumericAxisBase.prototype.mz = function () {
        var e_42, _a;
        try {
            for (var _b = __values(fromEnum(this.da())), _c = _b.next(); !_c.done; _c = _b.next()) {
                var a = _c.value;
    ...
    NumericAxisBase.prototype.kq = function () {
        var e_43, _a;
    ...
    NumericAxisBase.prototype.lk = function (a) {
        var e_44, _a;
        if (a == 1 || a == 2 || a == 3) {
            var b = this.kp;
            if (b == null) {
            ...
            if (this.bh == null || this.bh.su.isEmpty) {
                return false;
            }
            var c = -1;
            var d = -1;
            try {
                for (var _b = __values(fromEnum(this.da())), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var e = _c.value;
                    var f = e.ao(b, this, new Rect(0, 0, 0, 1, 1));
                    if (f.c != b.c) {
                        if (a == 1 || a == 2) {
    ...
    NumericAxisBase.prototype.ku = function () {
        if (this.kt == 0) {
            if (this.bh != null) {
                if (this.co) {
                    if (this.bh.bv == 2) {
    ...
    NumericAxisBase.prototype.mw = function (a, b, c, d, e, f, g) {
    ...
    NumericAxisBase.prototype.c2 = function () {
        var a = this.k9 && !isNaN_(this.l7) && !isInfinity(this.l7) && this.l7 > 1;
        var b;
        var c;
        var d = this.ku();
        var e = false;
        ...
        var f = this.mw(this, this.l3, this.l2, a, this.l7, b, c);
        b = f.p5;
        c = f.p6;
        if (b != this.lv || c != this.lu || this.li || e) {
            this.li = false;
            var g = new AxisRangeChangedEventArgs(0, this.lv, b, this.lu, c);
            this.lv = b;
            this.lu = c;
            if (!this.kc.isEmpty && d != 4) {
                if (this.lk(d)) {
                    var h = this.mw(this, this.l3, this.l2, a, this.l7, b, c);
                    b = h.p5;
                    c = h.p6;
    ...
    NumericAxisBase.prototype.mx = function () {
        this.ls = -1;
        this.lr = -1;
    };
    NumericAxisBase.prototype.m0 = function (a) {
    };
    NumericAxisBase.prototype.cs = function (a) {
        var b = _super.prototype.cs.call(this, a);
        if (b) {
            this.c0();
        }
    ...
    NumericAxisBase.prototype.bz = function (a) {
        var b = _super.prototype.bz.call(this, a);
        if (b) {
            this.c0();
        }
    ...
    NumericAxisBase.prototype.kx = function (a) {
        return new NumericAxisRenderer(a);
    };
    NumericAxisBase.prototype.kw = function () {
        var _this = this;
        var a = ((function () {
        ...
        b.d = function (c, d, e, f) { return _this.kz(c, d, e, f); };
        b.g = function (c, d) {
            _this.lf = d;
            var e = _this.fy(c);
            _this.lf = false;
    ...
    NumericAxisBase.prototype.my = function () {
    };
    NumericAxisBase.prototype.k1 = function () {
        return null;
    };
    NumericAxisBase.prototype.kz = function (a, b, c, d) {
        var e = this.k0();
        var f = this.a4.a1();
        var g = this.a4.a4();
        var h = this.a4.a2();
    ...
    NumericAxisBase.prototype.l6 = function (a) {
        var b = this.j7();
        var c = new ScalerParams(0, this.bh.sf, this.kc, this.cg, b);
        return this.el(a, c);
    };
    NumericAxisBase.prototype.lc = function () {
        return !isNaN_(this.lz);
    };
    Object.defineProperty(NumericAxisBase.prototype, "le", {
        get: function () {
    ...
    Object.defineProperty(NumericAxisBase.prototype, "ld", {
        get: function () {
    ...
    NumericAxisBase.prototype.m1 = function () {
        if (this.k4 != null) {
            this.k3 = this.k4;
        }
        else if (this.k9) {
    ...
    Object.defineProperty(NumericAxisBase.prototype, "k4", {
        get: function () {
    ...
    Object.defineProperty(NumericAxisBase.prototype, "k3", {
        get: function () {
            if (this.k2 == null) {
                this.m1();
            }
    ...
    Object.defineProperty(NumericAxisBase.prototype, "k8", {
        get: function () {
            return this.k5;
        },
        set: function (a) {
    ...
    NumericAxisBase.nc = DependencyProperty.i("AutoRangeBufferMode", AxisRangeBufferMode_$type, NumericAxisBase.$, new PropertyMetadata(2, enumGetBox(AxisRangeBufferMode_$type, 0), function (a, b) { return a.h1("AutoRangeBufferMode", b.oldValue, b.newValue); }));
    NumericAxisBase.ne = DependencyProperty.i("TickmarkValues", TickmarkValues.$, NumericAxisBase.$, new PropertyMetadata(1, function (a, b) { return a.h1("TickmarkValues", b.oldValue, b.newValue); }));
    NumericAxisBase.$$p = markDep(DependencyProperty, PropertyMetadata, NumericAxisBase, 'h1', ['AbbreviatedLabelFormat:l9:m2', [2, null], 'AbbreviatedLabelFormatSpecifiers:km:m3', [Array_$type, null], 'FavorLabellingScaleEnd:lb:m4', [0, false], 'FormatAbbreviatedLabel:ko:m5', [Delegate_$type], 'Interval:lz:m6', [1, NaN], 'IsLogarithmic:lg:m7', [0, false], 'LogarithmBase:l7:m8', [1, 10], 'MaximumValue:l2:m9', [1, NaN], 'MinimumValue:l3:na', [1, NaN], 'MinorInterval:l4:nb', [1, NaN], 'ReferenceValue:l5:nd', [1, 0]]);
...
var VerticalAxisLabelPanel = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    VerticalAxisLabelPanel.prototype.cm = function (a, b) {
        ...
        if (f != 0 && f != 360) {
            ...
            if (f > 0 && f < 180) {
                g.k = this.dh;
                h = -this.dh + this.dg / 2;
                h = h + Math.sin(MathUtil.n(f - 180)) * (this.dg / 2);
            }
            else {
                if (f >= 180) {
                    h = h - Math.cos(MathUtil.n(f)) * (this.dg / 2);
                }
                else {
                    h = h + Math.cos(MathUtil.n(f)) * (this.dg / 2);
                }
    ...
    VerticalAxisLabelPanel.prototype.c0 = function () {
        ...
        var e = this.bs();
        var f = 0;
        var g = this.ad.be == null ? 1 : this.ad.be.verticalAlignment;
        if (g == 0) {
            f = this.c1.top;
        }
        else if (g == 2) {
 ...
 * @hidden
 */
export var IHighlightingManager_$type = /*@__PURE__*/ new Type(null, 'IHighlightingManager');
/**
 * @hidden
 */
...
var XamDataChart = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function XamDataChart() {
        ...
        _this.tu = true;
        var a = _this.axes;
        a.collectionChanged = delegateCombine(a.collectionChanged, runOn(_this, _this.vz));
        var b = _this.axes;
        b.collectionResetting = delegateCombine(b.collectionResetting, runOn(_this, _this.v0));
        return _this;
    }
    Object.defineProperty(XamDataChart.prototype, "XSRP", {
        get: function () {
            if (this._xsr == null) {
                this._xsr = new SRProvider(this.cq.j.ae);
            }
            return this._xsr;
        },
        enumerable: false,
    ...
    Object.defineProperty(XamDataChart.prototype, "s8", {
        get: function () {
            var _this = this;
            if (this.s7 == null) {
                this.s7 = DVContainer.instance.createInstance(IDataChartVisualDataManager_$type, function () { return _this.XSRP.q; });
            }
            return this.s7;
        },
        enumerable: false,
    ...
    XamDataChart.staticInit = function () {
        XamDataChart.up = -1.7976931348623157E+308;
        XamDataChart.uo = 1.7976931348623157E+308;
    };
    XamDataChart.u1 = function (a) {
        if (a.cd == null) {
            return -1;
        }
        if (!a.dy) {
    ...
    XamDataChart.prototype.nh = function (a, b, c, d) {
    ...
    XamDataChart.prototype.nx = function () {
        _super.prototype.nx.call(this);
        if (this.s1 == 1 || this.s1 == 2) {
            this.v7();
        }
    };
    XamDataChart.prototype.l8 = function () {
        _super.prototype.l8.call(this);
        if (this.tk && this.s1 != 0) {
            if (!this.t1) {
                this.v7();
            }
        }
    };
    XamDataChart.prototype.lz = function (a, b) {
        _super.prototype.lz.call(this, a, b);
        if (this.tk && this.s1 == 2) {
    ...
    XamDataChart.prototype.l3 = function () {
        _super.prototype.l3.call(this);
        if (this.s4 == 1) {
            this.v3();
        }
    };
    XamDataChart.prototype.v8 = function () {
        this.v3();
    };
    XamDataChart.prototype.v3 = function () {
        var e_53, _a, e_54, _b;
        var a = this.w3();
        this.tj = false;
        if (!isNaN_(this.uv)) {
    ...
    XamDataChart.prototype.wa = function () {
        this.bt = this.ta();
        this.bv = this.td();
    };
    XamDataChart.prototype.td = function () {
        var e_55, _a;
        var a = 1;
        try {
            for (var _b = __values(fromEnum(this.series)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    XamDataChart.prototype.tc = function (a, b) {
        switch (a) {
            case 2: return 2;
            case 4:
                if (b == 2 || b == 3) {
    ...
    XamDataChart.prototype.ta = function () {
        var e_56, _a;
        var a = 1;
        try {
            for (var _b = __values(fromEnum(this.series)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    XamDataChart.prototype.s9 = function (a, b) {
        switch (a) {
            case 2: return 2;
            case 4:
                if (b == 2 || b == 3) {
    ...
    XamDataChart.prototype.w4 = function () {
    ...
    XamDataChart.prototype.w5 = function (a, b) {
    ...
    XamDataChart.prototype.get_d0 = function () {
        return this.s4 == 1;
    };
    XamDataChart.prototype.ga = function () {
        return this.uk;
    };
    XamDataChart.prototype.gb = function () {
        return this.ul;
    };
    XamDataChart.prototype.og = function () {
        _super.prototype.og.call(this);
        this.uk = this.sf.width;
        this.ul = this.sf.height;
    };
    Object.defineProperty(XamDataChart.prototype, "uk", {
        get: function () {
            return this.t8;
        },
        set: function (a) {
            var b = this.t8;
            this.t8 = a;
            this.nl("ActualWindowScaleHorizontal", b, this.t8);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(XamDataChart.prototype, "ul", {
        get: function () {
            return this.t9;
        },
        set: function (a) {
            var b = this.t9;
            this.t9 = a;
            this.nl("ActualWindowScaleVertical", b, this.t9);
        },
        enumerable: false,
        configurable: true
    });
    XamDataChart.prototype.em = function () {
        return this.tq;
    };
    XamDataChart.prototype.en = function () {
        return this.tt;
    };
    Object.defineProperty(XamDataChart.prototype, "tk", {
        get: function () {
            return this.tw || this.tz;
        },
        enumerable: false,
        configurable: true
    });
    XamDataChart.prototype.get_ev = function () {
        return this.tl;
    };
    Object.defineProperty(XamDataChart.prototype, "tl", {
        get: function () {
            return this.t0 || (this.eu && this.s1 != 0);
        },
        enumerable: false,
        configurable: true
    });
    XamDataChart.prototype.get_eu = function () {
        return this.tz;
    };
    XamDataChart.prototype.get_et = function () {
        return this.tw;
    };
    XamDataChart.prototype.v7 = function () {
        this.tr = false;
        this.tv = true;
        this.tu = true;
    ...
    XamDataChart.prototype.v6 = function () {
        this.tr = false;
        this.tu = true;
        for (var a = 0; a < this.axes.count; a++) {
            this.axes._inner[a].cp = true;
    ...
    XamDataChart.prototype.v5 = function (a, b, c, d) {
        if (a.ad == null) {
            return;
        }
        ...
        for (var f = 0; f < this.axes.count; f++) {
            var g = this.axes._inner[f].av.bh;
        ...
        this.e8 = true;
        this.gk = this.us + this.ua;
        this.gn = this.ut + this.ub;
        this.e8 = false;
        this.er = x;
        if (y) {
            if (q && (this.er || this.dm)) {
                this.v2();
            }
            return;
        }
    ...
    XamDataChart.prototype.uy = function (a, b, c, d) {
        var e = this.uq(-1, a, b, c, d);
        var f = a.bl();
        if (e < f) {
            ...
            var y = this.cq.a4;
            var z = this.cq.a5;
            var aa = new Thickness(1, this.us + w, 0, this.ut + x, 0);
            var ab = (aa.left - y) + (aa.right - z);
            var ac = a.ad.j6().width;
            var ad = ac - ab;
            var ae = ad / ac;
            var af = a.bn() * ae;
            var ag = this.uq(af, a, b, c, d);
            if (ag == e) {
                return e;
            }
            else {
    ...
    XamDataChart.prototype.uq = function (a, b, c, d, e) {
        var f = b.c3;
        var g = b.bn();
        if (a < 0) {
        }
    ...
    XamDataChart.prototype.v2 = function () {
        for (var a = 0; a < this.axes.count; a++) {
            this.axes._inner[a].cp = true;
            this.axes._inner[a].h7(false);
        }
        this.lb(true, false, false);
        this.tr = false;
    ...
    XamDataChart.prototype.vz = function (a, b) {
            ...
            try {
                for (var _d = __values(fromEn(b.oldItems)), _e = _d.next(); !_e.done; _e = _d.next()) {
                    ...
                    if (c != null) {
                        ...
                        this.n1(c);
                        this.cq.dw(c);
                        c.rangeChanged = delegateRemove(c.rangeChanged, runOn(this, this.v1));
                        this.cq.dx(c);
                        if (c.dd != null) {
                            try {
                                for (var _f = (e_58 = void 0, __values(fromEnum(c.da()))), _g = _f.next(); !_g.done; _g = _f.next()) {
                                    var d = _g.value;
                                    d.mh(false);
                                }
                            }
            ...
            try {
                for (var _h = __values(fromEn(b.newItems)), _j = _h.next(); !_j.done; _j = _h.next()) {
                    ...
                    if (e != null) {
                        ...
                        e.a4.az();
                        this.cq.bo(e);
                        e.rangeChanged = delegateCombine(e.rangeChanged, runOn(this, this.v1));
                        this.cq.bl(e);
                    }
                }
            }
    ...
    XamDataChart.prototype.v0 = function (a, b) {
        var e_60, _a, e_61, _b, e_62, _c, e_63, _d;
        var c = new List$1(Series.$, 0);
        try {
            for (var _e = __values(fromEnum(this.axes)), _f = _e.next(); !_f.done; _f = _e.next()) {
                ...
                if (d.dd != null) {
                    try {
                        for (var _g = (e_61 = void 0, __values(fromEnum(d.da()))), _h = _g.next(); !_h.done; _h = _g.next()) {
                            var e = _h.value;
                            if (!c.contains(e)) {
                                c.add(e);
                            }
                ...
                this.n1(d);
                this.cq.dw(d);
                d.rangeChanged = delegateRemove(d.rangeChanged, runOn(this, this.v1));
                this.cq.dx(d);
                this.n6();
            }
        }
    ...
    XamDataChart.prototype.v1 = function (a, b) {
        var e_64, _a, e_65, _b, e_66, _c;
        ...
        try {
            for (var _d = __values(fromEnum(c.da())), _e = _d.next(); !_e.done; _e = _d.next()) {
                var e = _e.value;
                e.ez = true;
                this.lw();
                e.mh(d);
        ...
        if (c.bh != null) {
            try {
                for (var _f = __values(fromEnum(c.bh.series)), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var f = _g.value;
                    XamDataChart.v4(c, d, f);
                }
            }
            catch (e_65_1) {
                e_65 = { error: e_65_1 };
    ...
    XamDataChart.v4 = function (a, b, c) {
    };
    XamDataChart.prototype.oq = function (a, b) {
        var e_67, _a;
        _super.prototype.oq.call(this, a, b);
        if (this.axes == null) {
            return;
        }
        try {
    ...
    XamDataChart.prototype.v9 = function () {
        var e_68, _a, e_69, _b;
        this.cq.ee();
        try {
            for (var _c = __values(fromEnum(this.axes)), _d = _c.next(); !_d.done; _d = _c.next()) {
    ...
    XamDataChart.prototype.k6 = function () {
        _super.prototype.k6.call(this);
    ...
    XamDataChart.prototype.e2 = function () {
        return true;
    };
    XamDataChart.prototype.ok = function () {
        var e_70, _a;
    ...
    XamDataChart.prototype.dz = function () {
        if (this.ts) {
            return true;
        }
        return this.to();
    };
    XamDataChart.prototype.to = function () {
        for (var a = 0; a < this.series.count; a++) {
            if (this.series._inner[a].ea || this.series._inner[a].d6) {
                return true;
            }
        }
        for (var b = 0; b < this.axes.count; b++) {
    ...
    XamDataChart.prototype.cp = function () {
        return new XamDataChartView(this);
    };
    XamDataChart.prototype.m5 = function (a) {
        _super.prototype.m5.call(this, a);
        this.tf = a;
    };
    XamDataChart.prototype.ny = function () {
        for (var a = 0; a < this.s2.count; a++) {
            this.s2._inner[a].cp = true;
            this.s2._inner[a].h7(false);
        }
        _super.prototype.ny.call(this);
    };
    Object.defineProperty(XamDataChart.prototype, "uh", {
        get: function () {
            return this.t5;
        },
        set: function (a) {
            ...
            if (this.t5 != b) {
                this.tj = true;
                this.nl(XamDataChart.u4, b, this.t5);
            }
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(XamDataChart.prototype, "uj", {
        get: function () {
            return this.t7;
        },
        set: function (a) {
            ...
            if (this.t7 != b) {
                this.tj = true;
                this.nl(XamDataChart.u6, b, this.t7);
            }
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(XamDataChart.prototype, "ui", {
        get: function () {
            return this.t6;
        },
        set: function (a) {
            ...
            if (this.t6 != b) {
                this.tj = true;
                this.nl(XamDataChart.u5, b, this.t6);
            }
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(XamDataChart.prototype, "ug", {
        get: function () {
            return this.t4;
        },
        set: function (a) {
            ...
            if (this.t4 != b) {
                this.tj = true;
                this.nl(XamDataChart.u3, b, this.t4);
            }
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(XamDataChart.prototype, "uv", {
        get: function () {
            return this.ud;
        },
        set: function (a) {
    ...
    Object.defineProperty(XamDataChart.prototype, "ux", {
        get: function () {
            return this.uf;
        },
        set: function (a) {
    ...
    Object.defineProperty(XamDataChart.prototype, "uw", {
        get: function () {
            return this.ue;
        },
        set: function (a) {
    ...
    Object.defineProperty(XamDataChart.prototype, "uu", {
        get: function () {
            return this.uc;
        },
        set: function (a) {
    ...
    XamDataChart.prototype.sh = function (a) {
        var b = _super.prototype.sh.call(this, a);
        if (a.isEmpty) {
            return Rect.empty;
        }
        if (this.uh == 0 && this.uj == 0 && this.ui == 0 && this.ug == 0) {
            return Rect.empty;
        }
        if (this.uh + this.ui >= a.width || this.uj + this.ug >= a.height) {
            return Rect.empty;
        }
        var c = new Rect(0, a.left + this.uh, a.top + this.uj, a.width - this.uh - this.ui, a.height - this.uj - this.ug);
        return c;
    };
    XamDataChart.prototype.sn = function () {
        var a = this.su;
        var b = this.sv;
        var c = this.sj;
    ...
    XamDataChart.prototype.u2 = function () {
        return this.s8.exportVisualData(this);
    };
    XamDataChart.prototype.vh = function () {
        var cvd_ = this.u2();
        cvd_.scaleByViewport();
        return (cvd_.serialize());
    };
    XamDataChart.prototype.ne = function () {
        _super.prototype.ne.call(this);
        for (var a = 0; a < this.axes.count; a++) {
    ...
    XamDataChart.prototype.n0 = function () {
    ...
    XamDataChart.prototype.t3 = function (a) {
        var e_71, _a;
    ...
    XamDataChart.up = 0;
    XamDataChart.uo = 0;
    XamDataChart.u4 = "ActualPlotAreaMarginLeft";
    XamDataChart.u6 = "ActualPlotAreaMarginTop";
    XamDataChart.u5 = "ActualPlotAreaMarginRight";
    XamDataChart.u3 = "ActualPlotAreaMarginBottom";
    XamDataChart.$$p = markDep(DependencyProperty, PropertyMetadata, XamDataChart, 'nl', ['AlignsGridLinesToPixels:tm:wb', [0, true], 'AutoExpandMarginExtraPadding:um:wc', [1, DeviceUtils.g(2)], 'AutoExpandMarginMaximumValue:un:wd', [1, 60], 'AutoMarginAndAngleUpdateMode:s1:we', [AutoMarginsAndAngleUpdateMode_$type, enumGetBox(AutoMarginsAndAngleUpdateMode_$type, 0)], 'ComputedPlotAreaMarginMode:s4:wf', [ComputedPlotAreaMarginMode_$type, enumGetBox(ComputedPlotAreaMarginMode_$type, 0)], 'DefaultAxisMajorStroke:w0:wg', [Brush.$, null], 'DefaultAxisMinorStroke:w1:wh', [Brush.$, null], 'DefaultAxisStroke:w2:wi', [Brush.$, null], 'GridMode:s6:wj', [GridMode_$type, enumGetBox(GridMode_$type, 2)], 'HorizontalZoomable:tp:wk', [0, false], 'InitialCloseGridlinesThreshold:ur:wl', [1, NaN], 'IsHorizontalZoomEnabled:tq:wm', [0, false], 'IsSquare:ts:wn', [0, false], 'IsVerticalZoomEnabled:tt:wo', [0, false], 'SeriesPlotAreaMarginHorizontalMode:tb:wp', [SeriesPlotAreaMarginHorizontalMode_$type, enumGetBox(SeriesPlotAreaMarginHorizontalMode_$type, 0)], 'SeriesPlotAreaMarginVerticalMode:te:wq', [SeriesPlotAreaMarginVerticalMode_$type, enumGetBox(SeriesPlotAreaMarginVerticalMode_$type, 0)], 'ShouldAutoExpandMarginForInitialLabels:tw:wr', [0, false], 'ShouldClipGridlines:tx:ws', [0, true], 'ShouldClipInitialCloseGridlines:ty:wt', [0, true], 'ShouldConsiderAutoRotationForInitialLabels:tz:wu', [0, false], 'ShouldSuppressAxisLabelTruncation:t0:wv', [0, false], 'SuppressAutoMarginAndAngleRecalculation:t1:ww', [0, false], 'VerticalZoomable:t2:wx', [0, false], 'WindowScaleHorizontal:uz:wy', [1, NaN], 'WindowScaleVertical:u0:wz', [1, NaN]]);
    return XamDataChart;
}(SeriesViewer));
export { XamDataChart };
/**
...
var ChartContentManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ChartContentManager.prototype._s = function () {
        var a, _a, _b, b, e_77_1, c, _c, _d, d, _e, _f, e, _g, _h, f, e_78_1, _j, _k, g, e_79_1;
        var e_77, _l, e_80, _m, e_81, _o, e_78, _p, e_79, _q;
...
var Series = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function Series() {
        ...
        _this.br = 1;
        _this.hr = null;
        _this.bg = new SeriesComponentsForView();
        _this.cu = false;
        _this.h2 = null;
        _this.g7 = null;
        _this._coercionMethods = null;
    ...
    Object.defineProperty(Series.prototype, "cn", {
        get: function () {
            if (this.cm == null) {
                this.cm = new SRProvider(this.g9);
            }
            if (this.cm.l == null) {
                if (this.g9 != null) {
                    this.cm.l = this.g9;
                }
                else if (this.cd != null && this.cd.cq != null && this.cd.cq.j != null && this.cd.cq.j.ae != null) {
                    this.cm.l = this.cd.cq.j.ae;
                }
            }
            return this.cm;
        },
    ...
    Object.defineProperty(Series.prototype, "a8", {
        get: function () {
            var _this = this;
            if (this.a7 == null) {
                this.a7 = DVContainer.instance.createInstance(ISeriesVisualDataManager_$type, function () { return _this.cn.q; });
            }
            return this.a7;
        },
        enumerable: false,
    ...
    Object.defineProperty(Series.prototype, "a6", {
        get: function () {
            var _this = this;
            if (this.a5 == null) {
                this.a5 = DVContainer.instance.createInstance(ISeriesInteractionManager_$type, function () { return _this.cn.n; });
    ...
    Object.defineProperty(Series.prototype, "dz", {
        get: function () {
            return DVContainer.instance.checkLoaded("InteractivityFactoryManager");
        },
        enumerable: false,
    ...
    Series.prototype.bx = function () {
        return new SeriesView(this);
    };
    Series.prototype.e6 = function () {
        return false;
    };
    Series.prototype.hw = function (a, b) {
        return null;
    };
    ...
    Series.prototype.onLegendItemEnter = function (a) {
        if (this.dx && this.dz && this.cd != null && (this.cd.a7 == 0 || this.cd.a7 == 2) && this.bk != 1) {
            this.a6.a$v(this, a, { $type: Point_$type, x: NaN, y: NaN }, false, true, false, a == null, this == this.cd.bk, false);
        }
    };
    Series.prototype.onLegendItemLeave = function (a) {
        if (this.dx && this.dz && this.cd != null && (this.cd.a7 == 0 || this.cd.a7 == 2) && this.bk != 1) {
            this.a6.a$v(this, a, { $type: Point_$type, x: NaN, y: NaN }, false, true, true, a == null, this == this.cd.bk, false);
        }
    };
    Series.prototype.jq = function (a) {
        if (!this.fb.containsKey(a)) {
            var b = a.substr(0, 1).toUpperCase() + a.substr(1);
            this.fb.addItem(a, b);
        }
        return this.fb.item(a);
    };
    Series.prototype.hx = function (a, b, c) {
        var d = null;
        if (!this.fa.containsKey(b)) {
            d = new FastReflectionHelper(false, c);
            this.fa.addItem(b, d);
        }
        else {
    ...
    Series.prototype.hf = function (a) {
        return -1;
    };
    Series.prototype.get_d9 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d9", {
        get: function () {
            return this.get_d9();
        },
        enumerable: false,
    ...
    Series.prototype.bw = function () {
        return 1;
    };
    Series.prototype.ht = function (a) {
        return null;
    };
    Series.prototype.hy = function (a, b) {
        return a.ht(b);
    };
    Series.prototype.ay = function (a, b, c, d) {
        return a.aw(b, c, d);
    };
    Series.prototype.az = function (a, b, c, d) {
        return a.ax(b, c, d);
    };
    Series.prototype.hc = function () {
        return -1;
    };
    Series.prototype.hg = function () {
        return -1;
    };
    Series.prototype.hl = function () {
        return -1;
    };
    ...
    Series.prototype.la = function (a) {
    };
    ...
    Series.prototype.get_dc = function () {
        return false;
    };
    ...
    Series.prototype.get_c9 = function () {
        return false;
    };
    ...
    Series.prototype.get_c8 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "c8", {
        get: function () {
            return this.get_c8();
        },
        enumerable: false,
    ...
    Series.prototype.get_db = function () {
        return false;
    };
    ...
    Series.prototype.get_da = function () {
        return true;
    };
    ...
    Series.prototype.get_du = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "du", {
        get: function () {
            return this.get_du();
        },
        enumerable: false,
    ...
    Series.prototype.get_de = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "de", {
        get: function () {
            return this.get_de();
        },
        enumerable: false,
    ...
    Series.prototype.get_dd = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dd", {
        get: function () {
            return this.get_dd();
        },
        enumerable: false,
    ...
    Series.prototype.get_c6 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "c6", {
        get: function () {
            return this.get_c6();
        },
        enumerable: false,
    ...
    Series.prototype.get_d1 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d1", {
        get: function () {
            return this.get_d1();
        },
        enumerable: false,
    ...
    Series.prototype.get_d0 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d0", {
        get: function () {
            return this.get_d0();
        },
        enumerable: false,
    ...
    Series.prototype.get_eg = function () {
        return false;
    };
    ...
    Series.prototype.get_dh = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dh", {
        get: function () {
            return this.get_dh();
        },
        enumerable: false,
    ...
    Series.prototype.get_df = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "df", {
        get: function () {
            return this.get_df();
        },
        enumerable: false,
    ...
    Series.prototype.get_d8 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d8", {
        get: function () {
            return this.get_d8();
        },
        enumerable: false,
    ...
    Series.prototype.get_d7 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d7", {
        get: function () {
            return this.get_d7();
        },
        enumerable: false,
    ...
    Series.prototype.get_d5 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d5", {
        get: function () {
            return this.get_d5();
        },
        enumerable: false,
    ...
    Series.prototype.get_d4 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d4", {
        get: function () {
            return this.get_d4();
        },
        enumerable: false,
    ...
    Series.prototype.get_eh = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "eh", {
        get: function () {
            return this.get_eh();
        },
        enumerable: false,
    ...
    Series.prototype.get_ee = function () {
        return false;
    };
    ...
    Series.prototype.get_d6 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d6", {
        get: function () {
            return this.get_d6();
        },
        enumerable: false,
    ...
    Series.prototype.get_ec = function () {
        return false;
    };
    ...
    Series.prototype.get_ea = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "ea", {
        get: function () {
            return this.get_ea();
        },
        enumerable: false,
    ...
    Series.prototype.get_dp = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dp", {
        get: function () {
            return this.get_dp();
        },
        enumerable: false,
    ...
    Series.prototype.get_eb = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "eb", {
        get: function () {
            return this.get_eb();
        },
        enumerable: false,
    ...
    Series.prototype.get_dg = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dg", {
        get: function () {
            return this.get_dg();
        },
        enumerable: false,
    ...
    Series.prototype.get_dv = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dv", {
        get: function () {
            return this.get_dv();
        },
        enumerable: false,
    ...
    Series.prototype.be = function () {
        return null;
    };
    Series.prototype.get_c4 = function () {
        return false;
    };
    ...
    Series.prototype.get_ds = function () {
        return false;
    };
    ...
    Series.prototype.get_dr = function () {
        return false;
    };
    ...
    Series.prototype.get_dq = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dq", {
        get: function () {
            return this.get_dq();
        },
        enumerable: false,
    ...
    Series.prototype.get_dt = function () {
        return false;
    };
    ...
    Series.prototype.get_dj = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dj", {
        get: function () {
            return this.get_dj();
        },
        enumerable: false,
    ...
    Series.prototype.get_dk = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dk", {
        get: function () {
            return this.get_dk();
        },
        enumerable: false,
    ...
    Series.prototype.f3 = function (a, b, c, d, e) {
        return Number.POSITIVE_INFINITY;
    };
    Series.prototype.f4 = function (a, b, c, d, e, f, g) {
    ...
    Series.prototype.gl = function (a, b, c, d, e, f, g, h) {
        return this.a6.a$m(this, a, b, c, d, e, f, g, h);
    };
    Series.prototype.f9 = function (a, b, c, d, e, f, g, h) {
        return this.a6.a$l(this, a, b, c, d, e, f, g, h);
    };
    Series.prototype.hk = function (a, b, c, d, e) {
        return this.a6.a$o(this, a, b, c, d, e);
    };
    Series.prototype.f8 = function (a) {
        return (a ? 10 : 3);
    };
    Series.prototype.ah = function (a) {
        return null;
    };
    Series.prototype.ai = function (a) {
        return null;
    };
    Series.prototype.eu = function (a, b) {
        return this.a6.a$d(this, a, b);
    };
    Series.prototype.aj = function (a, b, c, d, e, f) {
        return this.a6.a$a(this, a, b, c, d, e, f);
    };
    Series.prototype.ew = function (a, b, c) {
        return this.a6.a$e(this, a, b, c);
    };
    Series.prototype.ex = function (a, b) {
        return this.a6.a$f(this, a, b);
    };
    Series.prototype.hi = function (a, b, c, d, e) {
        return this.a6.a$n(this, a, b, c, d, e);
    };
    Series.prototype.f7 = function (a, b) {
        return this.a6.a$k(this, a, b);
    };
    Series.prototype.hj = function (a, b) {
        return -1;
    };
    Series.prototype.hh = function (a, b) {
        return -1;
    };
    ...
    Series.prototype.go = function (a) {
        var b = this.i0();
        if (b == null) {
            return NaN;
        }
        ...
        return FastItemColumn.i(this.hw(a.content.item, b));
    };
    Series.prototype.i0 = function () {
        return null;
    };
    ...
    Series.prototype.pg = function (a) {
        ...
        var e = b.top + (a.y - c.top) / c.height * b.height;
        return { $type: Point_$type, x: d, y: e };
    };
    Series.prototype.hz = function (a, b) {
        var c = this.b0.c(a);
    ...
    Series.prototype.en = function (a) {
        return false;
    };
    ...
    Series.prototype.ao = function (a, b, c) {
        this.k6();
        if (!this.isVertical) {
            if (this.fv == 0 && this.fy == 0) {
                return a;
            }
            var d = new ScalerParams(0, c, this.cd.su, b.cg, this.getEffectiveViewport());
            d.b = this.gc();
            var e = b.ei(a.c, d);
            var f = b.ei(a.b, d);
            if (b.cg) {
            ...
            if (this.fw == 0 && this.fx == 0) {
                return a;
            }
            var i = new ScalerParams(0, c, this.cd.su, b.cg, this.getEffectiveViewport());
            i.b = this.gc();
            var j = b.ei(a.c, i);
            var k = b.ei(a.b, i);
            if (!b.cg) {
    ...
    Series.prototype.kt = function () {
        if (this.e0 && !this.e2) {
            this.ce.r = truncate(Math.max(this.gm(), this.gn()));
            this.ky();
        }
    };
    ...
    Series.prototype.getEffectiveViewport1 = function (a) {
        ...
        if (a.q) {
            if (this.cd.sj.isEmpty) {
                return this.cd.sj;
            }
            var b = this.cd.so(a.bu, this.cd.su, this.cd.sj);
            return b;
        }
        return this.cd.sj;
    };
    Series.prototype.pq = function (a) {
        ...
        if (a.q) {
            ...
            if (this.cd.si.equals1(this.cd.su)) {
                return a.bu;
            }
            var b = this.cd.so(a.bu, this.cd.su, this.cd.sj);
            var c = this.cd.sm(a.bu, b, this.cd.sf);
            return c;
        }
        return this.cd.si;
    };
    ...
    Object.defineProperty(Series.prototype, "c2", {
        get: function () {
            return this.get_c2();
        },
        enumerable: false,
    ...
    Series.prototype.get_c5 = function () {
        return this.bk == 2 || this.bk == 4;
    };
    Object.defineProperty(Series.prototype, "c5", {
        get: function () {
            return this.get_c5();
        },
        enumerable: false,
    ...
    Series.prototype.e9 = function (a, b, c) {
    ...
    Series.prototype.cw = function () {
        return this.cx(this.b0);
    };
    Series.prototype.cx = function (a) {
        var b = a.bu;
        var c = a.bv;
        if (!this.e9(b, c, a)) {
            this.kx(true, a);
    ...
    Series.prototype.get_dy = function () {
        return true;
    };
    Object.defineProperty(Series.prototype, "dy", {
        get: function () {
            return this.get_dy();
        },
        enumerable: false,
    ...
    Series.prototype.l2 = function (a) {
        ...
        var b = this.b0.bu;
        var c = this.b0.bv;
        var d = this.e9(b, c, this.b0);
        var e = this.cd != null && this.cd.ej && this.bz != null && this.e9(this.bz.bu, this.bz.bv, this.bz);
        if (d) {
            if (a) {
                this.es = !this.em();
                this.k3(false);
        ...
        switch (b) {
            ...
            case "SeriesViewer":
                if (typeCast(SeriesViewer.$, c) !== null) {
                    ...
                    var h = c.series;
                    h.collectionChanged = delegateRemove(h.collectionChanged, this.fg);
                    var i = c;
                ...
                if (typeCast(SeriesViewer.$, d) !== null) {
                    ...
                    var k = d.series;
                    k.collectionChanged = delegateCombine(k.collectionChanged, this.fg);
                    var l = d;
                ...
                this.a1 = this.a2();
                this.kr(typeCast(SeriesViewer.$, c), typeCast(SeriesViewer.$, d));
                break;
            case Series.$$p[35]:
                if (this.b0 != null) {
                    this.b0.ay();
            ...
            case Series.$$p[13]:
                ...
                if (typeCast(IFastItemsSource_$type, d) != null) {
                    var n = d;
                    n.event = delegateCombine(n.event, this.g5);
                }
                break;
            case "Legend":
                if (d != null) {
            ...
            case "ActualLegend":
                ...
                this.kq(typeCast(IChartLegend_$type, c), typeCast(IChartLegend_$type, d));
                break;
            case "LegendItem":
                this.ks(typeCast(Control.$, c), typeCast(Control.$, d));
                break;
            case Series.$$p[21]:
                this.b0.at();
                break;
            ...
            case "CrosshairPoint":
                ...
                if (this.cd != null) {
                    if (!this.cy) {
                        this.cd.no(this, this.ht(this.cd.r6));
                    }
                }
                break;
            case Series.$$p[27]:
    ...
    Series.prototype.m2 = function (a) {
        if (this.cd != null && this.cd.ed && this.bk != 1 && this.cd.ea) {
            if (isNaN_(a.x) || isNaN_(a.y)) {
                ...
                this.a6.a$v(this, this.ht(a), a, false, false, false, false, this.cd.bk == this, false);
            }
        }
    };
    Series.prototype.k5 = function () {
    ...
    Series.prototype.get_dx = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "dx", {
        get: function () {
            return this.get_dx();
        },
        enumerable: false,
    ...
    Object.defineProperty(Series.prototype, "b8", {
        get: function () {
            return this.b7;
        },
        set: function (a) {
    ...
    Object.defineProperty(Series.prototype, "cd", {
        get: function () {
            return this.cc;
        },
        set: function (a) {
    ...
    Series.prototype.k0 = function (a, b, c, d) {
        if (this.cd != null) {
            this.cd.np();
        }
    };
    ...
    Object.defineProperty(Series.prototype, "a1", {
        get: function () {
            return this.a0;
        },
        set: function (a) {
    ...
    Object.defineProperty(Series.prototype, "ft", {
        ...
        set: function (a) {
            ...
            this.fj = a;
            if (b != this.fj) {
                this.raisePropertyChanged("ActualResolution", b, this.fj);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(Series.prototype, "bk", {
        get: function () {
            return this.bj;
        },
        set: function (a) {
    ...
    Series.prototype.bl = function () {
        ...
        if (this.cd != null) {
            if (this.cd.br != 1 && this.cd.br != 0 && !this.di) {
                return this.cd.br;
            }
        }
        if (this.dw) {
    ...
    Series.prototype.ef = function (a) {
        switch (a) {
            case 2:
            case 4: return true;
        }
    ...
    Object.defineProperty(Series.prototype, "fr", {
        ...
        set: function (a) {
            ...
            this.fi = a;
            if (b != this.fi) {
                this.raisePropertyChanged("ActualHighlightingFadeOpacity", b, this.fi);
            }
        },
        enumerable: false,
        configurable: true
    });
    Series.prototype.get_dn = function () {
        return true;
    };
    Object.defineProperty(Series.prototype, "dn", {
        get: function () {
            return this.get_dn();
        },
        enumerable: false,
    ...
    Object.defineProperty(Series.prototype, "dl", {
        get: function () {
            return this.cq;
        },
        set: function (a) {
    ...
    Object.defineProperty(Series.prototype, "bs", {
        get: function () {
            return this.br;
        },
        set: function (a) {
    ...
    Series.fe = function (a, b, c) {
        return toEnum(function () { return Series._fe(a, b, c); });
    };
    Series.fd = function (a, b) {
        return Series.fe(a, 0, b);
    };
    ...
    Series.prototype.set_e3 = function (a) {
        this.cu = a;
    };
    ...
    Series.prototype.aw = function (a, b, c) {
        return null;
    };
    ...
    Series.prototype.eq = function () {
        return false;
    };
    Series.prototype.eo = function (a) {
        return (a && this.gm() > 0) || this.cv() || (this.e2 && this.eq() && this.gn() > 0);
    };
    ...
    Series.prototype.at = function (a, b) {
        return null;
    };
    Object.defineProperty(Series.prototype, "bq", {
        get: function () {
            return this.bn;
        },
        set: function (a) {
    ...
    Object.defineProperty(Series.prototype, "bo", {
        get: function () {
            return this.bm;
        },
        set: function (a) {
    ...
    Series.prototype.ch = function (a) {
        if (a == null) {
            return this.ck.registerColumn(null, null, false);
        }
        var b = null;
        var c = SeriesViewer.cc(a, this.coercionMethods);
        b = c.a;
        return this.ck.registerColumn(a, b, this.expectFunctions);
    };
    Series.prototype.ci = function (a) {
        if (a == null) {
    ...
    Series.prototype.cj = function (a) {
        if (a == null) {
    ...
    Series.prototype.get_d3 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d3", {
        get: function () {
            return this.get_d3();
        },
        enumerable: false,
    ...
    Series.prototype.get_d2 = function () {
        return false;
    };
    Object.defineProperty(Series.prototype, "d2", {
        get: function () {
            return this.get_d2();
        },
        enumerable: false,
    ...
    Series.prototype.ag = function () {
        return null;
    };
    Series.prototype.gc = function () {
        return NaN;
    };
    Series.gd = function (a, b) {
        if (a == null || a.count == 0) {
            return NaN;
        }
    ...
    Object.defineProperty(Series.prototype, "f1", {
        ...
        set: function (a) {
            ...
            if (a != b) {
                this.fo = a;
                this.raisePropertyChanged("FinalValue", b, this.f1);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Series.prototype.hv = function (a) {
        return null;
    };
    ...
    Object.defineProperty(Series.prototype, "h5", {
        get: function () {
    ...
    Object.defineProperty(Series.prototype, "h6", {
        get: function () {
    ...
    Series.prototype.ba = function (a) {
        return a;
    };
    Series.prototype.bb = function () {
        if (this.dd || this.df || this.dh || this.d7 || this.ee || this.ds || this.dq || this.dr || this.ei || this.ek) {
            return this.ba(3);
        }
        else if (this.d1 || this.eg || this.d8 || this.d0 || this.isValueOverlay) {
            return this.ba(2);
        }
        else if (this.dc || this.d5 || this.d4) {
            return this.ba(1);
        }
        else if (this.c4) {
            return this.ba(4);
    ...
    Series.prototype.iy = function () {
        return null;
    };
    Series.prototype.iz = function (a, b) {
        if (b == a.cd.ov) {
            return "Circle";
        }
        else if (b == a.cd.ow) {
    ...
    Series.prototype.gb = function (a, b) {
        return FastItemColumn.i(this.hw(a, b));
    };
    ...
    Series.prototype.fh = function (ticks_) {
...
var MarkerSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    MarkerSeries.prototype.k7 = function (a) {
...
var SyncLink = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SyncLink.prototype.releaseFastItemsSource = function (a) {
        ...
        if (a != null) {
            var b_1 = null;
            if (((function () { var c = _this.ah.tryGetValue(a, b_1); b_1 = c.p1; return c.ret; })())) {
                --b_1.b;
                if (b_1.b == 0) {
        ...
        if (!c.isEmpty) {
            ...
            if (b == a) {
                if (!d) {
                    ...
                    if (!b.en()) {
                        c.y = b.sv.y;
                        c.height = b.sv.height;
                    }
                }
            }
            else {
                var f = SyncManager.a(b);
            ...
            var g = 0.5 * (c.left + c.right);
            var h = 0.5 * (c.top + c.bottom);
            var i = c.width;
            var j = c.height;
            var k = MathUtil.c(c.width, e, 1);
            var l = MathUtil.c(c.height, e, 1);
            var m = false;
            if (a.fa() && !a.su.isEmpty) {
                var n = a.su;
                ...
                var s = false;
                var t = false;
                if (Math.abs(k - a.sf.width) > e) {
                    s = true;
                }
                if (Math.abs(l - a.sf.height) > e) {
                    t = true;
                }
                var u = a.ll(k, l, s, t);
                k = u.p0;
                ...
                var af = new Rect(0, z, ab, aa - z, ac - ab);
                var ag = [v, w];
                var ah = [x, y];
                for (var ai = 0; ai < b.series.count; ai++) {
                    var aj = b.series._inner[ai];
                    if (aj.dc) {
                        continue;
                    }
                    {
                ...
                var al = (v == 1.7976931348623157E+308 || w == -1.7976931348623157E+308 || isNaN_(v) || isNaN_(w));
                var am = (x == 1.7976931348623157E+308 || y == -1.7976931348623157E+308 || isNaN_(x) || isNaN_(y));
                if (!al || !am) {
                    if (al) {
                        c = new Rect(0, x, c.top, y - x, c.height);
                    }
                    else if (am) {
                        c = new Rect(0, c.left, v, c.width, w - v);
                    }
                    else {
                        c = new Rect(0, x, v, y - x, w - v);
                    }
                    k = c.width;
                    l = c.height;
                    m = true;
            ...
            var an = k != i;
            var ao = l != j;
            var ap = an && !m ? g - 0.5 * k : c.left;
            var aq = ao && !m ? h - 0.5 * l : c.top;
            var ar = an && !m ? g + 0.5 * k : c.right;
            var as = ao && !m ? h + 0.5 * l : c.bottom;
            if (b.b9 == 1) {
                if (ap < 0) {
                    ap = 0;
                    ar = ap + k;
            ...
            c = new Rect(0, ap, aq, ar - ap, as - aq);
        }
        return c;
    };
    SyncLink.prototype.ab = function (a, b, c, d) {
        ...
        if (h != null) {
            ...
            var k = new ScalerParams(0, j, j, h.cg, b.so(j, b.su, b.sj));
            k.b = a.gc();
            var l = a.aq(c);
    ...
    SyncLink.prototype.an = function (a, b) {
        ...
        try {
            for (var _b = __values(fromEnum(this.ai)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
                if (c == a) {
                    c.r6 = { $type: Point_$type, x: b.x, y: b.y };
                }
                else {
...
var SyncManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SyncManager.c = function (a) {
        ...
        if (a.ei && a.syncChannel == b.syncChannel) {
            return;
        }
        var c = null;
        if (a.ei) {
...
var DataChartMouseButtonEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function DataChartMouseButtonEventArgs(a, b, c, d) {
        var _this = _super.call(this) || this;
        _this.g = null;
        _this._item = null;
        _this._series = null;
...
var ChartMouseEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function ChartMouseEventArgs(a, b, c, d) {
        var _this = _super.call(this) || this;
        _this.f = null;
        _this._item = null;
        _this._series = null;
...
var AxisLabelPanelBaseView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AxisLabelPanelBaseView.prototype.ao = function () {
        ...
        if (this.e.d) {
            if (this.a.ad.bh != null && this.a.ad.bh.f4 != 1) {
                this.e.z();
                this.e.aa(this.a.ad.bh.f4, this.a.ad.bh.f4);
            }
            this.ag();
            this.av = this.a.c1;
            var a = this.a.ad.bf.getFontBrush();
    ...
    AxisLabelPanelBaseView.prototype.d = function () {
        var a = this.a.ad.bh.getFontInfo();
        if (this.a.ad.be != null && this.a.ad.be.textStyle != null) {
            a = this.a.ad.be.h(this.a.ad.bh.cq.j.ae);
        }
        else {
            var b = this.a.ad.bh.ct();
            if (b != null) {
                a = b;
            }
        }
    ...
    AxisLabelPanelBaseView.prototype.ag = function () {
        ...
        if (this.a.ag != null && this.a.ag.j) {
            a = this.a.ag.h(this.a.ad.bh.cq.j.ae);
        }
        if (this.c != a) {
            this.c = a;
            this.as();
    ...
    AxisLabelPanelBaseView.prototype.as = function () {
        if (this.a.ad != null && this.a.ad.bh != null) {
            ...
            var a = this.h;
            var b = this.a.ad.bh.getFontInfo();
            if (this.a.ag != null && this.a.ag.textStyle != null) {
                b = this.a.ag.h(this.a.ad.bh.cq.j.ae);
            }
            var c = FontUtil.getCurrentFontHeight(this.a.ad.bh.cq.j.ae, b);
            this.h = c;
            if (a != this.h) {
                this.a.ad.bh.lj();
            }
    ...
    AxisLabelPanelBaseView.prototype.j = function () {
        ...
        this.i = FontUtil.getCurrentFontHeight(this.a.ad.bh.cq.j.ae, a);
        return this.i;
    };
    ...
    AxisLabelPanelBaseView.prototype.aq = function () {
        ...
        if (this.a.ad.jz == null) {
            this.aw._stroke = this.a.ad.bf.rk();
        }
        else {
...
var AxisView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AxisView.prototype.a0 = function () {
        var a = new TextBlock();
        return a;
    };
    ...
    Object.defineProperty(AxisView.prototype, "index", {
        get: function () {
            if (this.a.bh != null && this.a.bh.ef) {
                return this.a.bh.series.count + 1;
            }
            var a = typeCast(XamDataChart.$, this.a.bf);
            var b = 0;
            if (a == null) {
                return 0;
            }
            if (a != null && a.s6 == 1) {
                var c = 0;
                for (var d = 0; d < this.a.bh.series.count; d++) {
                    if (this.a.bh.series._inner[d].isStacked) {
                        c += this.a.bh.series._inner[d].hl();
                    }
                    else {
                        c++;
                    }
    ...
    AxisView.prototype.ae = function () {
        this.d.ca();
    };
    ...
    AxisView.prototype.ac = function (a) {
        if (a != null) {
            a.clear();
        }
    };
    AxisView.prototype.a1 = function () {
        return this.ba.ak.d;
    };
    ...
    AxisView.prototype.aw = function (a, b, c) {
        this.d.ad = a;
        this.d.c5 = b;
        this.d.c4 = c;
        this.ah();
    };
    AxisView.prototype.ab = function () {
        this.d.ab.clear();
        this.ah();
    };
    AxisView.prototype.as = function (a) {
        this.d.bw = a;
        this.ah();
    };
    AxisView.prototype.ax = function (a, b) {
        this.d.a9 = a;
        this.d.ba = b;
        this.d.ar = false;
    };
    ...
    AxisView.prototype.y = function () {
    };
    AxisView.prototype.r = function (a) {
        return null;
    };
    ...
    AxisView.prototype.ai = function (a, b) {
        this.j = a;
        this.k = b;
    };
    ...
    AxisView.prototype.ao = function (a) {
        if (this.j == null) {
            return;
        }
        if (this.j.d) {
            if (this.a.bh != null && this.a.bh.f4 != 1) {
                this.j.z();
                this.j.aa(this.a.bh.f4, this.a.bh.f4);
            }
            var b = this.a.bf.sk();
            if (a) {
        ...
        if (this.k.d) {
            if (this.a.bh != null && this.a.bh.f4 != 1) {
                this.k.z();
                this.k.aa(this.a.bh.f4, this.a.bh.f4);
            }
            var c = this.a8;
            var d = this.a.bf.sk();
            if (!c.isEmpty && a) {
    ...
    AxisView.prototype.ad = function (a) {
        if (a != null) {
            a.al.r(this);
            a.cq.cq();
        }
    ...
    AxisView.prototype.i = function () {
        if (this.a.bh == null || this.a.bh.cq.j.ae == null) {
            return null;
        }
        return FontUtil.getFont(this.a.bh.cq.j.ae);
    };
    ...
    AxisView.prototype.v = function (a, b) {
        this.a.fk.startCSSQuery();
        var c = this.a.fk.getCssDefaultPropertyValue(b, "margin-top");
        var d = this.a.fk.getCssDefaultPropertyValue(b, "margin-right");
        var e = this.a.fk.getCssDefaultPropertyValue(b, "margin-bottom");
        var f = this.a.fk.getCssDefaultPropertyValue(b, "margin-left");
        var g = this.a.fk.getCssDefaultPropertyValue(b, "text-align");
        var h = this.a.fk.getCssDefaultPropertyValue(b, "vertical-align");
        var i = this.a.fk.getCssDefaultPropertyValue(b, "color");
        var j = FontUtil.getFontForClass(this.a.fk, b);
    ...
    AxisView.prototype.a5 = function (a) {
    ...
    AxisView.prototype.bg = function (a) {
        var b = this.a.av.af.t();
        var c = this.a.av.af.v();
        var d = this.a.av.af.u();
        var e = this.a.av.af.s();
        return new Thickness(1, b, c, d, e);
    };
    AxisView.prototype.ak = function () {
...
var CategoryAxisBaseView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryAxisBaseView.prototype.r = function (a) {
        var b = 0;
    ...
    CategoryAxisBaseView.prototype.bi = function (a) {
        var b = 0;
        var c = false;
        for (var d = 0; d < a.count; d++) {
...
var NumericAxisBaseView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericAxisBaseView.prototype.bi = function () {
    };
    NumericAxisBaseView.prototype.n = function () {
        return this.bh.lf;
    };
    NumericAxisBaseView.prototype.l = function () {
        if (this.bh.ko != null) {
            return true;
        }
        if (this.bh.kn != null) {
    ...
    NumericAxisBaseView.prototype.q = function (dataItem_) {
        if (this.bh.ko != null) {
    ...
    NumericAxisBaseView.prototype.r = function (a) {
        var b = this.bh.ky.d(this.bh.kc, this.bh.bh.sf, this.bh.j7(), this.bh.j6());
...
var XamDataChartView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    XamDataChartView.prototype.d4 = function () {
        ...
        this.fn.w2 = f.i;
        this.fn.w0 = AxisDefaults.h;
        this.fn.w1 = AxisDefaults.i;
        this.fn.tm = e;
        this.fv = a;
        this.fu = b;
        this.fn.ag = f.a;
    ...
    XamDataChartView.prototype.d1 = function () {
        ...
        this.fe._stroke = this.p.r2 != null ? this.p.r2 : this.ft;
        this.fd._stroke = this.p.rt != null ? this.p.rt : this.ft;
...
var SeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SeriesView.prototype.j = function () {
        return new DOMExecutionContext(this.e.cd.cq.j.ae);
    };
    ...
    SeriesView.prototype.get_index = function () {
        ...
        if (this.e.cd.ef) {
            if (this.e.dv) {
                ...
                var a = this.e.cd.series.indexOf(this.e);
                if (a >= 0) {
                    return a;
                }
                for (var b = 0; b < this.e.cd.series.count; b++) {
                    if (this.e.cd.series._inner[b].dv) {
                        var c = this.e.cd.series._inner[b].be();
                        if (c == this.e) {
                            return b;
                        }
                    }
        ...
        var d = typeCast(XamDataChart.$, this.e.cb);
        var e = 0;
        if (d != null) {
            if (d.s6 == 2 || d.s6 == 0) {
                e = d.axes.count;
    ...
    SeriesView.prototype.bd = function (a, b, c) {
        if (c) {
            this.bf(a, b);
        }
        else {
    ...
    SeriesView.prototype.bg = function (a, b, c) {
        if (c) {
            this.bi(a, b);
        }
        else {
    ...
    SeriesView.prototype.be = function (a, b) {
    };
    SeriesView.prototype.bh = function (a, b) {
    };
    SeriesView.prototype.bf = function (a, b) {
    };
    SeriesView.prototype.bi = function (a, b) {
    };
    SeriesView.prototype.ba = function (a) {
        if (a) {
            this.bc();
        }
        else {
    ...
    SeriesView.prototype.bp = function (a) {
        return this.bo();
    };
    SeriesView.prototype.bo = function () {
        var a = this.e.ho;
        var num_ = (a + 1) * 1000;
        var b = ((num_ & 0x3F) << 2);
        num_ = (num_ >> 6);
    ...
    SeriesView.prototype.a6 = function (a, b) {
        this.br = this.bu;
    };
    SeriesView.prototype.a5 = function (a, b) {
    };
    SeriesView.prototype.ax = function () {
    };
    SeriesView.prototype.am = function () {
    };
    ...
    SeriesView.prototype.a9 = function (a) {
    };
    ...
    SeriesView.prototype.ar = function (a, b) {
        this.k = a;
        this.l = b;
    };
    Object.defineProperty(SeriesView.prototype, "bu", {
        get: function () {
            return this.bs;
        },
        set: function (a) {
    ...
    SeriesView.prototype.get_bv = function () {
        if (this.p) {
            return this.bt;
        }
        else if (this.q) {
            return XamDataChart.sr;
        }
        else {
            return this.e.cd != null ? this.e.cd.sf : Rect.empty;
        }
    };
    Object.defineProperty(SeriesView.prototype, "bv", {
        get: function () {
            return this.get_bv();
        },
        enumerable: false,
    ...
    SeriesView.prototype.ag = function (a) {
        ...
        if (a != null) {
            if (this.e.e5) {
                this.k = this.e.cd.cq.z;
                a.cq.a.l(this);
                this.a = a.cq.a;
            }
            else {
                this.k = this.e.cd.cq.y;
                a.al.l(this);
                this.a = a.al;
            }
            if (this.e.bz != null) {
            ...
            if (this.e.dz) {
                try {
                    for (var _b = __values(fromEnum(this.e.a6.a$h.keys)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var b = _c.value;
    ...
    SeriesView.prototype.a2 = function (a) {
        this.e.bz.k = a.a;
    };
    SeriesView.prototype.al = function (a) {
    };
    SeriesView.prototype.bj = function () {
        if (this.n) {
            return;
        }
        if (this.e.cd != null) {
    ...
    SeriesView.prototype.at = function () {
        this.e.kq(this.e.a1, this.e.a1);
    };
    ...
    SeriesView.prototype.a3 = function () {
    ...
    SeriesView.prototype.a1 = function (a) {
        this.k = a.a;
    };
    SeriesView.prototype.bl = function (type_) {
...
var MarkerSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function MarkerSeriesView(a) {
        ...
        _this.co = null;
        _this.bx = new Marker();
        _this.bx.content = new DataContext();
        _this.b1 = a;
        return _this;
    }
    MarkerSeriesView.prototype.as = function () {
    ...
    MarkerSeriesView.prototype.cg = function () {
        var e_95, _a;
        try {
            for (var _b = __values(fromEnum(this.b4)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var a = _c.value;
                a.ah = this.b1.qx;
            }
        }
    ...
    MarkerSeriesView.prototype.b0 = function () {
        var _this = this;
        var a = new Marker();
        a.content = ((function () {
            var $ret = new DataContext();
    ...
    MarkerSeriesView.prototype.cj = function (a) {
        a._visibility = 0;
    };
    MarkerSeriesView.prototype.cl = function (a) {
        a._visibility = 1;
    };
    ...
    MarkerSeriesView.prototype.bh = function (a, b) {
    ...
    MarkerSeriesView.prototype.a5 = function (a, b) {
    ...
    MarkerSeriesView.prototype.ch = function (a) {
        a.create = runOn(this, this.b0);
        a.destroy = runOn(this, this.ck);
        a.activate = runOn(this, this.cj);
        a.disactivate = runOn(this, this.cl);
    };
    MarkerSeriesView.prototype.ci = function (a) {
        a.create = runOn(this, this.b0);
        a.destroy = runOn(this, this.ck);
        a.activate = runOn(this, this.cj);
        a.disactivate = runOn(this, this.cl);
    };
    MarkerSeriesView.prototype.by = function (a) {
        var b = this.bz(a, 0);
        if (b == null) {
            b = this.bz(a, 3);
        }
    ...
    MarkerSeriesView.prototype.bz = function (a, b) {
        var c;
        var d;
        var e;
        var f;
        for (var g = this.b4.count - 1; g >= 0; g--) {
            var h = this.b4._inner[g];
