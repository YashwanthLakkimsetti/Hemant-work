...
var SeriesInteractionManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SeriesInteractionManager.prototype.a$m = function (a, b, c, d, e, f, g, h, i) {
        ...
        var j = a.e8;
        var k = a.hk(c, i, d, g, b);
        var l = a.hi(c, i, d, g, b);
        var m = a.f3(c, k, d, e, f);
        var n = a.f3(c, l, d, e, f);
        var o = k;
        var p = l;
        var q = d.cm;
        if (q && !j) {
    ...
    SeriesInteractionManager.prototype.a$d = function (a, b, c) {
        ...
        for (var f = 0; f < d.length; f++) {
            ...
            if (GeometryUtil.a(b, g[0], g[1], a.fu / 2 + a.f8(c))) {
                return true;
            }
            if (e != null && f < e.length) {
                ...
                if (GeometryUtil.a(b, h[0], h[1], a.fu / 2 + a.f8(c))) {
                    return true;
                }
                if (GeometryUtil.a(b, g[0], h[0], a.fu / 2 + a.f8(c))) {
                    return true;
                }
                if (GeometryUtil.a(b, g[1], h[1], a.fu / 2 + a.f8(c))) {
                    return true;
                }
                var i = new Array(5);
                i[0] = h[0];
    ...
    SeriesInteractionManager.prototype.a$e = function (a, b, c, d) {
        ...
        for (var e = 0; e < d.c.count; e++) {
            ...
            for (var g = 0; g < f._segments.count; g++) {
                ...
                if (GeometryUtil.b(b, f._startPoint, h._points, a.f8(c))) {
                    return true;
                }
            }
        }
    ...
    SeriesInteractionManager.prototype.a$al = function (a, b, c, d, e, f, g, h, i, j) {
        ...
        if (!c && g != null) {
            ...
            r.c = a.cd.sj;
            var s = a.f3(b, p, g, r, e);
            var t = a.f3(b, q, g, r, e);
            var u = q;
            var v = p;
            if (g.cm) {
                var w = g;
    ...
    SeriesInteractionManager.prototype.a$y = function (a, b, c, d, e) {
        ...
        if (a.cd != null && !this.c) {
            ...
            this.a$v(a, g, a.po(b), e, true, false, false, a == a.cd.bk, false);
            a.cd.mw(a, g, d);
        }
    };
    SeriesInteractionManager.prototype.a$ai = function (a, b) {
        ...
        var d = null;
        var e;
        var f = ((function () { var g = a.cd.cq.f(b, false, e, false); e = g.p2; return g.ret; })());
        if (f != a) {
            if (this.a$c) {
    ...
    SeriesInteractionManager.prototype.a$ab = function (a, b, c, d, e) {
        ...
        if (a.cd != null && f != null && this.c) {
            this.c = false;
            this.d = true;
            this.a$v(a, f, a.po(b), e, true, false, false, a == a.cd.bk, false);
            a.cd.mw(a, f, d);
        }
        if (a.cd != null && (!a.ep || f != null) && !this.c) {
            this.a$v(a, f, a.po(b), e, true, false, false, a == a.cd.bk, false);
            a.cd.m0(a, f, d);
        }
        if (f == null && !this.c && a.ep) {
            this.a$v(a, f, a.po(b), e, false, true, false, a == a.cd.bk, false);
            a.cd.mx(a, this.a$p, d);
            this.d = false;
            this.c = true;
        }
    };
    ...
    SeriesInteractionManager.prototype.r = function (a, b, c, d) {
        ...
        if (this._toolTipObject != null) {
            if (this.f || g) {
                ...
                this._toolTipObject.addClass(a.cd.j6);
                a.cd.kw(this._toolTipObject);
    ...
    SeriesInteractionManager.prototype.a$r = function (a) {
        var b = new Color();
        var c = a != null && a.cd != null && a.cd.cq != null && a.cd.cq.j != null ? a.cd.cq.j.ae : null;
        c.startCSSQuery();
    ...
    SeriesInteractionManager.prototype.a$aj = function (a, b) {
        ...
        if (typeof b === 'string') {
            ...
            if (this._toolTipObject != null) {
                ...
                var d = a.o1 != null && Color.e(toNullable(Color.$, a.o1.color), toNullable(Color.$, null)) && a.o1.color.l > 0;
                if (d) {
                    this._toolTipObject.setStyleProperty("border-color", a.o1._fill);
                }
            }
            else {
                if (!this.e && c != null) {
